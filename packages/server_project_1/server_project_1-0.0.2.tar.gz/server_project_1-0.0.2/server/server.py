...
import os
import argparse
from decos import logger, DecoratorLogger
...
def config_load():
    ...
    BASE_DIR = os.getcwd()
    '''Парсер конфигурационного json файла.'''
...
def main():
    ...
    print('Db', database, config['database_path'], config['database_file'])
