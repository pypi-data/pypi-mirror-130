...
{'': ['*'],
 'qmm': ['.mypy_cache/3.8/*',
         '.mypy_cache/3.8/_pytest/*',
         '.mypy_cache/3.8/_pytest/_code/*',
         '.mypy_cache/3.8/_pytest/_io/*',
         '.mypy_cache/3.8/_pytest/assertion/*',
         '.mypy_cache/3.8/_pytest/config/*',
         '.mypy_cache/3.8/_pytest/mark/*',
         ...
         '.mypy_cache/3.8/os/*',
         '.mypy_cache/3.8/packaging/*',
         '.mypy_cache/3.8/pkg_resources/*',
         '.mypy_cache/3.8/py/*',
         '.mypy_cache/3.8/pytest/*',
         '.mypy_cache/3.8/qmm/*',
