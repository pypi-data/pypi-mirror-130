from recaptcha3.exceptions import RecaptchaTokenNotFound, RecaptchaResponseNotFound
from recaptcha3.session import Session
from recaptcha3.structs import Proxy
from recaptcha3.utils import parse_url
...
class reCaptchaV3:
    ...
    proxy [Optional]: Proxy or Dict,
        Proxy object from `recaptcha3.structs` or dict (for requests library).
