...
Welcome to ``kaomoji-database-edit-tool`` contributor's guide.
...
If you experience bugs or general issues with ``kaomoji-database-edit-tool``, please have a look
...
You can help improve ``kaomoji-database-edit-tool`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``kaomoji-database-edit-tool`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``kaomoji-database-edit-tool``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n kaomoji-database-edit-tool python=3 six virtualenv pytest pytest-cov
    conda activate kaomoji-database-edit-tool
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/kaomoji-database-edit-tool.git
    cd kaomoji-database-edit-tool
...
#. Install |pre-commit|_::
   ...
   ``kaomoji-database-edit-tool`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/kaomoji-database-edit-tool
.. _issue tracker: https://github.com/<USERNAME>/kaomoji-database-edit-tool/issues
.. <-- end -->
