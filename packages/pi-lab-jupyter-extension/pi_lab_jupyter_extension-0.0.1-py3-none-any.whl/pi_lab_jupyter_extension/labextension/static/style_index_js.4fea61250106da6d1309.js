...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* 更改Cell样式 */\n.jp-Notebook .jp-Cell {\n  padding: 21px var(--jp-cell-padding) 2px var(--jp-cell-padding);\n}\n\n\n.jp-Notebook {\n  box-shadow: 0px 0px 12px 1px rgba(87, 87, 87, 0.2);;\n  padding:10px;\n  background-color: white;\n  max-width: 1200px;\n  margin: auto;\n\n}\n\n.p-Widget.jp-Notebook-container {\n  background-color: #eee;\n}\n", "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAGA,aAAa;AACb;EACE,+DAA+D;AACjE;;;AAGA;EACE,kDAAkD;EAClD,YAAY;EACZ,uBAAuB;EACvB,iBAAiB;EACjB,YAAY;;AAEd;;AAEA;EACE,sBAAsB;AACxB","sourcesContent":["@import url('cell_tool_bar/index.css');\n\n\n/* 更改Cell样式 */\n.jp-Notebook .jp-Cell {\n  padding: 21px var(--jp-cell-padding) 2px var(--jp-cell-padding);\n}\n\n\n.jp-Notebook {\n  box-shadow: 0px 0px 12px 1px rgba(87, 87, 87, 0.2);;\n  padding:10px;\n  background-color: white;\n  max-width: 1200px;\n  margin: auto;\n\n}\n\n.p-Widget.jp-Notebook-container {\n  background-color: #eee;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.4fea61250106da6d1309.js.map