...
/* harmony import */ var _style_cell_tool_bar_lockedtags_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../style/cell_tool_bar/lockedtags.svg */ "./style/cell_tool_bar/lockedtags.svg");
/* harmony import */ var _style_cell_tool_bar_unlockedtags_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../style/cell_tool_bar/unlockedtags.svg */ "./style/cell_tool_bar/unlockedtags.svg");
...
const codeIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
    name: `${EXTENSION_ID}:code`,
    svgstr: _style_cell_tool_bar_code_svg__WEBPACK_IMPORTED_MODULE_5__["default"]
});
const deleteIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
    name: `${EXTENSION_ID}:delete`,
    svgstr: _style_cell_tool_bar_delete_svg__WEBPACK_IMPORTED_MODULE_6__["default"]
});
const formatIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
    name: `${EXTENSION_ID}:format`,
    svgstr: _style_cell_tool_bar_format_svg__WEBPACK_IMPORTED_MODULE_7__["default"]
});
const lockedTagsIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
    name: `${EXTENSION_ID}:lockedtags`,
    svgstr: _style_cell_tool_bar_lockedtags_svg__WEBPACK_IMPORTED_MODULE_8__["default"]
});
const unlockedTagsIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
    name: `${EXTENSION_ID}:unlockedtags`,
    svgstr: _style_cell_tool_bar_unlockedtags_svg__WEBPACK_IMPORTED_MODULE_9__["default"]
});
...
const DEFAULT_HELPER_BUTTONS = [
    ...
    },
    {
        ...
        icon: _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.caretUpEmptyThinIcon
    },
    {
        command: 'notebook:move-cell-down',
        icon: _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.caretDownEmptyThinIcon
    },
    {
...
class ToggleButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    constructor(props = {}) {
        super();
        this.props = props;
        this._toggled = false;
        (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.addToolbarButtonClass)(this);
    }
    get toggled() {
    ...
    render() {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ToolbarButtonComponent, Object.assign({}, p));
    }
}
/**
 * Positioned helper button
 */
class PositionedButton extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_4__.Widget {
    constructor(item) {
 ...
 */
class CellMenu extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_4__.Widget {
    ...
    _addButtons(items) {
        (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_3__.each)(this.children(), widget => {
            widget.dispose();
        });
        ...
        items.forEach(entry => {
            ...
            if (this._commands.hasCommand(entry.command)) {
                layout.addWidget(new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ToolbarButton({
                    icon: _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon.resolve({ icon: entry.icon }),
 ...
 * Cell Toolbar Widget
 */
class CellToolbarWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_4__.Widget {
    constructor(commands, leftMenuItems, rightMenuItems, leftSpace = 0, position = null) {
        ...
        if (position) {
            ...
            this.layout.addWidget(_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Toolbar.createSpacerItem());
        }
...
class CellToolbarTracker {
    constructor(panel, commands) {
        ...
        (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_3__.find)(panel.toolbar.children(), (tbb, index) => {
...
(function (Private) {
    ...
    function createNode(item) {
        ...
        button.appendChild(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon.resolve({ icon: item.icon }).element({
...
/***/ "./style/cell_tool_bar/lockedtags.svg":
/*!********************************************!*\
  !*** ./style/cell_tool_bar/lockedtags.svg ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./style/cell_tool_bar/unlockedtags.svg":
/*!**********************************************!*\
  !*** ./style/cell_tool_bar/unlockedtags.svg ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
//# sourceMappingURL=lib_index_js.dfb92d348a1f6125c3f9.js.map