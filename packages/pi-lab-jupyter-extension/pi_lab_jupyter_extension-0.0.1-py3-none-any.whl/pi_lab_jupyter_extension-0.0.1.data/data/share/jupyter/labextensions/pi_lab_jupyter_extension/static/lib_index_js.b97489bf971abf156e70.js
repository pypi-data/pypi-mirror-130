...
/* harmony export */ });
/* harmony import */ var _plugin_cell_toolbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./plugin_cell_toolbar */ "./lib/plugin_cell_toolbar.js");
...
const plugins = [
    _plugin_cell_toolbar__WEBPACK_IMPORTED_MODULE_0__.cellToolbarPlugin,
...
const CELL_BAR_CLASS = 'jp-pilab-cell-toobar-pulgin';
...
class CellMenu extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Widget {
    constructor(commands, items) {
        ...
        this.addClass(`${CELL_BAR_CLASS}-menu`);
        ...
        items.forEach(entry => {
            ...
            if (this._commands.hasCommand(entry.command)) {
                layout.addWidget(new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton({
                    ...
                    className: `${CELL_BAR_CLASS}-${(_a = entry.cellType) !== null && _a !== void 0 ? _a : 'all'}`,
                    onClick: () => {
...
class CellToolbarWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Widget {
    constructor(commands, leftMenuItems, rightMenuItems) {
        super();
        this.layout = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.PanelLayout();
        this.addClass(`${CELL_BAR_CLASS}-toolbar`);
...
const cellToolbarPlugin = {
    ...
    activate: async (app) => {
        ...
        // 每当打开一个 notebook 时, 创建一个 CellToolbarExtension
        app.docRegistry.addWidgetExtension('Notebook', new CellToolbarExtension(app.commands));
    },
};
...
//# sourceMappingURL=lib_index_js.b97489bf971abf156e70.js.map