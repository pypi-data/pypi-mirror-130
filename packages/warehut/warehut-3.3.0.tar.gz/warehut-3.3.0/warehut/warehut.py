...
class Warehut:
    ...
    def __init__(self, worker_types: Sequence[type[Worker]], *args, **kwargs):
        ...
        self.consumers = [w(*args, **kwargs) for w in consumers]
        self.producers  = [w(self.consumers, *args, **kwargs) for w in producers]
        self.hybrids = [w(self.consumers, *args, **kwargs) for w in hybrids]
