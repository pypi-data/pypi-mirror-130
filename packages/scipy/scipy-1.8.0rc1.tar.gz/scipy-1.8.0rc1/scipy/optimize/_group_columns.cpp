...
namespace __pythran__group_columns
{
  ...
  typename group_sparse::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type group_sparse::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& indices, argument_type3&& indptr) const
  {
    ...
    {
      long  __target140075286635376 = n;
      for (long  i=0L; i < __target140075286635376; i += 1L)
      {
        ...
        {
          long  __target140075283004288 = indptr[pythonic::operator_::add(i, 1L)];
          for (long  k=indptr[i]; k < __target140075283004288; k += 1L)
          {
            union_[indices[k]] = 1L;
          }
        }
        {
          long  __target140075283004960 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target140075283004960; j += 1L)
          {
            ...
            {
              long  __target140075283004432 = indptr[pythonic::operator_::add(j, 1L)];
              for (long  k_=indptr[j]; k_ < __target140075283004432; k_ += 1L)
              {
            ...
            {
              {
                long  __target140075283965600 = indptr[pythonic::operator_::add(j, 1L)];
                for (long  k__=indptr[j]; k__ < __target140075283965600; k__ += 1L)
                {
  ...
  typename group_dense::type<argument_type0, argument_type1, argument_type2>::result_type group_dense::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& A) const
  {
    ...
    {
      long  __target140075290483776 = n;
      for (long  i=0L; i < __target140075290483776; i += 1L)
      {
        if (pythonic::operator_::ge(groups[i], 0L))
        {
          continue;
        ...
        {
          long  __target140075283525056 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target140075283525056; j += 1L)
          {
            if (pythonic::operator_::lt(groups[j], 0L))
            {
              all_grouped = false;
            ...
            typename pythonic::lazy<decltype(false)>::type intersect = false;
            {
              long  __target140075286621872 = m;
              for (long  k=0L; k < __target140075286621872; k += 1L)
              {
