...
class V1EKSCusterDriverStatus(object):
    ...
    def __init__(self, builder_ami=None, cpu_ami=None, ecr_registry_id=None, ecr_repository_uri=None, gpu_ami=None, gridlet_role_arn=None, user_workload_role_arn=None, vpc_id=None, _configuration=None):  # noqa: E501
    ...
    @builder_ami.setter
    def builder_ami(self, builder_ami):
