...
class V1KubernetesClusterStatus(object):
    ...
    def __init__(self, azure=None, bastion_host_ip=None, eks=None, ingress_ca_cert=None, ingress_load_balancer_hostname=None, ingress_load_balancer_ip=None, ssh_gateway_hostname=None, ssh_private_key=None, ssh_public_key=None, _configuration=None):  # noqa: E501
