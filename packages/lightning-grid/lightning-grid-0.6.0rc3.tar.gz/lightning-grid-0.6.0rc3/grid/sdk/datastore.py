...
from grid.sdk.user import SDKUser, sdkuser_from_logged_in_account, Team, User
...
class Datastore:
    ...
    def __init__(
        ...
        if owner is None:
            _sdk_user = sdkuser_from_logged_in_account()
            owner = User(
    ...
    def datastore_id(self) -> str:
        """UUID corresponding to this datastore. used only for debugging with Grid Engineers."""
