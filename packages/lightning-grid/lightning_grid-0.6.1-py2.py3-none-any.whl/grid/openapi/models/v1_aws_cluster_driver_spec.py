...
class V1AWSClusterDriverSpec(object):
    ...
    def __init__(self, bucket_name=None, builder_ami_override=None, builder_node_instance_type=None, cpu_ami_override=None, enable_dns_firewall=None, external_id=None, gpu_ami_override=None, guardduty_integration=None, instance_types=None, internal_gc_ttl=None, internal_test_cluster=None, kubernetes_version=None, management_node_instance_type=None, original_cluster_name=None, region=None, role_arn=None, tensorboard_node_instance_type=None, x_multi_az_count=None, _configuration=None):  # noqa: E501
    ...
    def builder_ami_override(self, builder_ami_override):
    ...
    def cpu_ami_override(self, cpu_ami_override):
    ...
    def gpu_ami_override(self, gpu_ami_override):
