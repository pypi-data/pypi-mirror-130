...
class V1InstanceSpec(object):
    ...
    def __init__(self, name=None, overprovisioned_ondemand_count=None, _configuration=None):  # noqa: E501
    ...
    def overprovisioned_ondemand_count(self, overprovisioned_ondemand_count):
