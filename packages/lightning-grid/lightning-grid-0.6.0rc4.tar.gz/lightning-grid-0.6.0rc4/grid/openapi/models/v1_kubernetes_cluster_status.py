...
class V1KubernetesClusterStatus(object):
    ...
    @property
    def ssh_gateway_hostname(self) -> 'str':
    ...
    def ssh_gateway_hostname(self, ssh_gateway_hostname: 'str'):
