...
class V1InstanceType(object):
    ...
    def __init__(self, cpu: 'str' = None, gpu: 'str' = None, hourly_cost: 'float' = None, memory: 'str' = None, name: 'str' = None, overprovisioned_ondemand_count: 'int' = None, spot: 'bool' = None, _configuration=None):  # noqa: E501
