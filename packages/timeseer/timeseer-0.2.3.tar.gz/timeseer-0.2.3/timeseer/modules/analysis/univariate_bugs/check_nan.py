...
<p>Due to network issues or some preprocessing it is possible that values are
recorded that do not match the normal format. Typically these are for instance
non-numerical values in measurement readings of a sensor or divide by 0.
These values are indicated as NaN (Not-a-Number).</p>
