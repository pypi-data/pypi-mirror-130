...
def run(
    ...
    stat_mean = timeseer.Statistic(META["statistics"][0]["name"], "float", float(mean))
    ...
    stat_median = timeseer.Statistic(
        META["statistics"][3]["name"], "float", float(median)
    )
    stat_std = timeseer.Statistic(META["statistics"][4]["name"], "float", float(std))
    return timeseer.AnalysisResult(
        statistics=[stat_mean, stat_min, stat_max, stat_median, stat_std]
    )
