...
and there are 7 positive and 3 negative jumps. The score for this check in that case would be
90% = 1 - 10 / 100. Which means that for 90% of all points no jump is present.</p>
