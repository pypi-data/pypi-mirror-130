...
Here q1, q3 and iqr stand for 25th, 27th percentile and inter-quartile range (=q3-q1) respectively.</p>
...
and there are 10 outliers. The score for this check in that case would be
90% = 1 - 10 / 100. Which means that 90% of all points are not outliers.</p>
