"""There is a longer gap in data being recorded than expected based on history.

<p>This check checks whether there have been periods for which no data
has been archived for a period of time. These could be indications of issues with
connectivity or sensors that are not well connected.</p>
