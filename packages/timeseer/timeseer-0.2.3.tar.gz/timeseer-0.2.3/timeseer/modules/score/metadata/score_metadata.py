...
META = {
    "scores": [
        dict(
            ...
            data_type="bool",
            checks=[
                dict(group="description", type="bug"),
            ],
        ),
        dict(
            ...
            data_type="bool",
            checks=[
                dict(group="interpolation type", type="bug"),
            ],
        ),
        dict(
            name="limits",
        ...
        dict(
            ...
            data_type="bool",
            checks=[
                dict(group="data types", type="bug"),
            ],
        ),
        dict(
            name="accuracy",
