...
class GetterData:
    ...
    def read_settings(self):
        ...
        ---------
            settings: dict
                Словарь содеражащий в себе компоненты необходимые для выгрузки данных
        """
    ...
    def get_connect_data(self):
        ...
        ---------
            connect_data: dict
                Словарь содержащий данны для подключения к базе данных
        """
        connect_data = {}
        try:
    ...
    def get_data_weather(self, row=None):
        """
        Функция для получения наьора данных погоды (не указывай ничего если необходимо выгрузить весь набор данных)
