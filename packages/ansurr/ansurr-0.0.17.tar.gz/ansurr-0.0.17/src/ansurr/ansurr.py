...
def main():
    ...
    parser.add_argument("-v", "--version", action='version', version='\nANSURR | Accuracy of NMR Structures Using RCI and Rigidity v0.0.17 | citation: https://doi.org/10.1038/s41467-020-20177-1')
    ...
    now = datetime.now()
    check_quiet_print(args.quiet,"ANSURR v0.0.17 "+now.strftime("%d/%m/%Y %H:%M:%S"))
