...
class TabMultiUnit_SB(tabsD.TabMultiUnits):
    def __init__(self,app,cfg):
        tabsD.TabMultiUnits.__init__(self,app,cfg,
            ...
            cfg.update_lineshape,
            baseId = 'mut_sb_',
            defaultTags = cfg.getTagsTU('B001.*sys-JTW')
            )

class RealTimeTabMultiUnit_SB_RT(tabsD.RealTimeTagMultiUnit):
    def __init__(self,app,cfg):
...
class RealTimeTabSelectedTags_SB(tabsD.RealTimeTabSelectedTags):
    def __init__(self,app,cfg):
...
class RealTimeMultiUnitSelectedTags_SB(tabsD.RealTimeMultiUnitSelectedTags):
    def __init__(self,app,cfg):
...
class RealTimeDoubleMultiUnits_SB(tabsD.RealTimeDoubleMultiUnits):
    def __init__(self,app,cfg):
        tabsD.RealTimeDoubleMultiUnits.__init__(self,app,cfg,
            ...
            cfg.update_lineshape,
            baseId = 'dmut_rt_sb_',
            defaultTags1=cfg.getTagsTU('B001.*sys-JTW')
)
