...
def match_shipments_propositions(shipments_df: pd.DataFrame, propositions_df: pd.DataFrame):
    ...
    return pd.merge(shipments_df, propositions_df[["proposition_id", "proposition_status", "purchase_ready_date",
                                                   "sent_date", "accepted_date", "shipment_id", "transit_time",
                                                   "transit_time_door_to_port", "transit_time_port_to_door",
                                                   "kronos_action", "kronos_proposition_id", "auto",]],
                    how="left",
                    on="shipment_id")
