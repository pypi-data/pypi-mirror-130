import click 
from .cli import cli
from pypipetcore.shop_conn.shop_connector import ShopConnector
from pypipetcore.operations.utility import get_front_shop_id
from pypipetcore.operations.inventory import update_inventory_bulk
from pypipetcore.operations.inventory import update_instock_qty_db
from pypipetcore.operations.inventory import update_instock_front_shop
# from pypipetcore.operations.inventory import update_instock_qty_db_simple
from pypipetcore.operations.inventory import get_inventory_by_sku
from pypipetcore.operations.inventory import update_instock_front_shop_by_sku
from pypipetcore.fileIO.file_loader import read_csv_file
...
@click.pass_context
def inventory(ctx, action, shop, filename, batch, sku,qty, skip_shop):
    """
