...
# from pypipetcore.sql.query import *
# from pypipetcore.shop_conn.gateway import update_shop_product, update_shop_product_batch
from pypipetcore.sql.query_interface import get_server_timestamp
from pypipetcore.sql.query_interface import add_json_to_db, search_exist
from pypipetcore.sql.query_interface import update_data, update_inventory,update_bulk
# from pypipetcore.sql.query_interface import get_inventory_update_after
from pypipetcore.sql.query_interface import get_variation_instock_qty
from pypipetcore.sql.query_interface import aggregate_inventory_qty
from pypipetcore.model.product import Inventory
from .utility import _object2dict
# from pypipetcore.sql.model2query import add_new_product_inventory
import logging
