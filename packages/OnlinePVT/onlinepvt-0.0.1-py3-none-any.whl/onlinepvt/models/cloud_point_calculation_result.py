...
from ..models.profile_information import ProfileInformation
...
class CloudPointCalculationResult:
    ...
    profiling: Union[Unset, ProfileInformation] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        profiling: Union[Unset, ProfileInformation]
        if isinstance(_profiling, Unset):
            profiling = UNSET
        else:
            profiling = ProfileInformation.from_dict(_profiling)
