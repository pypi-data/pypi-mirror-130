...
from ..models.fluid_distribution_moment import FluidDistributionMoment
...
class CalculationComposition:
    ...
    moment: Union[Unset, FluidDistributionMoment] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        moment: Union[Unset, FluidDistributionMoment]
        if isinstance(_moment, Unset):
            moment = UNSET
        else:
            moment = FluidDistributionMoment.from_dict(_moment)
