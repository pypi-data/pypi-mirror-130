...
from ..models.user_point_output import UserPointOutput
...
class SlePointCalculationInput:
    ...
    user_output: Union[Unset, UserPointOutput] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        user_output: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.user_output, Unset):
            user_output = self.user_output.to_dict()
        ...
        if user_output is not UNSET:
            field_dict["userOutput"] = user_output
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _user_output = d.pop("userOutput", UNSET)
        user_output: Union[Unset, UserPointOutput]
        if isinstance(_user_output, Unset):
            user_output = UNSET
        else:
            user_output = UserPointOutput.from_dict(_user_output)
