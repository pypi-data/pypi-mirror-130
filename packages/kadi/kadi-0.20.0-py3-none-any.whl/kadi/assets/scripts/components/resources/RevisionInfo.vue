      ...
      <div v-for="(value, prop) in revision.data" :key="prop">
        ...
        <div class="row">
          ...
          <div class="col-md-10" v-if="!revision.diff[prop]">
            <pre class="d-inline pre-wrap" v-if="value !== null">{{ revisionValue(value) }}</pre>
        ...
        <div class="row" v-if="revision.diff[prop]">
          <div class="col-md-10 offset-md-2 diff-add">
            ...
            <pre class="d-inline pre-wrap" v-if="revision.diff[prop]['new'] !== null">{{ revisionValue(revision.diff[prop]['new']) }}</pre>
