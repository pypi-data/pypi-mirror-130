    ...
    <div class="card mb-4 collapse" :id="`collapse-${suffix}`" v-if="isCustomizable">
      <div class="card-body">
        ...
        <div v-if="resourceType === 'record'">
          ...
          <br>
          <label class="form-control-label mt-2" :for="`links-${suffix}`">Record links</label>
          ...
          <div v-if="extras.length > 0">
            <div class="row mt-3 mb-2">
              <div class="col-md-6">Extra metadata</div>
              <div class="col-md-6 d-md-flex justify-content-end mt-2 mt-md-0" v-if="exportType === 'json'">
                <div class="form-check form-check-inline">
                  ...
                  <label class="form-check-label" :for="`propagate-${suffix}`">Propagate to linked records</label>
                </div>
              </div>
            </div>
