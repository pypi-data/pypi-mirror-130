...
def ccplot(data: pd.DataFrame, variableofinterest: str, path:str="", dicorename:Dict={}, forcepower:bool=False, addccviol:bool=False, colorby:Union[None,str]=None) -> pd.DataFrame:
    """
