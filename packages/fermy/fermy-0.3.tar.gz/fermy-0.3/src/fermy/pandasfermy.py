...
==> next step groupby option for fanodygrowth function
...
def fanodygrowth(data: pd.DataFrame, percentofmax:float=0.05, usemax:bool=False, timethreshold:Union[None, float]=None) -> pd.DataFrame:
