...
class AwsCdkConstructLibrary(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param cdk_version: (experimental) Minimum target version this library is tested against. Default: "1.129.0"
