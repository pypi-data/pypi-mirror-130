...
class OWPythonScript(OWWidget):
    ...
    class Inputs:
        data = MultiInput(
            "Data", Table, replaces=["in_data"], default=True, label=i18n.t("widget.data.data.common.data")
        )
        learner = MultiInput(
            "Learner", Learner, replaces=["in_learner"], default=True, label=i18n.t("common.general.learner")
        )
        classifier = MultiInput(
            "Classifier", Model, replaces=["in_classifier"], default=True, label=i18n.t("common.general.classifier")
        )
        object = MultiInput(
            "Object", object, replaces=["in_object"], default=False, label=i18n.t("widget.data.data.common.object")
        )
