...
class CatalogItem(object):
    ...
    @property
    def aliases(self):
        """Gets the aliases of this CatalogItem.  # noqa: E501

        Список псевдонимов названия товара  # noqa: E501

        :return: The aliases of this CatalogItem.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def aliases(self, aliases):
        """Sets the aliases of this CatalogItem.

        Список псевдонимов названия товара  # noqa: E501

        :param aliases: The aliases of this CatalogItem.  # noqa: E501
        :type: list[str]
        """
    ...
    def badge_color(self):
        """Gets the badge_color of this CatalogItem.  # noqa: E501

        Цвет ярлыка товара в формате HEX RGB  # noqa: E501

        :return: The badge_color of this CatalogItem.  # noqa: E501
        :rtype: str
        """
    ...
    def badge_color(self, badge_color):
        """Sets the badge_color of this CatalogItem.

        Цвет ярлыка товара в формате HEX RGB  # noqa: E501

        :param badge_color: The badge_color of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def badge_text(self):
        """Gets the badge_text of this CatalogItem.  # noqa: E501

        Текст в ярлыке товара  # noqa: E501

        :return: The badge_text of this CatalogItem.  # noqa: E501
        :rtype: str
        """
    ...
    def badge_text(self, badge_text):
        """Sets the badge_text of this CatalogItem.

        Текст в ярлыке товара  # noqa: E501

        :param badge_text: The badge_text of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def body(self):
        """Gets the body of this CatalogItem.  # noqa: E501

        Полный текст  # noqa: E501

        :return: The body of this CatalogItem.  # noqa: E501
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this CatalogItem.

        Полный текст  # noqa: E501

        :param body: The body of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cid(self):
        """Gets the cid of this CatalogItem.  # noqa: E501

        Идентификатор  # noqa: E501

        :return: The cid of this CatalogItem.  # noqa: E501
        :rtype: str
        """
        return self._cid
    ...
    @cid.setter
    def cid(self, cid):
        """Sets the cid of this CatalogItem.

        Идентификатор  # noqa: E501

        :param cid: The cid of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def creator(self):
        """Gets the creator of this CatalogItem.  # noqa: E501

        Идентификатор создателя  # noqa: E501

        :return: The creator of this CatalogItem.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this CatalogItem.

        Идентификатор создателя  # noqa: E501

        :param creator: The creator of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    def detail_images(self):
        """Gets the detail_images of this CatalogItem.  # noqa: E501

        Массив изображений товара  # noqa: E501

        :return: The detail_images of this CatalogItem.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def detail_images(self, detail_images):
        """Sets the detail_images of this CatalogItem.

        Массив изображений товара  # noqa: E501

        :param detail_images: The detail_images of this CatalogItem.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def disabled(self):
        """Gets the disabled of this CatalogItem.  # noqa: E501

        Флаг отключения товара  # noqa: E501

        :return: The disabled of this CatalogItem.  # noqa: E501
        :rtype: bool
        """
    ...
    def disabled(self, disabled):
        """Sets the disabled of this CatalogItem.

        Флаг отключения товара  # noqa: E501

        :param disabled: The disabled of this CatalogItem.  # noqa: E501
        :type: bool
        """
    ...
    def discount_price(self):
        """Gets the discount_price of this CatalogItem.  # noqa: E501

        Cкидочная цена на товар  # noqa: E501

        :return: The discount_price of this CatalogItem.  # noqa: E501
        :rtype: float
        """
    ...
    def discount_price(self, discount_price):
        """Sets the discount_price of this CatalogItem.

        Cкидочная цена на товар  # noqa: E501

        :param discount_price: The discount_price of this CatalogItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def extra_item(self):
        """Gets the extra_item of this CatalogItem.  # noqa: E501

        Флаг дополнительного товара  # noqa: E501

        :return: The extra_item of this CatalogItem.  # noqa: E501
        :rtype: bool
        """
    ...
    def extra_item(self, extra_item):
        """Sets the extra_item of this CatalogItem.

        Флаг дополнительного товара  # noqa: E501

        :param extra_item: The extra_item of this CatalogItem.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def image(self):
        """Gets the image of this CatalogItem.  # noqa: E501

        URL изображения превью  # noqa: E501

        :return: The image of this CatalogItem.  # noqa: E501
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this CatalogItem.

        URL изображения превью  # noqa: E501

        :param image: The image of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def _import(self):
        """Gets the _import of this CatalogItem.  # noqa: E501

        Флаг, означающий автоматически импортирована сущность или нет  # noqa: E501

        :return: The _import of this CatalogItem.  # noqa: E501
        :rtype: bool
        """
    ...
    def _import(self, _import):
        """Sets the _import of this CatalogItem.

        Флаг, означающий автоматически импортирована сущность или нет  # noqa: E501

        :param _import: The _import of this CatalogItem.  # noqa: E501
        :type: bool
        """
    ...
    def measure(self, measure):
        """Sets the measure of this CatalogItem.

        Единица измерения   * u - единица   * kg - килограмм   * gm - грамм   * lit - литр   * mlit - миллилитр   * sec - секунды   * day - дни   * hour - часы   # noqa: E501

        :param measure: The measure of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def remote_id(self):
        """Gets the remote_id of this CatalogItem.  # noqa: E501

        Идентификатор заказа во внешней системе (кассовый сервер, 1С и т.д.)  # noqa: E501

        :return: The remote_id of this CatalogItem.  # noqa: E501
        :rtype: str
        """
    ...
    def remote_id(self, remote_id):
        """Sets the remote_id of this CatalogItem.

        Идентификатор заказа во внешней системе (кассовый сервер, 1С и т.д.)  # noqa: E501

        :param remote_id: The remote_id of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    def template_id(self):
        """Gets the template_id of this CatalogItem.  # noqa: E501

        Id шаблона  # noqa: E501

        :return: The template_id of this CatalogItem.  # noqa: E501
        :rtype: str
        """
    ...
    def template_id(self, template_id):
        """Sets the template_id of this CatalogItem.

        Id шаблона  # noqa: E501

        :param template_id: The template_id of this CatalogItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def unit(self):
        """Gets the unit of this CatalogItem.  # noqa: E501

        Минимальная единица  # noqa: E501

        :return: The unit of this CatalogItem.  # noqa: E501
        :rtype: float
        """
        return self._unit
    ...
    @unit.setter
    def unit(self, unit):
        """Sets the unit of this CatalogItem.

        Минимальная единица  # noqa: E501

        :param unit: The unit of this CatalogItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this CatalogItem.  # noqa: E501

        Таймштамп модификации (Unix)  # noqa: E501

        :return: The updated_at of this CatalogItem.  # noqa: E501
        :rtype: int
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this CatalogItem.

        Таймштамп модификации (Unix)  # noqa: E501

        :param updated_at: The updated_at of this CatalogItem.  # noqa: E501
        :type: int
        """
