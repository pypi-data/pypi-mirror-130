...
class OrderItem(object):
    ...
    def catalog_item_id(self):
        """Gets the catalog_item_id of this OrderItem.  # noqa: E501

        Идентификатор товара в каталоге (UUID)  # noqa: E501

        :return: The catalog_item_id of this OrderItem.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def image(self):
        """Gets the image of this OrderItem.  # noqa: E501

        URL изображения превью  # noqa: E501

        :return: The image of this OrderItem.  # noqa: E501
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this OrderItem.

        URL изображения превью  # noqa: E501

        :param image: The image of this OrderItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def measure(self):
        """Gets the measure of this OrderItem.  # noqa: E501

        Единица измерения  # noqa: E501

        :return: The measure of this OrderItem.  # noqa: E501
        :rtype: str
        """
    ...
    def measure(self, measure):
        """Sets the measure of this OrderItem.

        Единица измерения  # noqa: E501

        :param measure: The measure of this OrderItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def old_price(self):
        """Gets the old_price of this OrderItem.  # noqa: E501

        Оригинальная стоимость позиции без скидок (не указывать, берется из каталога)  # noqa: E501

        :return: The old_price of this OrderItem.  # noqa: E501
        :rtype: float
        """
    ...
    def old_price(self, old_price):
        """Sets the old_price of this OrderItem.

        Оригинальная стоимость позиции без скидок (не указывать, берется из каталога)  # noqa: E501

        :param old_price: The old_price of this OrderItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def remote_id(self):
        """Gets the remote_id of this OrderItem.  # noqa: E501

        Идентификатор товара во внешней системе (кассовый сервер, 1С и т.д.)  # noqa: E501

        :return: The remote_id of this OrderItem.  # noqa: E501
        :rtype: str
        """
    ...
    def remote_id(self, remote_id):
        """Sets the remote_id of this OrderItem.

        Идентификатор товара во внешней системе (кассовый сервер, 1С и т.д.)  # noqa: E501

        :param remote_id: The remote_id of this OrderItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def shop_id(self):
        """Gets the shop_id of this OrderItem.  # noqa: E501

        Идентификатор магазина (UUID)  # noqa: E501

        :return: The shop_id of this OrderItem.  # noqa: E501
        :rtype: str
        """
    ...
    def shop_id(self, shop_id):
        """Sets the shop_id of this OrderItem.

        Идентификатор магазина (UUID)  # noqa: E501

        :param shop_id: The shop_id of this OrderItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def unit(self):
        """Gets the unit of this OrderItem.  # noqa: E501

        Минимальная единица  # noqa: E501

        :return: The unit of this OrderItem.  # noqa: E501
        :rtype: float
        """
        return self._unit
    ...
    @unit.setter
    def unit(self, unit):
        """Sets the unit of this OrderItem.

        Минимальная единица  # noqa: E501

        :param unit: The unit of this OrderItem.  # noqa: E501
        :type: float
        """
