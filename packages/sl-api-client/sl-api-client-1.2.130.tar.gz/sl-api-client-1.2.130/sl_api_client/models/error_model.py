...
class ErrorModel(object):
    ...
    def code(self):
        ...
        Номер ошибки. Номера ошибок должен составить разработчик серверной части в соответствии с реализацией  # noqa: E501
    ...
    def message(self):
        ...
        Локализованный объект описания ошибки для показа пользователю или отладки работы системы  # noqa: E501
