...
class NotificationsApi(object):
    ...
    def create_api_request_notification(self, scope, code, create_api_request_notification, **kwargs):  # noqa: E501
        """[DEPRECATED] Add a LUSID API Request notification to a subscription.  # noqa: E501
        ...
        :type code: str
        :param create_api_request_notification: The data to create a LUSID API Request notification (required)
    ...
    def create_webhook_notification(self, scope, code, create_webhook_notification, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Add a Webhook notification to a subscription.  # noqa: E501
    ...
    def update_api_request_notification(self, scope, code, id, update_api_request_notification, **kwargs):  # noqa: E501
        """[DEPRECATED] Update a LUSID API Request notification for a given subscription.  # noqa: E501
    ...
    def update_api_request_notification_with_http_info(self, scope, code, id, update_api_request_notification, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) > 40):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `update_api_request_notification`, length must be less than or equal to `40`")  # noqa: E501
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) < 30):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `update_api_request_notification`, length must be greater than or equal to `30`")  # noqa: E501
        if self.api_client.client_side_validation and 'id' in local_var_params and not re.search(r'^[a-zA-Z0-9\-]+$', local_var_params['id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `update_api_request_notification`, must conform to the pattern `/^[a-zA-Z0-9\-]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def update_webhook_notification(self, scope, code, id, update_webhook_notification, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Update a Webhook notification for a given subscription.  # noqa: E501
