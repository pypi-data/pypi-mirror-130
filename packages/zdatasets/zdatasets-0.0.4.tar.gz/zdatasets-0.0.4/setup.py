...
package_data = \
{'': ['*'],
 'datasets.tests': ['data/datastore/my_program/ds1/_SUCCESS',
                    'data/datastore/my_program/ds1/col1=A/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/datastore/my_program/ds1/col1=B/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/datastore/my_program/ds_dask/col1=A/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/datastore/my_program/ds_dask/col1=B/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/datastore/my_program/my_table/col1=A/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/datastore/my_program/my_table/col1=B/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/ds1/_SUCCESS',
                    'data/ds1/col1=A/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*',
                    'data/ds1/col1=B/run_id=f1775878-5613-11ec-a4a1-5def08ef015a/*'],
 'datasets.tutorials': ['data/my_dataset_foreach/region=A/*',
                        'data/my_dataset_foreach/region=B/*']}
...
{'datasets.executors': ['metaflow_executor = '
 ...
 'datasets.plugins': ['batch_dataset = datasets.plugins:BatchDatasetPlugin',
                      'batch_flow_dataset = '
                      'datasets.plugins:BatchFlowDatasetPlugin']}
