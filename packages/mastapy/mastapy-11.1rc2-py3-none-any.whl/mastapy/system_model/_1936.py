...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_1932.Design':
        ...
        return constructor.new(_1932.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties is not None else None
