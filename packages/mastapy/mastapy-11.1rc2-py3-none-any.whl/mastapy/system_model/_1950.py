...
T = TypeVar('T', bound='_2171.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self) -> '_1951.RelativeOffsetOption':
        ...
        return constructor.new(_1951.RelativeOffsetOption)(value) if value is not None else None

    @axial_offset.setter
    def axial_offset(self, value: '_1951.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
