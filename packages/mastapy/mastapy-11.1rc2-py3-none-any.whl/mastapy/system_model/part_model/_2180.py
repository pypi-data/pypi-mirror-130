...
class FlexiblePinAssembly(_2202.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2250.CylindricalGear':
        ...
        if _2250.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
