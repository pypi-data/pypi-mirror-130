...
from mastapy.system_model.import_export import _1968
...
class Part(_1936.DesignEntity):
    ...
    @property
    def local_connections(self) -> 'List[_1999.Connection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocalConnections, constructor.new(_1999.Connection))
        return value

    def create_geometry_export_options(self) -> '_1968.GeometryExportOptions':
    ...
    def copy_to(self, container: '_2161.Assembly') -> 'Part':
    ...
    def connections_to(self, part: 'Part') -> 'List[_1999.Connection]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionsTo(part.wrapped if part else None), constructor.new(_1999.Connection))
