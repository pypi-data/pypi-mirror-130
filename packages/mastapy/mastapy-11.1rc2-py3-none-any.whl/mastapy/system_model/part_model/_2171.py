...
from mastapy.system_model.connections_and_sockets import (
    _1997, _2018, _1999, _2023
)
from mastapy.system_model.part_model import _2172, _2194
...
class Component(_2194.Part):
    ...
    @property
    def component_connections(self) -> 'List[_1997.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1997.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2018.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1292.CoordinateSystem3D') -> '_2018.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2018.RealignmentResult':
    ...
    def can_delete_connection(self, connection: '_1999.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_2023.Socket':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1999.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1999.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2023.Socket') -> 'List[_2023.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_2023.Socket))

    def connect_to_socket(self, socket: '_2023.Socket') -> '_2172.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2023.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_2023.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2172.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2172.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
