...
from mastapy.system_model.part_model import _2187, _2190
...
class PlanetCarrier(_2190.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_2015.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_2015.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2208.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2208.Shaft', offset: Optional['float'] = float('nan')):
