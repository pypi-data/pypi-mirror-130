...
class ShaftHubConnection(_2174.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2317.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2317.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2317.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def left_flank_lead_relief(self) -> '_2324.SplineLeadRelief':
        ...
        return constructor.new(_2324.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief is not None else None

    @property
    def right_flank_lead_relief(self) -> '_2324.SplineLeadRelief':
        ...
        return constructor.new(_2324.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief is not None else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2318.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2318.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2324.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2324.SplineLeadRelief))
        return value
