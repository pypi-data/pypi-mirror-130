...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def crowning(self) -> '_2310.CrowningSpecification':
        ...
        return constructor.new(_2310.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning is not None else None
