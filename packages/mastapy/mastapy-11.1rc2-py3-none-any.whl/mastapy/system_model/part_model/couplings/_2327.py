...
from mastapy.system_model.part_model.couplings import _2331, _2329
...
class Synchroniser(_2202.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2331.SynchroniserSleeve':
        ...
        return constructor.new(_2331.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve is not None else None

    @property
    def left_cone(self) -> '_2329.SynchroniserHalf':
        ...
        return constructor.new(_2329.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone is not None else None

    @property
    def right_cone(self) -> '_2329.SynchroniserHalf':
        ...
        return constructor.new(_2329.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone is not None else None

    @property
    def clutch_connection_left(self) -> '_2069.ClutchConnection':
        ...
        return constructor.new(_2069.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft is not None else None

    @property
    def clutch_connection_right(self) -> '_2069.ClutchConnection':
        ...
        return constructor.new(_2069.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight is not None else None
