...
class SteadyStateSynchronousResponseOnAShaft(_7252.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3329.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3329.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options is not None else None
