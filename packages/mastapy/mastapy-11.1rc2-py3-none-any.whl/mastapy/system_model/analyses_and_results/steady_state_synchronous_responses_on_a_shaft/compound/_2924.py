...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_2931.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2794.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2794.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2794.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2794.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft))
        return value
