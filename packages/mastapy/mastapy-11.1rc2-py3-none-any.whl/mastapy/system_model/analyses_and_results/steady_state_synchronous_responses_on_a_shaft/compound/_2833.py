...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_2912.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    '''AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2703.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2703.AbstractAssemblySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2703.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2703.AbstractAssemblySteadyStateSynchronousResponseOnAShaft))
        return value
