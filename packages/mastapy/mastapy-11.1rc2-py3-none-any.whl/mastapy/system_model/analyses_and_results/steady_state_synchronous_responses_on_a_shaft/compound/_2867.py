...
class ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_2893.GearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2736.ConicalGearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2736.ConicalGearSetSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2736.ConicalGearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2736.ConicalGearSetSteadyStateSynchronousResponseOnAShaft))
        return value
