...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4336, _4335, _4349
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4349.GearSetModalAnalysisAtAStiffness):
    '''CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4336.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysisAtAStiffness, constructor.new(_4336.CylindricalGearModalAnalysisAtAStiffness))
        return value

    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4335.CylindricalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysisAtAStiffness, constructor.new(_4335.CylindricalGearMeshModalAnalysisAtAStiffness))
        return value
