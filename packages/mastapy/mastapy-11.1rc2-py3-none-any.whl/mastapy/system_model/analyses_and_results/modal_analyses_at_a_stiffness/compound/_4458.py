...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4427.BeltConnectionCompoundModalAnalysisAtAStiffness):
    '''CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4328.CVTBeltConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4328.CVTBeltConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4328.CVTBeltConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4328.CVTBeltConnectionModalAnalysisAtAStiffness))
        return value
