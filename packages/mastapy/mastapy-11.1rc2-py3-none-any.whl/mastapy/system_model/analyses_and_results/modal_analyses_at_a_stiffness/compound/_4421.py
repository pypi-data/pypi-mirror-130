...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4453.ConnectionCompoundModalAnalysisAtAStiffness):
    '''AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4291.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4291.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4291.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4291.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness))
        return value
