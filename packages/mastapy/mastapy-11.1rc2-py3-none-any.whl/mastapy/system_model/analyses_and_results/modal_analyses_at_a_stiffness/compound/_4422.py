...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4450.ConicalGearCompoundModalAnalysisAtAStiffness):
    '''AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4293.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4293.AGMAGleasonConicalGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4293.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4293.AGMAGleasonConicalGearModalAnalysisAtAStiffness))
        return value
