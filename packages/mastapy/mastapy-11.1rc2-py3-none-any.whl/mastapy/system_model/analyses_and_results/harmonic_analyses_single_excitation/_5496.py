...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5494, _5495, _5406
...
class StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation(_5406.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5494.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5494.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def straight_bevel_diff_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5495.StraightBevelDiffGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5495.StraightBevelDiffGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
