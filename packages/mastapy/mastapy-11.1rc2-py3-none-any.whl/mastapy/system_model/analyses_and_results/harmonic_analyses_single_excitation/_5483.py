...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5450, _5395
...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5395.AssemblyHarmonicAnalysisOfSingleExcitation):
    '''RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_5450.HarmonicAnalysisOfSingleExcitation':
        ...
        return constructor.new(_5450.HarmonicAnalysisOfSingleExcitation)(self.wrapped.HarmonicAnalysisOfSingleExcitationInputs) if self.wrapped.HarmonicAnalysisOfSingleExcitationInputs is not None else None
