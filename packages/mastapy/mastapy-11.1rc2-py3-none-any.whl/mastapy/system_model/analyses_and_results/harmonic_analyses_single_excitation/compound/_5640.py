...
class VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation(_5595.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5511.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5511.VirtualComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5511.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5511.VirtualComponentHarmonicAnalysisOfSingleExcitation))
        return value
