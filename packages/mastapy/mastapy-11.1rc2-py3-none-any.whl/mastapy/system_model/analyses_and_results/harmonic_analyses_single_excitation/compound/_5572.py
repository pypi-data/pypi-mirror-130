...
class FaceGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_5577.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    '''FaceGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5442.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5442.FaceGearMeshHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5442.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5442.FaceGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
