...
class RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_5616.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    '''RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5480.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5480.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5480.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5480.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation))
        return value
