...
class BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_5535.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    '''BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5400.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5400.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5400.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5400.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
