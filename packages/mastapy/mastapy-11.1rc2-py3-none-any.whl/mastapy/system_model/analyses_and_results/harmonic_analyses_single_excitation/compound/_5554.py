...
class ConnectorCompoundHarmonicAnalysisOfSingleExcitation(_5595.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''ConnectorCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5424.ConnectorHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5424.ConnectorHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5424.ConnectorHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5424.ConnectorHarmonicAnalysisOfSingleExcitation))
        return value
