...
class ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_5577.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    '''ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5418.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5418.ConceptGearMeshHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5418.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5418.ConceptGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
