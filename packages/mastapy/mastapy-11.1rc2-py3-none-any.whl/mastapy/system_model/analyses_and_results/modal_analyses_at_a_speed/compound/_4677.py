...
class AbstractShaftCompoundModalAnalysisAtASpeed(_4678.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    '''AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4548.AbstractShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4548.AbstractShaftModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4548.AbstractShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4548.AbstractShaftModalAnalysisAtASpeed))
        return value
