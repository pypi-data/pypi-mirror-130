...
class ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_4679.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4644.ShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4644.ShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4644.ShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4644.ShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value
