...
class ShaftSectionSystemDeflection(_121.Bar):
    ...
    @property
    def left_end(self) -> '_2522.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2522.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd is not None else None

    @property
    def right_end(self) -> '_2522.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2522.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd is not None else None
