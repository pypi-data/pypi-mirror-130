...
class CVTSystemDeflection(_2420.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3791.CVTPowerFlow':
        ...
        return constructor.new(_3791.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
