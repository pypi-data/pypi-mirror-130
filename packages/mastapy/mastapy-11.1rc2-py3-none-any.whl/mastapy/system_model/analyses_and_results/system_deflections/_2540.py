...
class StraightBevelSunGearSystemDeflection(_2535.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3865.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3865.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
