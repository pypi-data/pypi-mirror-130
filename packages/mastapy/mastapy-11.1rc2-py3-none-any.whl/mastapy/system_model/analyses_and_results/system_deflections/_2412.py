...
from mastapy.system_model.analyses_and_results.power_flows import _3752, _3796, _3849
...
class AbstractShaftSystemDeflection(_2411.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3752.AbstractShaftPowerFlow':
