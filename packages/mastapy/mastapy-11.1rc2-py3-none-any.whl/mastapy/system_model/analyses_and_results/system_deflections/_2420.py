...
from mastapy.system_model.part_model.couplings import _2301, _2311
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.static_loads import _6521, _6554
from mastapy.system_model.analyses_and_results.power_flows import _3760, _3791
from mastapy.system_model.analyses_and_results.system_deflections import _2419, _2526
...
class BeltDriveSystemDeflection(_2526.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def assembly_design(self) -> '_2301.BeltDrive':
    ...
    @property
    def assembly_load_case(self) -> '_6521.BeltDriveLoadCase':
        ...
        if _6521.BeltDriveLoadCase.TYPE not in self.wrapped.AssemblyLoadCase.__class__.__mro__:
    ...
    @property
    def power_flow_results(self) -> '_3760.BeltDrivePowerFlow':
        ...
        if _3760.BeltDrivePowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def belts(self) -> 'List[_2419.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2419.BeltConnectionSystemDeflection))
        return value
