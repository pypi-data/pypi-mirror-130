...
from mastapy.system_model.analyses_and_results.system_deflections import _2522, _2523, _2412
...
class ShaftSystemDeflection(_2412.AbstractShaftSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3849.ShaftPowerFlow':
        ...
        return constructor.new(_3849.ShaftPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2522.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2522.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor is not None else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2522.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2522.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor is not None else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2522.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2522.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife is not None else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2523.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2523.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2522.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2522.ShaftSectionEndResultsSystemDeflection))
        return value
