...
class PartToPartShearCouplingHalfSystemDeflection(_2450.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3832.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3832.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
