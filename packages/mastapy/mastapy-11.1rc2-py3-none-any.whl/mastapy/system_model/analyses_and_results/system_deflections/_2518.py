...
class RollingRingConnectionSystemDeflection(_2487.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3845.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3845.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
