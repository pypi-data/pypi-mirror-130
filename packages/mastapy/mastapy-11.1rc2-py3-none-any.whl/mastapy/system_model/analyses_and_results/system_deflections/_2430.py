...
class BoltSystemDeflection(_2435.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3770.BoltPowerFlow':
        ...
        return constructor.new(_3770.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
