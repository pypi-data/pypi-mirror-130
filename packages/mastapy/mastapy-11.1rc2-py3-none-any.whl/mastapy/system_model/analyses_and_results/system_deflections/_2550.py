...
class TorqueConverterSystemDeflection(_2451.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3872.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3872.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
