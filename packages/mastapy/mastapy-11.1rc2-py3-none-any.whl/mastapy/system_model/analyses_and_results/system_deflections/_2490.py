...
from mastapy.system_model.analyses_and_results.power_flows import _3818, _3821, _3824
...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2446.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3818.KlingelnbergCycloPalloidConicalGearPowerFlow':
