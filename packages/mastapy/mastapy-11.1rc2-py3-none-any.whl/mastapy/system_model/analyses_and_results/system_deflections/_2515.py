...
from mastapy.system_model.analyses_and_results.system_deflections import _2516, _2487
...
class RingPinsToDiscConnectionSystemDeflection(_2487.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6647.RingPinsToDiscConnectionLoadCase':
        ...
        return constructor.new(_6647.RingPinsToDiscConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None

    @property
    def power_flow_results(self) -> '_3843.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3843.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2516.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2516.RingPinToDiscContactReporting))
        return value
