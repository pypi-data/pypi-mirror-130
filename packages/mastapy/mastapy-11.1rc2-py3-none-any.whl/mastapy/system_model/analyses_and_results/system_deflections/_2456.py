...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2434.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3794.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3794.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
