...
class TorqueConverterPumpSystemDeflection(_2450.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3873.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3873.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
