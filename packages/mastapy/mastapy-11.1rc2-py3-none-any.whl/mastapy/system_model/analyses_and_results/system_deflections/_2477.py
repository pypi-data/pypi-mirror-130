...
from mastapy.system_model.fe import _2136
...
class FEPartSystemDeflection(_2411.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3807.FEPartPowerFlow':
        ...
        return constructor.new(_3807.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def export(self) -> '_2136.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2136.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
