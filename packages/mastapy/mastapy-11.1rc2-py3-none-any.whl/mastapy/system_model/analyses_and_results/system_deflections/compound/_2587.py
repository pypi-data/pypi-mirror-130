...
class BevelGearCompoundSystemDeflection(_2575.AGMAGleasonConicalGearCompoundSystemDeflection):
    '''BevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2428.BevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2428.BevelGearSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2428.BevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2428.BevelGearSystemDeflection))
        return value
