...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2582.BevelDifferentialGearCompoundSystemDeflection):
    '''BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2424.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2424.BevelDifferentialPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2424.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2424.BevelDifferentialPlanetGearSystemDeflection))
        return value
