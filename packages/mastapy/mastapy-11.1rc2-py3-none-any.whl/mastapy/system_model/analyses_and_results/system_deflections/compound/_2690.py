...
class TorqueConverterCompoundSystemDeflection(_2608.CouplingCompoundSystemDeflection):
    '''TorqueConverterCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2550.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2550.TorqueConverterSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2550.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2550.TorqueConverterSystemDeflection))
        return value
