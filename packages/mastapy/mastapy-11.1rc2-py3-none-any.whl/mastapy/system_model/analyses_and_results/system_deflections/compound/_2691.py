...
class TorqueConverterConnectionCompoundSystemDeflection(_2609.CouplingConnectionCompoundSystemDeflection):
    '''TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2548.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2548.TorqueConverterConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2548.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2548.TorqueConverterConnectionSystemDeflection))
        return value
