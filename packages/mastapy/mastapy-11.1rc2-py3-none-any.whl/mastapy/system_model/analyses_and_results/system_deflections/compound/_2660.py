...
class PulleyCompoundSystemDeflection(_2610.CouplingHalfCompoundSystemDeflection):
    '''PulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2513.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2513.PulleySystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2513.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2513.PulleySystemDeflection))
        return value
