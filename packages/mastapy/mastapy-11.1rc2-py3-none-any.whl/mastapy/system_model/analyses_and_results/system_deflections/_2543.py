...
class SynchroniserSleeveSystemDeflection(_2542.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3869.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3869.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
