...
class RollingRingSystemDeflection(_2450.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3846.RollingRingPowerFlow':
        ...
        return constructor.new(_3846.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
