...
class MeasurementComponentSystemDeflection(_2555.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3827.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3827.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
