...
class PlanetaryConnectionSystemDeflection(_2525.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3834.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3834.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
