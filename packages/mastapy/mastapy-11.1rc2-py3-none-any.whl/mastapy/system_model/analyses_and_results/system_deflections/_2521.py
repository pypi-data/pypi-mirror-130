...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2570
...
class ShaftHubConnectionSystemDeflection(_2448.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3848.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3848.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1681.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1681.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem is not None else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1681.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1681.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem is not None else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2570.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2570.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2570.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2570.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2570.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2570.SplineFlankContactReporting))
        return value
