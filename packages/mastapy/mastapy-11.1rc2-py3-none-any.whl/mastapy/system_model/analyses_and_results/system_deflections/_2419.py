...
from mastapy.system_model.analyses_and_results.power_flows import _3759, _3790
...
class BeltConnectionSystemDeflection(_2487.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3759.BeltConnectionPowerFlow':
