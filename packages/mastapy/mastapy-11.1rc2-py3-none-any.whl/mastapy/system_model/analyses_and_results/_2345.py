...
from mastapy.system_model.analyses_and_results import _2376
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7260.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1936.DesignEntity') -> '_2376.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2376.DesignEntityAnalysis') -> '_2376.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
