...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6353, _6354, _6261
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6261.BevelGearSetCriticalSpeedAnalysis):
    '''StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6353.StraightBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCriticalSpeedAnalysis, constructor.new(_6353.StraightBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6354.StraightBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCriticalSpeedAnalysis, constructor.new(_6354.StraightBevelGearMeshCriticalSpeedAnalysis))
        return value
