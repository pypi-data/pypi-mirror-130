...
class CriticalSpeedAnalysis(_7252.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_options(self) -> '_6284.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6284.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions is not None else None
