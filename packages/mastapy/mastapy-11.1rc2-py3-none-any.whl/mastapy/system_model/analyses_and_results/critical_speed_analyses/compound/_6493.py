...
class TorqueConverterPumpCompoundCriticalSpeedAnalysis(_6413.CouplingHalfCompoundCriticalSpeedAnalysis):
    '''TorqueConverterPumpCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6364.TorqueConverterPumpCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6364.TorqueConverterPumpCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6364.TorqueConverterPumpCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6364.TorqueConverterPumpCriticalSpeedAnalysis))
        return value
