...
class RingPinsToDiscConnectionCompoundCriticalSpeedAnalysis(_6439.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''RingPinsToDiscConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6335.RingPinsToDiscConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6335.RingPinsToDiscConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6335.RingPinsToDiscConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6335.RingPinsToDiscConnectionCriticalSpeedAnalysis))
        return value
