...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6453.PartCompoundCriticalSpeedAnalysis):
    '''AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6243.AbstractAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6243.AbstractAssemblyCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6243.AbstractAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6243.AbstractAssemblyCriticalSpeedAnalysis))
        return value
