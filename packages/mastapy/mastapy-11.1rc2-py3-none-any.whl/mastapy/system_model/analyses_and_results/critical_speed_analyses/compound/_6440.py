...
class KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis(_6406.ConicalGearCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6311.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6311.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6311.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6311.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis))
        return value
