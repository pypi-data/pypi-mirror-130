...
class BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis(_6391.BevelGearMeshCompoundCriticalSpeedAnalysis):
    '''BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6255.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6255.BevelDifferentialGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6255.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6255.BevelDifferentialGearMeshCriticalSpeedAnalysis))
        return value
