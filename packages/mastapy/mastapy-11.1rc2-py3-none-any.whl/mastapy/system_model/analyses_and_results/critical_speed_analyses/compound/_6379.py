...
class AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis(_6407.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    '''AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6248.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6248.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6248.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6248.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis))
        return value
