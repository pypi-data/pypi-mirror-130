...
TReal = TypeVar('TReal', bound='_2171.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6536.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5387.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
