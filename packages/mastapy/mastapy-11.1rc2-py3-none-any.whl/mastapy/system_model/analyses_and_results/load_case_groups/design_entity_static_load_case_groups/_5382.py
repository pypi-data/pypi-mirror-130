...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5387
...
TAssembly = TypeVar('TAssembly', bound='_2162.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6506.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5387.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
