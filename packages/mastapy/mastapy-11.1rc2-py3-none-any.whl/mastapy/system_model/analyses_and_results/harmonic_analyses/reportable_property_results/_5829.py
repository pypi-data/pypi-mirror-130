...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5822, _5827
...
class ResultsForMultipleOrdersForGroups(_5827.ResultsForMultipleOrders):
    '''ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5822.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5822.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
