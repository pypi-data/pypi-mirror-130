...
class RootAssemblyHarmonicAnalysis(_5655.AssemblyHarmonicAnalysis):
    '''RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5732.HarmonicAnalysisRootAssemblyExportOptions':
        ...
        return constructor.new(_5732.HarmonicAnalysisRootAssemblyExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2357.HarmonicAnalysis':
        ...
        if _2357.HarmonicAnalysis.TYPE not in self.wrapped.HarmonicAnalysisInputs.__class__.__mro__:
