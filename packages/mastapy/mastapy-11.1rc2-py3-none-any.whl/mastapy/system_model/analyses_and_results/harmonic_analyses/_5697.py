...
from mastapy.system_model.analyses_and_results.system_deflections import _2459, _2460, _2461
...
class CylindricalGearMeshHarmonicAnalysis(_5722.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7024.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7024.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2459.CylindricalGearMeshSystemDeflection':
