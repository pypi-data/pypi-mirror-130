...
class AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis(_5873.ConicalGearMeshCompoundHarmonicAnalysis):
    '''AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5653.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5653.AGMAGleasonConicalGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5653.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5653.AGMAGleasonConicalGearMeshHarmonicAnalysis))
        return value
