...
class AGMAGleasonConicalGearCompoundHarmonicAnalysis(_5872.ConicalGearCompoundHarmonicAnalysis):
    '''AGMAGleasonConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5652.AGMAGleasonConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5652.AGMAGleasonConicalGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5652.AGMAGleasonConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5652.AGMAGleasonConicalGearHarmonicAnalysis))
        return value
