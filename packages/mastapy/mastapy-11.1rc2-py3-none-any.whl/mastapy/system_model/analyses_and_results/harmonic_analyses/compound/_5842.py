...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5865.ComponentCompoundHarmonicAnalysis):
    '''AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5650.AbstractShaftOrHousingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5650.AbstractShaftOrHousingHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5650.AbstractShaftOrHousingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5650.AbstractShaftOrHousingHarmonicAnalysis))
        return value
