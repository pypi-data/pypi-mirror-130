...
class BevelDifferentialPlanetGearCompoundHarmonicAnalysis(_5851.BevelDifferentialGearCompoundHarmonicAnalysis):
    '''BevelDifferentialPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5662.BevelDifferentialPlanetGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5662.BevelDifferentialPlanetGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5662.BevelDifferentialPlanetGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5662.BevelDifferentialPlanetGearHarmonicAnalysis))
        return value
