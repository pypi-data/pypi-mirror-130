...
class AbstractShaftOrHousingHarmonicAnalysis(_5674.ComponentHarmonicAnalysis):
    '''AbstractShaftOrHousingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2411.AbstractShaftOrHousingSystemDeflection':
