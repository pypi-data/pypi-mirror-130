...
class CylindricalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3151.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CylindricalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3009.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3009.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3009.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3009.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
