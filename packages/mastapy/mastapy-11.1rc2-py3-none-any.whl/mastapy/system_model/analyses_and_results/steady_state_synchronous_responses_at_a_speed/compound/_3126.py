...
class ConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3152.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    '''ConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2995.ConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2995.ConicalGearSetSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2995.ConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2995.ConicalGearSetSteadyStateSynchronousResponseAtASpeed))
        return value
