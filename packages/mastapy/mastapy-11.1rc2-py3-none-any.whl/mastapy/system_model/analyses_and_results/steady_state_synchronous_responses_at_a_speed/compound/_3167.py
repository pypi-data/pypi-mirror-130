...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3214.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3037.MassDiscSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3037.MassDiscSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3037.MassDiscSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3037.MassDiscSteadyStateSynchronousResponseAtASpeed))
        return value
