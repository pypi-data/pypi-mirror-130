...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3067, _2969
...
class RootAssemblySteadyStateSynchronousResponseAtASpeed(_2969.AssemblySteadyStateSynchronousResponseAtASpeed):
    '''RootAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed_inputs(self) -> '_3067.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3067.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs) if self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs is not None else None
