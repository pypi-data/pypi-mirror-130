...
from mastapy.system_model import _1946, _1947, _1948
from mastapy.system_model.analyses_and_results.mbd_analyses import _5226
from mastapy.system_model.analyses_and_results.static_loads import _6681, _6572, _6685
from mastapy.system_model.fe import _2100
...
class PowerLoadLoadCase(_6685.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1946.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1946.PowerLoadDragTorqueSpecificationMethod)(value) if value is not None else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1946.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5226.WheelSlipType':
        ...
        return constructor.new(_5226.WheelSlipType)(value) if value is not None else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5226.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1948.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1948.PowerLoadPIDControlSpeedInputType)(value) if value is not None else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1948.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def get_harmonic_load_data_for_import(self) -> '_6572.ElectricMachineHarmonicLoadData':
