...
from mastapy.system_model.analyses_and_results.static_loads import _6612, _6599, _6579
...
class HarmonicLoadDataFluxImport(_6599.HarmonicLoadDataCSVImport['_6579.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6612.InnerDiameterReference':
        ...
        return constructor.new(_6612.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6612.InnerDiameterReference'):
