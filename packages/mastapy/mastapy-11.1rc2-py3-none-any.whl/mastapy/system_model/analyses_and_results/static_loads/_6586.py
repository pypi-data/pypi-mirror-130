...
from mastapy.system_model.analyses_and_results.static_loads import _6584, _6585, _6595
...
class FaceGearSetLoadCase(_6595.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6584.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6584.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6584.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6584.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6585.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6585.FaceGearMeshLoadCase))
        return value
