...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def roundness_specification(self) -> '_1659.RoundnessSpecification':
        ...
        return constructor.new(_1659.RoundnessSpecification)(self.wrapped.RoundnessSpecification) if self.wrapped.RoundnessSpecification is not None else None

    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6645.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6645.RingPinManufacturingError))
        return value
