...
from mastapy.system_model.analyses_and_results.static_loads import _6637, _6627
...
class PlanetCarrierLoadCase(_6627.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6637.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6637.PlanetarySocketManufactureError))
        return value
