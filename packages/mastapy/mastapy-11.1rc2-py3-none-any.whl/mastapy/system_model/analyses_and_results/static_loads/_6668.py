...
from mastapy.system_model.analyses_and_results.static_loads import _6666, _6667, _6529
...
class StraightBevelGearSetLoadCase(_6529.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6666.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6666.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6666.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6666.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6667.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6667.StraightBevelGearMeshLoadCase))
        return value
