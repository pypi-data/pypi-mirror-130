...
class GearLoadCase(_6627.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6591.GearManufactureError':
        ...
        if _6591.GearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6544.ConicalGearManufactureError':
        ...
        if _6544.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6561.CylindricalGearManufactureError':
        ...
        if _6561.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
