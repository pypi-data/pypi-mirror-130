...
from mastapy.system_model.analyses_and_results.static_loads import _6555, _6521
...
class CVTLoadCase(_6521.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6555.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6555.CVTPulleyLoadCase))
        return value
