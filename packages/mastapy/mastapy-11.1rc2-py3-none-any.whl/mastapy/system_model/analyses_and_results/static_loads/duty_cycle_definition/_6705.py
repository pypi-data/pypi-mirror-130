...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6695, _6706, _6697, _6694,
    _6698, _6700, _6707, _6704,
    _6696, _6699, _6693
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6610.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6610.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6610.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6706.TimeStepInputOptions':
        ...
        return constructor.new(_6706.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput is not None else None

    @property
    def gear_ratio_options(self) -> '_6697.GearRatioInputOptions':
        ...
        return constructor.new(_6697.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions is not None else None

    @property
    def design_state_options(self) -> '_6694.DesignStateOptions':
        ...
        return constructor.new(_6694.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions is not None else None

    @property
    def load_case_name_inputs(self) -> '_6698.LoadCaseNameOptions':
        ...
        return constructor.new(_6698.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs is not None else None

    @property
    def file_inputs(self) -> 'List[_6700.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6700.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6707.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6707.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6704.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6704.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6696.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6696.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6699.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6699.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6693.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6693.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1579.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1579.ColumnTitle))
        return value
