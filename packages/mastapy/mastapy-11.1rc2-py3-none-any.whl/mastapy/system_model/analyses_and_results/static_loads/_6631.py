...
from mastapy.system_model.analyses_and_results import _2382
...
class PartLoadCase(_2382.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6504.StaticLoadCase':
        ...
        if _6504.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6505.TimeSeriesLoadCase':
        ...
        return constructor.new(_6505.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase is not None else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6598.HarmonicLoadDataBase':
