...
class PartDynamicAnalysis(_7249.PartFEAnalysis):
    '''PartDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_2351.DynamicAnalysis':
        ...
        if _2351.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
