...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6041, _6042, _5984
...
class HypoidGearSetDynamicAnalysis(_5984.AGMAGleasonConicalGearSetDynamicAnalysis):
    '''HypoidGearSetDynamicAnalysis
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_6041.HypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsDynamicAnalysis, constructor.new(_6041.HypoidGearDynamicAnalysis))
        return value

    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_6042.HypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesDynamicAnalysis, constructor.new(_6042.HypoidGearMeshDynamicAnalysis))
        return value
