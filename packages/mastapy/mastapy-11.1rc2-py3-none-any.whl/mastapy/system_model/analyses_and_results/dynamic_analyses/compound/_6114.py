...
class AGMAGleasonConicalGearSetCompoundDynamicAnalysis(_6142.ConicalGearSetCompoundDynamicAnalysis):
    '''AGMAGleasonConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5984.AGMAGleasonConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5984.AGMAGleasonConicalGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5984.AGMAGleasonConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5984.AGMAGleasonConicalGearSetDynamicAnalysis))
        return value
