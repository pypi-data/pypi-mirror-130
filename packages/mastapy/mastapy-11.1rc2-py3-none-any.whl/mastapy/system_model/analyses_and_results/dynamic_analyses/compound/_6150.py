...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6196
...
class CVTPulleyCompoundDynamicAnalysis(_6196.PulleyCompoundDynamicAnalysis):
    '''CVTPulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6020.CVTPulleyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6020.CVTPulleyDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6020.CVTPulleyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6020.CVTPulleyDynamicAnalysis))
        return value
