...
class AbstractShaftCompoundDynamicAnalysis(_6110.AbstractShaftOrHousingCompoundDynamicAnalysis):
    '''AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5979.AbstractShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5979.AbstractShaftDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5979.AbstractShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5979.AbstractShaftDynamicAnalysis))
        return value
