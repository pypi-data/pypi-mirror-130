...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6078, _6079, _5996
...
class SpiralBevelGearSetDynamicAnalysis(_5996.BevelGearSetDynamicAnalysis):
    '''SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6078.SpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsDynamicAnalysis, constructor.new(_6078.SpiralBevelGearDynamicAnalysis))
        return value

    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6079.SpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesDynamicAnalysis, constructor.new(_6079.SpiralBevelGearMeshDynamicAnalysis))
        return value
