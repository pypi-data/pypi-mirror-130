...
class PartPowerFlow(_7250.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def power_flow(self) -> '_3838.PowerFlow':
        ...
        return constructor.new(_3838.PowerFlow)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow is not None else None

    def create_viewable(self) -> '_1980.PowerFlowViewable':
