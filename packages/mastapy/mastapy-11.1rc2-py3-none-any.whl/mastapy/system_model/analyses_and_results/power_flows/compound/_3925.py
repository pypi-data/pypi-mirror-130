...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3971
...
class CVTPulleyCompoundPowerFlow(_3971.PulleyCompoundPowerFlow):
    '''CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3792.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3792.CVTPulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3792.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3792.CVTPulleyPowerFlow))
        return value
