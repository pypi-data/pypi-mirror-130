...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3912, _3913, _3943
...
class ConceptGearSetCompoundPowerFlow(_3943.GearSetCompoundPowerFlow):
    '''ConceptGearSetCompoundPowerFlow
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_3912.ConceptGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundPowerFlow, constructor.new(_3912.ConceptGearCompoundPowerFlow))
        return value

    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_3913.ConceptGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundPowerFlow, constructor.new(_3913.ConceptGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3781.ConceptGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3781.ConceptGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3781.ConceptGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3781.ConceptGearSetPowerFlow))
        return value
