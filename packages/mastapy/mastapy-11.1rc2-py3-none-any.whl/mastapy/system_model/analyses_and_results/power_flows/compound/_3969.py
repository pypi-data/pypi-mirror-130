...
class PointLoadCompoundPowerFlow(_4005.VirtualComponentCompoundPowerFlow):
    '''PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3837.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3837.PointLoadPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3837.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3837.PointLoadPowerFlow))
        return value
