...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4009, _4010, _3901
...
class ZerolBevelGearSetCompoundPowerFlow(_3901.BevelGearSetCompoundPowerFlow):
    '''ZerolBevelGearSetCompoundPowerFlow
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4009.ZerolBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsCompoundPowerFlow, constructor.new(_4009.ZerolBevelGearCompoundPowerFlow))
        return value

    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4010.ZerolBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesCompoundPowerFlow, constructor.new(_4010.ZerolBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3882.ZerolBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3882.ZerolBevelGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3882.ZerolBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3882.ZerolBevelGearSetPowerFlow))
        return value
