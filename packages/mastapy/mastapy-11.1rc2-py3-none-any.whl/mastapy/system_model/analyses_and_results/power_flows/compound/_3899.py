...
class BevelGearCompoundPowerFlow(_3887.AGMAGleasonConicalGearCompoundPowerFlow):
    '''BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3767.BevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3767.BevelGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3767.BevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3767.BevelGearPowerFlow))
        return value
