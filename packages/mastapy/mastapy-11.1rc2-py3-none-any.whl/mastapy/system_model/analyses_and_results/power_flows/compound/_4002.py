...
class TorqueConverterPumpCompoundPowerFlow(_3922.CouplingHalfCompoundPowerFlow):
    '''TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3873.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3873.TorqueConverterPumpPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3873.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3873.TorqueConverterPumpPowerFlow))
        return value
