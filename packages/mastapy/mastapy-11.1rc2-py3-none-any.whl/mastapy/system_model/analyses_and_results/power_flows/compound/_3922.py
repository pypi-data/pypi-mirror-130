...
class CouplingHalfCompoundPowerFlow(_3960.MountableComponentCompoundPowerFlow):
    '''CouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3788.CouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3788.CouplingHalfPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3788.CouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3788.CouplingHalfPowerFlow))
        return value
