...
class ShaftHubConnectionCompoundPowerFlow(_3919.ConnectorCompoundPowerFlow):
    '''ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3848.ShaftHubConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3848.ShaftHubConnectionPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3848.ShaftHubConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3848.ShaftHubConnectionPowerFlow))
        return value
