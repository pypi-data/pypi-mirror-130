...
class PulleyCompoundPowerFlow(_3922.CouplingHalfCompoundPowerFlow):
    '''PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3841.PulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3841.PulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3841.PulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3841.PulleyPowerFlow))
        return value
