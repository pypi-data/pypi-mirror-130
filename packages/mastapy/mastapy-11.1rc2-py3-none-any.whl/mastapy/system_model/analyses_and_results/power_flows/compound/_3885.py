...
class AbstractShaftOrHousingCompoundPowerFlow(_3908.ComponentCompoundPowerFlow):
    '''AbstractShaftOrHousingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3751.AbstractShaftOrHousingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3751.AbstractShaftOrHousingPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3751.AbstractShaftOrHousingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3751.AbstractShaftOrHousingPowerFlow))
        return value
