...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3988
...
class StraightBevelPlanetGearCompoundPowerFlow(_3988.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3864.StraightBevelPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3864.StraightBevelPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3864.StraightBevelPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3864.StraightBevelPlanetGearPowerFlow))
        return value
