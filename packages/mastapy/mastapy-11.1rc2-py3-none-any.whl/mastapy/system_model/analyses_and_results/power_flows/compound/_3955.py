...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3949
...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow(_3949.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3824.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3824.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3824.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3824.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow))
        return value
