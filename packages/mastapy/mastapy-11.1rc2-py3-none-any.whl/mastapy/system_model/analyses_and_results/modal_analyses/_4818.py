...
from mastapy.system_model.analyses_and_results.modal_analyses import _4817, _4816, _4823
...
class BevelDifferentialGearSetModalAnalysis(_4823.BevelGearSetModalAnalysis):
    '''BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4817.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysis, constructor.new(_4817.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4816.BevelDifferentialGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysis, constructor.new(_4816.BevelDifferentialGearMeshModalAnalysis))
        return value
