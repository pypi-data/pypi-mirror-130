...
class ModalAnalysisOptions(_0.APIBase):
    ...
    @property
    def frequency_response_options_for_reports(self) -> '_4864.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4864.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports is not None else None
