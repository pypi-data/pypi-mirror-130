...
class CylindricalPlanetGearCompoundModalAnalysis(_5005.CylindricalGearCompoundModalAnalysis):
    '''CylindricalPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4856.CylindricalPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4856.CylindricalPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4856.CylindricalPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4856.CylindricalPlanetGearModalAnalysis))
        return value
