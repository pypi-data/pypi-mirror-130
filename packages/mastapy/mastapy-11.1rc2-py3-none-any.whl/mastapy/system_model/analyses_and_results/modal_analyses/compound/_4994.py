...
class ConnectorCompoundModalAnalysis(_5035.MountableComponentCompoundModalAnalysis):
    '''ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4841.ConnectorModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4841.ConnectorModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4841.ConnectorModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4841.ConnectorModalAnalysis))
        return value
