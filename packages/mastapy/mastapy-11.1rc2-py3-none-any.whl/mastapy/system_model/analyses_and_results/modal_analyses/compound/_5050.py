...
class RollingRingCompoundModalAnalysis(_4997.CouplingHalfCompoundModalAnalysis):
    '''RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4904.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4904.RollingRingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4904.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4904.RollingRingModalAnalysis))
        return value
