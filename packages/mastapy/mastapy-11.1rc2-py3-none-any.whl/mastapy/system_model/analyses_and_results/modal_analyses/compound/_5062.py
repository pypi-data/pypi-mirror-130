...
class SpringDamperHalfCompoundModalAnalysis(_4997.CouplingHalfCompoundModalAnalysis):
    '''SpringDamperHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4915.SpringDamperHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4915.SpringDamperHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4915.SpringDamperHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4915.SpringDamperHalfModalAnalysis))
        return value
