...
class CycloidalDiscCompoundModalAnalysis(_4959.AbstractShaftCompoundModalAnalysis):
    '''CycloidalDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4851.CycloidalDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4851.CycloidalDiscModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4851.CycloidalDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4851.CycloidalDiscModalAnalysis))
        return value
