...
from mastapy.system_model.analyses_and_results.modal_analyses import _4835, _4834, _4867
...
class ConceptGearSetModalAnalysis(_4867.GearSetModalAnalysis):
    '''ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4835.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_4835.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4834.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_4834.ConceptGearMeshModalAnalysis))
        return value
