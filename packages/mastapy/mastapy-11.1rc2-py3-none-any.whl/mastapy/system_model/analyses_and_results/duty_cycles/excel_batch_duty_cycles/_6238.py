...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6242, _6239, _6241
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6242.MASTAFileDetails':
        ...
        return constructor.new(_6242.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails is not None else None

    @property
    def excel_file_details(self) -> '_6239.ExcelFileDetails':
        ...
        return constructor.new(_6239.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails is not None else None
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6241.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6241.ExcelSheetDesignStateSelector))
        return value
