...
from mastapy.system_model.analyses_and_results.stability_analyses import _3555, _3553, _3551
...
class KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis(_3551.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_stability_analysis(self) -> 'List[_3555.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsStabilityAnalysis, constructor.new(_3555.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_stability_analysis(self) -> 'List[_3553.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesStabilityAnalysis, constructor.new(_3553.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis))
        return value
