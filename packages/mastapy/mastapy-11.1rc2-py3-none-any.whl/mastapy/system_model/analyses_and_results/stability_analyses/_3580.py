...
from mastapy.system_model.analyses_and_results.stability_analyses import _3523, _3485
...
class ShaftStabilityAnalysis(_3485.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3523.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3523.CriticalSpeed))
        return value
