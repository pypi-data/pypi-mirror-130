...
from mastapy.system_model.analyses_and_results.stability_analyses import _3596, _3594, _3500
...
class StraightBevelGearSetStabilityAnalysis(_3500.BevelGearSetStabilityAnalysis):
    '''StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3596.StraightBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsStabilityAnalysis, constructor.new(_3596.StraightBevelGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3594.StraightBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesStabilityAnalysis, constructor.new(_3594.StraightBevelGearMeshStabilityAnalysis))
        return value
