...
from mastapy.system_model.analyses_and_results.stability_analyses import _3593, _3591, _3500
...
class StraightBevelDiffGearSetStabilityAnalysis(_3500.BevelGearSetStabilityAnalysis):
    '''StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3593.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsStabilityAnalysis, constructor.new(_3593.StraightBevelDiffGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3591.StraightBevelDiffGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesStabilityAnalysis, constructor.new(_3591.StraightBevelDiffGearMeshStabilityAnalysis))
        return value
