...
class PlanetaryGearSetCompoundStabilityAnalysis(_3664.CylindricalGearSetCompoundStabilityAnalysis):
    '''PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3568.PlanetaryGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3568.PlanetaryGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3568.PlanetaryGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3568.PlanetaryGearSetStabilityAnalysis))
        return value
