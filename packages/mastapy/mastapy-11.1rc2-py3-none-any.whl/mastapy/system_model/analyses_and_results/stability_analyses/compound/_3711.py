...
class ShaftHubConnectionCompoundStabilityAnalysis(_3651.ConnectorCompoundStabilityAnalysis):
    '''ShaftHubConnectionCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3579.ShaftHubConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3579.ShaftHubConnectionStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3579.ShaftHubConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3579.ShaftHubConnectionStabilityAnalysis))
        return value
