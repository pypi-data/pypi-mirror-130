...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_6811.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2509.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2509.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
