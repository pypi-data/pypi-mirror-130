...
class ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_6903.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6747.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6747.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6747.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6747.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation))
        return value
