...
from mastapy.system_model.connections_and_sockets import _1995, _2000
...
class BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6908.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_1995.BeltConnection':
    ...
    @property
    def connection_design(self) -> '_1995.BeltConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6722.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6722.BeltConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6722.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6722.BeltConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
