...
class ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation(_6712.AbstractShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_2022.ShaftToMountableComponentConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2525.ShaftToMountableComponentConnectionSystemDeflection':
