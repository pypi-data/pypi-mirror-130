...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6771.GearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2465.CylindricalGearSystemDeflection':
