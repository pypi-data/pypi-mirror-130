...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6730.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2559.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2559.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
