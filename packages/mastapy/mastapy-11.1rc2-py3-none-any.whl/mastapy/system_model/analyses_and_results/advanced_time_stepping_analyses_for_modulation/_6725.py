...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6730.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2421.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2421.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
