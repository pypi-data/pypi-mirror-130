...
class ConicalGearAdvancedTimeSteppingAnalysisForModulation(_6771.GearAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2446.ConicalGearSystemDeflection':
