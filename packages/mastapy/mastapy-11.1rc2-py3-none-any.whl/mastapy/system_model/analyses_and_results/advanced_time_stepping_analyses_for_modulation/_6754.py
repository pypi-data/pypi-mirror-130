...
class CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6722.BeltConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2452.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2452.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
