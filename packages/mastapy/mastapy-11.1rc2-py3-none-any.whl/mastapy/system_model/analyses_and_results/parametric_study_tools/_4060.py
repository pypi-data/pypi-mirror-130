...
class CylindricalGearParametricStudyTool(_4078.GearParametricStudyTool):
    '''CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2465.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2465.CylindricalGearSystemDeflection))
        return value
