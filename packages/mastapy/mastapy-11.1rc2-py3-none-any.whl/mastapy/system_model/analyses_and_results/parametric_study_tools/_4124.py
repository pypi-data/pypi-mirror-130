...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4104, _4106, _4019
...
class RootAssemblyParametricStudyTool(_4019.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_4104.ParametricStudyTool':
        ...
        return constructor.new(_4104.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs is not None else None
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> 'List[_2623.DutyCycleEfficiencyResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RootAssemblyDutyCycleResults, constructor.new(_2623.DutyCycleEfficiencyResults))
        return value
