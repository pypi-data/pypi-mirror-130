...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4099, _4096, _4064
...
class ParametricStudyVariable(_2373.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4099.ParametricStudyDimension':
        ...
        return constructor.new(_4099.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4099.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4096.MonteCarloDistribution':
        ...
        return constructor.new(_4096.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4096.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4064.DesignOfExperimentsVariableSetter':
        ...
        return constructor.new(_4064.DesignOfExperimentsVariableSetter)(self.wrapped.DOEVariableSetter) if self.wrapped.DOEVariableSetter is not None else None
