...
class TorqueConverterTurbineCompoundParametricStudyTool(_4198.CouplingHalfCompoundParametricStudyTool):
    '''TorqueConverterTurbineCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4150.TorqueConverterTurbineParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4150.TorqueConverterTurbineParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4150.TorqueConverterTurbineParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4150.TorqueConverterTurbineParametricStudyTool))
        return value
