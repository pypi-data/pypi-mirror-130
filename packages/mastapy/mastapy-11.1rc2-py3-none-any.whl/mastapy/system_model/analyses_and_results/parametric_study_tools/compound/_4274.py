...
class SynchroniserPartCompoundParametricStudyTool(_4198.CouplingHalfCompoundParametricStudyTool):
    '''SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4145.SynchroniserPartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4145.SynchroniserPartParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4145.SynchroniserPartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4145.SynchroniserPartParametricStudyTool))
        return value
