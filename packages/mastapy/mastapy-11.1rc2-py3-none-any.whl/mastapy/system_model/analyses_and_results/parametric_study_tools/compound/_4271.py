...
class StraightBevelSunGearCompoundParametricStudyTool(_4264.StraightBevelDiffGearCompoundParametricStudyTool):
    '''StraightBevelSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4142.StraightBevelSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4142.StraightBevelSunGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4142.StraightBevelSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4142.StraightBevelSunGearParametricStudyTool))
        return value
