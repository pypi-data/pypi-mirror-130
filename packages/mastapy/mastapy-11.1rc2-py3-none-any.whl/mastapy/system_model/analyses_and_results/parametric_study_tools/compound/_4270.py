...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4264
...
class StraightBevelPlanetGearCompoundParametricStudyTool(_4264.StraightBevelDiffGearCompoundParametricStudyTool):
    '''StraightBevelPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4141.StraightBevelPlanetGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4141.StraightBevelPlanetGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4141.StraightBevelPlanetGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4141.StraightBevelPlanetGearParametricStudyTool))
        return value
