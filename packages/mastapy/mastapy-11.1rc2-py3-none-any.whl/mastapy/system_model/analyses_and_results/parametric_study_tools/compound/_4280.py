...
class UnbalancedMassCompoundParametricStudyTool(_4281.VirtualComponentCompoundParametricStudyTool):
    '''UnbalancedMassCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4151.UnbalancedMassParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4151.UnbalancedMassParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4151.UnbalancedMassParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4151.UnbalancedMassParametricStudyTool))
        return value
