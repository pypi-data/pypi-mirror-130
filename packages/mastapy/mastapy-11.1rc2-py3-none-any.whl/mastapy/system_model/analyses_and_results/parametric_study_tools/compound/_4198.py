...
class CouplingHalfCompoundParametricStudyTool(_4236.MountableComponentCompoundParametricStudyTool):
    '''CouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4050.CouplingHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4050.CouplingHalfParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4050.CouplingHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4050.CouplingHalfParametricStudyTool))
        return value
