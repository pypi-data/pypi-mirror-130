...
from mastapy.system_model.analyses_and_results.static_loads import _6517, _6630
from mastapy.system_model import _1940, _1936
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4107, _4108
from mastapy.system_model.analyses_and_results import _2373
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6630.ParametricStudyType':
        ...
        return constructor.new(_6630.ParametricStudyType)(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6630.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1940.ExternalFullFELoader':
        ...
        return constructor.new(_1940.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader is not None else None

    @property
    def step_results(self) -> 'List[_4107.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4107.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4108.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4108.ParametricStudyVariable))
        return value

    @property
    def parametric_study_logging_variables(self) -> 'List[_2373.AnalysisCaseVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParametricStudyLoggingVariables, constructor.new(_2373.AnalysisCaseVariable))
        return value
    ...
    def data_logger_for(self, design_entity: '_1936.DesignEntity') -> '_1367.DataLogger':
    ...
    def add_study_variable(self, design_entity: '_1936.DesignEntity', path: 'List[str]') -> '_4108.ParametricStudyVariable':
    ...
    def remove_study_variable(self, study_variable: '_4108.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4108.ParametricStudyVariable'):
    ...
    def move_study_variable_down(self, study_variable: '_4108.ParametricStudyVariable'):
    ...
    def add_logging_variable(self, design_entity: '_1936.DesignEntity', path: 'List[str]') -> '_2373.AnalysisCaseVariable':
    ...
    def remove_logging_variable(self, analysis_variable: '_2373.AnalysisCaseVariable'):
