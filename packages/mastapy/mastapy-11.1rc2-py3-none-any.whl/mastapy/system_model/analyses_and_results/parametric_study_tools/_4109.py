...
class PartParametricStudyTool(_7247.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4104.ParametricStudyTool':
        ...
        return constructor.new(_4104.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool is not None else None

    @property
    def data_logger(self) -> '_1609.DataLoggerWithCharts':
        ...
        return constructor.new(_1609.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger is not None else None
