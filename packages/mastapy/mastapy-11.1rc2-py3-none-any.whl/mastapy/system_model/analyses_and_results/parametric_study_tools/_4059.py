...
class CylindricalGearMeshParametricStudyTool(_4077.GearMeshParametricStudyTool):
    '''CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2459.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2459.CylindricalGearMeshSystemDeflection))
        return value
