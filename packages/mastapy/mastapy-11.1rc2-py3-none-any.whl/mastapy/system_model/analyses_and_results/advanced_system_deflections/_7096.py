...
class TorqueConverterConnectionAdvancedSystemDeflection(_7014.CouplingConnectionAdvancedSystemDeflection):
    '''TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2548.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2548.TorqueConverterConnectionSystemDeflection))
        return value
