...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6976, _6982
...
class RootAssemblyAdvancedSystemDeflection(_6982.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6976.AdvancedSystemDeflection':
        ...
        return constructor.new(_6976.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs is not None else None
