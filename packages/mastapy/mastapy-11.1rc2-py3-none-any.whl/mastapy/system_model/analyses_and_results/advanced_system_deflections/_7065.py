...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7099, _7101
...
class PowerLoadAdvancedSystemDeflection(_7101.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7099.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_7099.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2512.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2512.PowerLoadSystemDeflection))
        return value
