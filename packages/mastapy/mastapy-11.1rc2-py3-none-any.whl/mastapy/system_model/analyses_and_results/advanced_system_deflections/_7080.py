...
class SpringDamperAdvancedSystemDeflection(_7013.CouplingAdvancedSystemDeflection):
    '''SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2532.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2532.SpringDamperSystemDeflection))
        return value
