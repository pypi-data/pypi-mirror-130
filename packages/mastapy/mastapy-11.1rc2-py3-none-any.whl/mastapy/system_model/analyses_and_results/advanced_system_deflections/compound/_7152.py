...
class CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection(_7132.CoaxialConnectionCompoundAdvancedSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7021.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7021.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_7021.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7021.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection))
        return value
