...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5159, _5198, _5193
...
class MBDRunUpAnalysisOptions(_7238.AbstractAnalysisOptions['_6505.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5159.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5159.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5159.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5198.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5198.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5198.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5193.RunUpDrivingMode':
        ...
        return constructor.new(_5193.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5193.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
