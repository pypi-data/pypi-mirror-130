...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5222, _5127
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5127.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5222.TorqueConverterStatus':
        ...
        return constructor.new(_5222.TorqueConverterStatus)(value) if value is not None else None
