...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5110, _5129
...
class ClutchMultibodyDynamicsAnalysis(_5129.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5110.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5110.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection is not None else None
