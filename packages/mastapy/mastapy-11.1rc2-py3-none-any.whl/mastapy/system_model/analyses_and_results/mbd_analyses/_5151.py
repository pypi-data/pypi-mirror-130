...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5150, _5148, _5199
...
class GearSetMultibodyDynamicsAnalysis(_5199.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5150.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5150.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5148.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5148.GearMeshMultibodyDynamicsAnalysis))
        return value
