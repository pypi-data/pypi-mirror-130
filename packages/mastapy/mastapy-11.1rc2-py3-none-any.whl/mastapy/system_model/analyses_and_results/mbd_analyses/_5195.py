...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5235, _5237
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5126.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5235.DynamicForceVector3DResult':
        ...
        return constructor.new(_5235.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce is not None else None

    @property
    def peak_dynamic_force_angular(self) -> '_5237.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5237.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular is not None else None
