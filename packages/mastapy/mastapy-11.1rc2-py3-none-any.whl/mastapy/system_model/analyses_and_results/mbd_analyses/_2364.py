...
class MultibodyDynamicsAnalysis(_7253.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5172.MBDAnalysisOptions':
        ...
        return constructor.new(_5172.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions is not None else None
