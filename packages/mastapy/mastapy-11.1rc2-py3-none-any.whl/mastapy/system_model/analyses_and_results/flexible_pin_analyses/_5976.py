...
class FlexiblePinAnalysisStopStartAnalysis(_5970.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2524.ShaftSystemDeflection':
        ...
        return constructor.new(_2524.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase is not None else None

    @property
    def shaft_extreme_load_case(self) -> '_2524.ShaftSystemDeflection':
        ...
        return constructor.new(_2524.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase is not None else None
