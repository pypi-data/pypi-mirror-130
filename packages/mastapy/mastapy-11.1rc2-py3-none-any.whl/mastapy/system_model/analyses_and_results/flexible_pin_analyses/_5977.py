...
from mastapy.system_model.analyses_and_results.load_case_groups import _5374
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5969
...
class WindTurbineCertificationReport(_5969.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2200.RootAssembly':
        ...
        return constructor.new(_2200.RootAssembly)(self.wrapped.Design) if self.wrapped.Design is not None else None

    @property
    def ldd_static_analysis(self) -> '_2666.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2666.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis is not None else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2520.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2520.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis is not None else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2520.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2520.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis is not None else None
