...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponse(_3354.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    '''SpecialisedAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3320.SpecialisedAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3320.SpecialisedAssemblySteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3320.SpecialisedAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3320.SpecialisedAssemblySteadyStateSynchronousResponse))
        return value
