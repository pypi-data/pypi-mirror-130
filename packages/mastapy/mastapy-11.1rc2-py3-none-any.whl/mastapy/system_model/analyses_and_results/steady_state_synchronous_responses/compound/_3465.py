...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3459
...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse(_3459.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    '''StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3336.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3336.StraightBevelPlanetGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3336.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3336.StraightBevelPlanetGearSteadyStateSynchronousResponse))
        return value
