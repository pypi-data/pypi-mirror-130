...
class KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse(_3388.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3289.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3289.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3289.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3289.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse))
        return value
