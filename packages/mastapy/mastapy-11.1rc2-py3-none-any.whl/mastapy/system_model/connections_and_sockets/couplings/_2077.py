...
from mastapy.system_model.connections_and_sockets.couplings import _2073
...
class SpringDamperConnection(_2073.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1934.ComponentDampingOption':
        ...
        return constructor.new(_1934.ComponentDampingOption)(value) if value is not None else None

    @damping_option.setter
    def damping_option(self, value: '_1934.ComponentDampingOption'):
