...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def fe_substructure_node(self) -> '_2111.FESubstructureNode':
        ...
        return constructor.new(_2111.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode is not None else None
