...
from mastapy.system_model.fe import _2131, _2130
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2131.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2131.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2130.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2130.PerLinkExportOptions))
        return value
