...
class FEStiffnessTester(_0.APIBase):
    ...
    @property
    def fe_stiffness(self) -> '_2109.FESubstructure':
        ...
        return constructor.new(_2109.FESubstructure)(self.wrapped.FEStiffness) if self.wrapped.FEStiffness is not None else None
