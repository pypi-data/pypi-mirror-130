...
from mastapy.system_model.optimization import _1966, _1964
...
TStep = TypeVar('TStep', bound='_1964.OptimizationStep')


class OptimizationStrategy(_1966.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
