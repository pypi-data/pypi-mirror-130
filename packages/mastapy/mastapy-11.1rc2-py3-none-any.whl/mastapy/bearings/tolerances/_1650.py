...
from mastapy.bearings.tolerances import _1645, _1642
...
class InterferenceTolerance(_1642.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1645.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1645.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1630.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1630.MountingPointSurfaceFinishes)(value) if value is not None else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1630.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
