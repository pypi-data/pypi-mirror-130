...
from mastapy.bearings.bearing_results.rolling import _1728, _1731, _1759
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1759.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1728.LoadedAxialThrustCylindricalRollerBearingResults':
