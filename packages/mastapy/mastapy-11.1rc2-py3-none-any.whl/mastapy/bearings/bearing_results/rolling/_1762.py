...
from mastapy.bearings.bearing_results.rolling import _1802, _1748
...
class LoadedRollerBearingElement(_1748.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1802.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1802.ResultsAtRollerOffset))
        return value
