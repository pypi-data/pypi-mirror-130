...
from mastapy.bearings.bearing_results.rolling.fitting import _1847, _1845, _1848
from mastapy.bearings.bearing_results.rolling import (
    _1711, _1809, _1707, _1795,
    _1768
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1851, _1849, _1850
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1838, _1836, _1842, _1841,
    _1837, _1843, _1839
)
from mastapy.bearings.bearing_results.rolling.skf_module import _1833
...
class LoadedRollingBearingResults(_1693.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1626.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1626.FluidFilmTemperatureOptions)(value) if value is not None else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1847.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1847.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly is not None else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1847.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1847.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions is not None else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1845.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1845.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly is not None else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1845.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1845.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions is not None else None
    ...
    @property
    def din732(self) -> '_1707.DIN732Results':
        ...
        return constructor.new(_1707.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 is not None else None

    @property
    def ansiabma(self) -> '_1851.ANSIABMAResults':
        ...
        if _1851.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1849.ANSIABMA112014Results':
        ...
        if _1849.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1850.ANSIABMA92015Results':
        ...
        if _1850.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1838.ISO2812007Results':
        ...
        if _1838.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1836.BallISO2812007Results':
        ...
        if _1836.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1842.RollerISO2812007Results':
        ...
        if _1842.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1841.ISOTS162812008Results':
        ...
        if _1841.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1837.BallISOTS162812008Results':
        ...
        if _1837.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1843.RollerISOTS162812008Results':
        ...
        if _1843.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1839.ISO762006Results':
        ...
        return constructor.new(_1839.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 is not None else None

    @property
    def maximum_static_contact_stress(self) -> '_1795.MaximumStaticContactStress':
        ...
        return constructor.new(_1795.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress is not None else None

    @property
    def skf_module_results(self) -> '_1833.SKFModuleResults':
        ...
        return constructor.new(_1833.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults is not None else None

    @property
    def rows(self) -> 'List[_1768.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1768.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1848.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1848.RingFittingThermalResults))
        return value
