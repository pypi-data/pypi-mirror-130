...
from mastapy.bearings.bearing_results.rolling.skf_module import _1827, _1831
...
class Viscosities(_1831.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1827.OperatingViscosity':
        ...
        return constructor.new(_1827.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity is not None else None
