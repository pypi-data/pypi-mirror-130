...
class GreaseLifeAndRelubricationInterval(_1831.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1821.Grease':
        ...
        return constructor.new(_1821.Grease)(self.wrapped.Grease) if self.wrapped.Grease is not None else None

    @property
    def initial_fill(self) -> '_1824.InitialFill':
        ...
        return constructor.new(_1824.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill is not None else None

    @property
    def grease_quantity(self) -> '_1823.GreaseQuantity':
        ...
        return constructor.new(_1823.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity is not None else None
