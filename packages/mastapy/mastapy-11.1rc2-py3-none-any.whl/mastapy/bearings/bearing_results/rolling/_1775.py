...
from mastapy.bearings.bearing_results.rolling import _1774, _1764
...
class LoadedSphericalRollerRadialBearingRow(_1764.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1774.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1774.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
