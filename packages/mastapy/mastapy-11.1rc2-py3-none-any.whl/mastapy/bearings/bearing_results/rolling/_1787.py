...
from mastapy.bearings.bearing_results.rolling import _1786, _1737
...
class LoadedThreePointContactBallBearingRow(_1737.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1786.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1786.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
