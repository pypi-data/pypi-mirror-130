...
from mastapy.bearings.bearing_results.rolling import _1799, _1758
...
class LoadedCylindricalRollerBearingResults(_1758.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_1799.PermissibleContinuousAxialLoadResults':
        ...
        return constructor.new(_1799.PermissibleContinuousAxialLoadResults)(self.wrapped.PermissibleContinuousAxialLoad) if self.wrapped.PermissibleContinuousAxialLoad is not None else None
