...
from mastapy.bearings.bearing_designs.fluid_film import _1919
...
class TiltingPadThrustBearing(_1919.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1641.TiltingPadTypes':
        ...
        return constructor.new(_1641.TiltingPadTypes)(value) if value is not None else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1641.TiltingPadTypes'):
