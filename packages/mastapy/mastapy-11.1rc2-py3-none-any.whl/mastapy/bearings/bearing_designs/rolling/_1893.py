...
from mastapy.bearings.bearing_designs.rolling import _1895, _1896, _1894
...
class NonBarrelRollerBearing(_1894.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1895.RollerEndShape':
        ...
        return constructor.new(_1895.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1895.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1896.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1896.RollerRibDetail))
        return value
