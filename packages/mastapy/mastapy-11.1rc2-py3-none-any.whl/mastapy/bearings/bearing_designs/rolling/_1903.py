...
from mastapy.bearings.bearing_designs.rolling import _1896, _1893
...
class TaperRollerBearing(_1893.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1620.BearingMeasurementType':
        ...
        return constructor.new(_1620.BearingMeasurementType)(value) if value is not None else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1620.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1896.RollerRibDetail':
        ...
        return constructor.new(_1896.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail is not None else None
