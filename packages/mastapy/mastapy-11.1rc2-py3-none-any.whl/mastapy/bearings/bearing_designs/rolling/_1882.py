...
class CylindricalRollerBearing(_1893.NonBarrelRollerBearing):
    '''CylindricalRollerBearing
    ...
    @property
    def permissible_axial_load_default_calculation_method(self) -> '_1682.CylindricalRollerMaxAxialLoadMethod':
        ...
        return constructor.new(_1682.CylindricalRollerMaxAxialLoadMethod)(value) if value is not None else None

    @permissible_axial_load_default_calculation_method.setter
    def permissible_axial_load_default_calculation_method(self, value: '_1682.CylindricalRollerMaxAxialLoadMethod'):
