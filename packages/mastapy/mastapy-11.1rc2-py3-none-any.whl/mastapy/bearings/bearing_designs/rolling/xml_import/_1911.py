...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1909, _1908
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1909.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1909.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1908.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1908.AbstractXmlVariableAssignment))
        return value
