...
class RollingBearingDatabase(_1592.SQLDatabase['_1636.RollingBearingKey', '_1897.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1897.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1897.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1613.BearingCatalog', type_: '_1638.RollingBearingType', bore_range: '_1282.Range', outer_diameter_range: '_1282.Range', width_range: '_1282.Range', dynamic_capacity_range: '_1282.Range', number_of_rows: 'int', material_type: '_1627.HybridSteelAll') -> 'List[_1897.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1613.BearingCatalog', type_: '_1638.RollingBearingType') -> 'List[_1897.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else '', catalog, type_), constructor.new(_1897.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1613.BearingCatalog') -> '_1897.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1613.BearingCatalog') -> 'List[_1897.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1897.RollingBearing))

    def create_bearing(self, type_: '_1638.RollingBearingType', designation: Optional['str'] = 'None') -> '_1897.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1897.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1638.RollingBearingType', designation: Optional['str'] = 'None') -> '_1636.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1636.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
