...
class MaterialsSettings(_1382.PerMachineSettings):
    ...
    @property
    def available_material_standards(self) -> 'List[_1603.EnumWithBool[_242.MaterialStandards]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AvailableMaterialStandards, constructor.new(_1603.EnumWithBool)[_242.MaterialStandards])
        return value
