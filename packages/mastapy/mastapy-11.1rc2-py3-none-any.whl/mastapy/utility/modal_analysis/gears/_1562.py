...
from mastapy.utility.modal_analysis.gears import _1563, _1566, _1568
...
class GearOrderForTE(_1568.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1563.GearPositions':
        ...
        return constructor.new(_1563.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1566.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1566.OrderForTE))
        return value
