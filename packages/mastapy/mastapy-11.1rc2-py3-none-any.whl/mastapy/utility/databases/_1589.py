...
from mastapy.utility.databases import _1590, _1592, _1591
...
TValue = TypeVar('TValue', bound='_1590.NamedDatabaseItem')


class NamedDatabase(_1592.SQLDatabase['_1591.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1590.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1590.NamedDatabaseItem') -> '_1590.NamedDatabaseItem':
