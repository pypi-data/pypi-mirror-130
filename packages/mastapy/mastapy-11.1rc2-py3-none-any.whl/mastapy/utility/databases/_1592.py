...
from mastapy.utility.databases import _1590, _1587, _1586
...
TKey = TypeVar('TKey', bound='_1587.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1586.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1590.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1587.DatabaseKey'):
