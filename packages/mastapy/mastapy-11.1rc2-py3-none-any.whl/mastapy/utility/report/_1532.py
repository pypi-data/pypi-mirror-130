...
from mastapy.utility.report import _1533, _1534
...
T = TypeVar('T', bound='_1534.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1533.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
