...
from mastapy.utility.report import _1537, _1540
...
TItem = TypeVar('TItem', bound='_1540.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1537.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
