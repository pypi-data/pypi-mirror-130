...
class DesignConstraintsCollection(_1590.NamedDatabaseItem):
    ...
    @property
    def design_constraints(self) -> 'List[_1597.DeletableCollectionMember[_896.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1597.DeletableCollectionMember)[_896.DesignConstraint])
        return value
