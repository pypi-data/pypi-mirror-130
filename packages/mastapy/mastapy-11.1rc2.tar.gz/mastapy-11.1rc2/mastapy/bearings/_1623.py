...
from mastapy.bearings import (
    _1633, _1632, _1625, _1626
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1830
...
class BearingSettings(_1382.PerMachineSettings):
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1632.RatingLife':
        ...
        return constructor.new(_1632.RatingLife)(value) if value is not None else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1632.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1625.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1625.ExponentAndReductionFactorsInISO16281Calculation)(value) if value is not None else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1625.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_authentication(self) -> '_1830.SKFAuthentication':
        ...
        return constructor.new(_1830.SKFAuthentication)(self.wrapped.SKFAuthentication) if self.wrapped.SKFAuthentication is not None else None
