...
from mastapy.bearings.bearing_designs.concept import _1928, _1930
...
class ConceptAxialClearanceBearing(_1930.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1928.BearingNodePosition':
        ...
        return constructor.new(_1928.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_1928.BearingNodePosition'):
