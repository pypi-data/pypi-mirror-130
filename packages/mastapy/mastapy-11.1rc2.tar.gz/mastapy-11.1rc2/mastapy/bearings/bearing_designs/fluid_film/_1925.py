...
class PlainOilFedJournalBearing(_1923.PlainJournalBearing):
    '''PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self) -> '_1629.JournalOilFeedType':
        '''JournalOilFeedType: 'FeedType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FeedType)
        return constructor.new(_1629.JournalOilFeedType)(value) if value is not None else None

    @feed_type.setter
    def feed_type(self, value: '_1629.JournalOilFeedType'):
    ...
    @property
    def axial_groove_oil_feed(self) -> '_1914.AxialGrooveJournalBearing':
        ...
        return constructor.new(_1914.AxialGrooveJournalBearing)(self.wrapped.AxialGrooveOilFeed) if self.wrapped.AxialGrooveOilFeed is not None else None

    @property
    def axial_hole_oil_feed(self) -> '_1915.AxialHoleJournalBearing':
        ...
        return constructor.new(_1915.AxialHoleJournalBearing)(self.wrapped.AxialHoleOilFeed) if self.wrapped.AxialHoleOilFeed is not None else None

    @property
    def circumferential_groove_oil_feed(self) -> '_1916.CircumferentialFeedJournalBearing':
        ...
        return constructor.new(_1916.CircumferentialFeedJournalBearing)(self.wrapped.CircumferentialGrooveOilFeed) if self.wrapped.CircumferentialGrooveOilFeed is not None else None
