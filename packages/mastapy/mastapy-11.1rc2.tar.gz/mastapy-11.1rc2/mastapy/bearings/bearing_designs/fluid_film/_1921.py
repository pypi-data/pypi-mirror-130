...
class PlainGreaseFilledJournalBearing(_1923.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1922.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1922.PlainGreaseFilledJournalBearingHousingType)(value) if value is not None else None

    @housing_type.setter
    def housing_type(self, value: '_1922.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1924.PlainJournalHousing':
        ...
        if _1924.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1917.CylindricalHousingJournalBearing':
        ...
        if _1917.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1918.MachineryEncasedJournalBearing':
        ...
        if _1918.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1920.PedestalJournalBearing':
        ...
        if _1920.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
