...
class LinearBearing(_1864.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1624.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1624.BearingStiffnessMatrixOption)(value) if value is not None else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1624.BearingStiffnessMatrixOption'):
