...
from mastapy.bearings.bearing_designs.rolling import _1885, _1891
...
class FourPointContactBallBearing(_1891.MultiPointContactBallBearing):
    '''FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_1885.FourPointContactAngleDefinition':
        ...
        return constructor.new(_1885.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_1885.FourPointContactAngleDefinition'):
