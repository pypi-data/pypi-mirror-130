...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1879.BearingProtectionLevel':
        ...
        return constructor.new(_1879.BearingProtectionLevel)(value) if value is not None else None

    @property
    def new_protection_level(self) -> '_1879.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1879.BearingProtectionLevel'):
