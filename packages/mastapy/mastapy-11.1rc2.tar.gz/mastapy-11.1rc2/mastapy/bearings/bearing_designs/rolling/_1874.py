...
from mastapy.bearings.bearing_designs.rolling import _1875, _1897
...
class BallBearing(_1897.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1875.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1875.BallBearingShoulderDefinition))
        return value
