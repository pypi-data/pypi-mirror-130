...
from mastapy.bearings import _1631
...
class ThrustBallBearing(_1874.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1631.OuterRingMounting':
        ...
        return constructor.new(_1631.OuterRingMounting)(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1631.OuterRingMounting'):
