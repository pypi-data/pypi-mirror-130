...
from mastapy.bearings.bearing_results.rolling import _1746, _1737
...
class LoadedDeepGrooveBallBearingRow(_1737.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1746.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1746.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
