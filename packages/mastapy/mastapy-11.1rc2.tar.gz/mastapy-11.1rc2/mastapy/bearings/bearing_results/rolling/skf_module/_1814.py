...
from mastapy.bearings.bearing_results.rolling.skf_module import _1825, _1831
...
class BearingRatingLife(_1831.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1825.LifeModel':
        ...
        return constructor.new(_1825.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel is not None else None
