...
from mastapy.bearings.bearing_results.rolling import (
    _1736, _1717, _1720, _1746,
    _1751, _1770, _1786, _1789,
    _1735, _1768
)
...
class LoadedBallBearingRow(_1768.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1736.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1735.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1735.LoadedBallBearingRaceResults))
        return value
