...
from mastapy.bearings.bearing_results.rolling import _1743, _1755, _1759
...
class LoadedCylindricalRollerBearingRow(_1759.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1743.LoadedCylindricalRollerBearingResults':
