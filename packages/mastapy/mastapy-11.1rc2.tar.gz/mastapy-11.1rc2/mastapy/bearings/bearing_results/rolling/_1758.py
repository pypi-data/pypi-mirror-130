...
from mastapy.bearings.bearing_results.rolling import _1807, _1763
...
class LoadedNonBarrelRollerBearingResults(_1763.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1807.SMTRibStressResults':
        ...
        return constructor.new(_1807.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress is not None else None
