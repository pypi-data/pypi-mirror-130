...
from mastapy.bearings.bearing_results.rolling import _1770, _1737
...
class LoadedSelfAligningBallBearingRow(_1737.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1770.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1770.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
