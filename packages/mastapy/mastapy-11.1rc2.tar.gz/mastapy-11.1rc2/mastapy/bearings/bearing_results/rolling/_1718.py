...
from mastapy.bearings.bearing_results.rolling import _1717, _1720, _1737
...
class LoadedAngularContactBallBearingRow(_1737.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1717.LoadedAngularContactBallBearingResults':
