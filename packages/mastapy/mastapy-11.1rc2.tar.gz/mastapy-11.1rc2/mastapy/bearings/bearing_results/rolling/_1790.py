...
from mastapy.bearings.bearing_results.rolling import _1789, _1737
...
class LoadedThrustBallBearingRow(_1737.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1789.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1789.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
