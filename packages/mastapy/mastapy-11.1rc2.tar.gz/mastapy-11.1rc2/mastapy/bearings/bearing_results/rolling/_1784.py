...
from mastapy.bearings.bearing_results.rolling import _1783, _1759
...
class LoadedTaperRollerBearingRow(_1759.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1783.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1783.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
