...
from mastapy.bearings.bearing_results.rolling import _1777, _1764
...
class LoadedSphericalRollerThrustBearingRow(_1764.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1777.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1777.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
