...
from mastapy.bearings.bearing_results.rolling import _1723, _1764
...
class LoadedAsymmetricSphericalRollerBearingRow(_1764.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1723.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1723.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
