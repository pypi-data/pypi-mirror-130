...
from mastapy.bearings.bearing_results.rolling.skf_module import _1828, _1831
...
class DynamicAxialLoadCarryingCapacity(_1831.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1828.PermissibleAxialLoad':
        ...
        return constructor.new(_1828.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad is not None else None
