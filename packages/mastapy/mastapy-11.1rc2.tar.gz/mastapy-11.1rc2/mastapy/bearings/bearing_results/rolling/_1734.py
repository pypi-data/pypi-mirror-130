...
from mastapy.bearings.bearing_results.rolling import _1706, _1748
...
class LoadedBallBearingElement(_1748.LoadedElement):
    '''LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1706.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceContactGeometries, constructor.new(_1706.BallBearingRaceContactGeometry))
        return value

    @property
    def outer_race_contact_geometries(self) -> 'List[_1706.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceContactGeometries, constructor.new(_1706.BallBearingRaceContactGeometry))
        return value
