...
from mastapy.bearings.bearing_results.rolling import _1731, _1729
...
class LoadedAxialThrustNeedleRollerBearingRow(_1729.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1731.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1731.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
