...
from mastapy.bearings.bearing_results.rolling.skf_module import _1812, _1831
...
class AdjustedSpeed(_1831.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1812.AdjustmentFactors':
        ...
        return constructor.new(_1812.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors is not None else None
