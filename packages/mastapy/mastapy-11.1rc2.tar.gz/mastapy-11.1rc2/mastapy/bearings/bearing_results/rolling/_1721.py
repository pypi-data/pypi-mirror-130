...
class LoadedAngularContactThrustBallBearingRow(_1718.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1720.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1720.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
