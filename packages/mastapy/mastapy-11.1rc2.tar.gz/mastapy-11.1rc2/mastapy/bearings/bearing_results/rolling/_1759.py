...
class LoadedNonBarrelRollerBearingRow(_1764.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1758.LoadedNonBarrelRollerBearingResults':
