...
from mastapy.bearings.bearing_results.fluid_film import _1857, _1853
...
class LoadedPlainJournalBearingResults(_1853.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1857.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1857.LoadedPlainJournalBearingRow))
        return value
