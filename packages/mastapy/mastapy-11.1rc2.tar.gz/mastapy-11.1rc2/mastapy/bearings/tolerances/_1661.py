...
from mastapy.bearings.tolerances import _1657, _1649
...
class SupportDetail(_1649.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1657.RadialSpecificationMethod':
        ...
        return constructor.new(_1657.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1657.RadialSpecificationMethod'):
