...
class PartSteadyStateSynchronousResponseOnAShaft(_7250.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self) -> '_1985.SteadyStateSynchronousResponseViewable':
