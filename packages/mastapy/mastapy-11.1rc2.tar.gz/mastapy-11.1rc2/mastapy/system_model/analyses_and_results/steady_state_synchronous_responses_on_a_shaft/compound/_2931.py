...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_2833.AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2801.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2801.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2801.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2801.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft))
        return value
