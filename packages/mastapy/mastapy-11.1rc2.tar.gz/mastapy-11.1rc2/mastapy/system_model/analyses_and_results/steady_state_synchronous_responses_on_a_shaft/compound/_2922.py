...
class RingPinsCompoundSteadyStateSynchronousResponseOnAShaft(_2910.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''RingPinsCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2792.RingPinsSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2792.RingPinsSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2792.RingPinsSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2792.RingPinsSteadyStateSynchronousResponseOnAShaft))
        return value
