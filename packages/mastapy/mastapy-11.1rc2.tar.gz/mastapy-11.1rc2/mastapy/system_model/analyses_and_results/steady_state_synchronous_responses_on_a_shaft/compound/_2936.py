...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_2871.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2805.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2805.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2805.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2805.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
