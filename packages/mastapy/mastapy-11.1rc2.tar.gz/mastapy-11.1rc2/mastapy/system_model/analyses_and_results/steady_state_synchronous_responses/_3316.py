...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3327, _3228
...
class RootAssemblySteadyStateSynchronousResponse(_3228.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3327.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3327.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs is not None else None
