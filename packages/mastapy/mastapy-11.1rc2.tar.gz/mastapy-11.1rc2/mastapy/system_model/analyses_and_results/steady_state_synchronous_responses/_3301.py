...
class PartSteadyStateSynchronousResponse(_7250.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3327.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3327.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse is not None else None
