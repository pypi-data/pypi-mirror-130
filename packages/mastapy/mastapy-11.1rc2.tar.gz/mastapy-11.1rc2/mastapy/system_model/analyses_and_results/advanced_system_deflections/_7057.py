...
from mastapy.system_model.drawing import _1970
...
class PartAdvancedSystemDeflection(_7250.PartStaticLoadAnalysisCase):
    '''PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6976.AdvancedSystemDeflection':
        ...
        return constructor.new(_6976.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None
    ...
    def create_viewable(self) -> '_1970.AdvancedSystemDeflectionViewable':
