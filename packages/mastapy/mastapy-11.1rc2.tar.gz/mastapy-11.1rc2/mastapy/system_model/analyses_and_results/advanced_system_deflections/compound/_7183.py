...
class MassDiscCompoundAdvancedSystemDeflection(_7230.VirtualComponentCompoundAdvancedSystemDeflection):
    '''MassDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7053.MassDiscAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7053.MassDiscAdvancedSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7053.MassDiscAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7053.MassDiscAdvancedSystemDeflection))
        return value
