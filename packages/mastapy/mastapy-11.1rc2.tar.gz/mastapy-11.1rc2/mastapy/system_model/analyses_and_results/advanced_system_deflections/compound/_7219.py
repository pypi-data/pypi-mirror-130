...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7213
...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7213.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    '''StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7089.StraightBevelPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7089.StraightBevelPlanetGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7089.StraightBevelPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7089.StraightBevelPlanetGearAdvancedSystemDeflection))
        return value
