...
class RingPinsAdvancedSystemDeflection(_7055.MountableComponentAdvancedSystemDeflection):
    '''RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2514.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2514.RingPinsSystemDeflection))
        return value
