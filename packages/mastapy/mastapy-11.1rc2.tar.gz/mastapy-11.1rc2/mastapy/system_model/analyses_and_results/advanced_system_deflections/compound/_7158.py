...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7155.CylindricalGearCompoundAdvancedSystemDeflection):
    '''CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7027.CylindricalPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7027.CylindricalPlanetGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7027.CylindricalPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7027.CylindricalPlanetGearAdvancedSystemDeflection))
        return value
