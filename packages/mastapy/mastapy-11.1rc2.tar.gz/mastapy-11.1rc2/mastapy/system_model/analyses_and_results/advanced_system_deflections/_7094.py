...
class SynchroniserSleeveAdvancedSystemDeflection(_7093.SynchroniserPartAdvancedSystemDeflection):
    '''SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2543.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2543.SynchroniserSleeveSystemDeflection))
        return value
