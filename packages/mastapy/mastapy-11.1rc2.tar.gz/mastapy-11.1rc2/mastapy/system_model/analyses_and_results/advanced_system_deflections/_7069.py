...
class RollingRingAdvancedSystemDeflection(_7015.CouplingHalfAdvancedSystemDeflection):
    '''RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2519.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2519.RollingRingSystemDeflection))
        return value
