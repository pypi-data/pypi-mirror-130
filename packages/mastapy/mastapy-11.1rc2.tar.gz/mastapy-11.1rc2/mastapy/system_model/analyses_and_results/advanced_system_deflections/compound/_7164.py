...
class FEPartCompoundAdvancedSystemDeflection(_7110.AbstractShaftOrHousingCompoundAdvancedSystemDeflection):
    '''FEPartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7033.FEPartAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7033.FEPartAdvancedSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7033.FEPartAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7033.FEPartAdvancedSystemDeflection))
        return value
