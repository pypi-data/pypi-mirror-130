...
class CycloidalDiscSystemDeflection(_2412.AbstractShaftSystemDeflection):
    '''CycloidalDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3796.CycloidalDiscPowerFlow':
        ...
        return constructor.new(_3796.CycloidalDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
