...
class AbstractShaftCompoundSystemDeflection(_2573.AbstractShaftOrHousingCompoundSystemDeflection):
    '''AbstractShaftCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2412.AbstractShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2412.AbstractShaftSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2412.AbstractShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2412.AbstractShaftSystemDeflection))
        return value
