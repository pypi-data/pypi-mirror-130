...
class RingPinsCompoundSystemDeflection(_2649.MountableComponentCompoundSystemDeflection):
    '''RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2514.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2514.RingPinsSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2514.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2514.RingPinsSystemDeflection))
        return value
