...
class BevelGearSetSystemDeflection(_2415.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3768.BevelGearSetPowerFlow':
