...
from mastapy.system_model.analyses_and_results.power_flows import _3841, _3792
...
class PulleySystemDeflection(_2450.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3841.PulleyPowerFlow':
