...
class CylindricalPlanetGearSystemDeflection(_2467.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3801.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3801.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
