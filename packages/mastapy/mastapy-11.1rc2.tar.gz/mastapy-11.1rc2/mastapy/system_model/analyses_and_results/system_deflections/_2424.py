...
class BevelDifferentialPlanetGearSystemDeflection(_2423.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3764.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3764.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
