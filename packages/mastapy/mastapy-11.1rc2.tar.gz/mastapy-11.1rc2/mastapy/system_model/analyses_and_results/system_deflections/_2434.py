...
from mastapy.system_model.analyses_and_results.power_flows import _3774, _3794
...
class CoaxialConnectionSystemDeflection(_2525.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3774.CoaxialConnectionPowerFlow':
