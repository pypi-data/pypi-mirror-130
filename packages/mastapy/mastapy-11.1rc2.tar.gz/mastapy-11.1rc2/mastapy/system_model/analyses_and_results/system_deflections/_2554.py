...
class UnbalancedMassSystemDeflection(_2555.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3875.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3875.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
