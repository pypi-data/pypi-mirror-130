...
class ShaftToMountableComponentConnectionSystemDeflection(_2413.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3850.ShaftToMountableComponentConnectionPowerFlow':
