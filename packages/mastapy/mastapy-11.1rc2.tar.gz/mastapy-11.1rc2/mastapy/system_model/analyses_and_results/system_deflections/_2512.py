...
from mastapy.system_model.analyses_and_results.system_deflections import _2553, _2555
...
class PowerLoadSystemDeflection(_2555.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3840.PowerLoadPowerFlow':
        ...
        return constructor.new(_3840.PowerLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2553.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2553.TransmissionErrorResult))
        return value
