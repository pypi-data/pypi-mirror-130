...
class ShaftToMountableComponentConnectionCompoundSystemDeflection(_2574.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    '''ShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2525.ShaftToMountableComponentConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2525.ShaftToMountableComponentConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2525.ShaftToMountableComponentConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2525.ShaftToMountableComponentConnectionSystemDeflection))
        return value
