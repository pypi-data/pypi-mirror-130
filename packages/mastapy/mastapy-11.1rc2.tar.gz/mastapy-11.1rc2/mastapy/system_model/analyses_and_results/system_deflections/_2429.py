...
class BoltedJointSystemDeflection(_2526.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.BoltedJointPowerFlow':
        ...
        return constructor.new(_3769.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
