...
class AGMAGleasonConicalGearSetSystemDeflection(_2445.ConicalGearSetSystemDeflection):
    '''AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3756.AGMAGleasonConicalGearSetPowerFlow':
