...
from mastapy.system_model.drawing import _1982, _1972
...
class SystemDeflectionDrawStyle(_1972.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1982.ScalingDrawStyle':
        ...
        return constructor.new(_1982.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling is not None else None
