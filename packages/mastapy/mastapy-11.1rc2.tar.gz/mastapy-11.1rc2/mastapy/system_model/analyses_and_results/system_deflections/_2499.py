...
class MassDiscSystemDeflection(_2555.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3826.MassDiscPowerFlow':
        ...
        return constructor.new(_3826.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
