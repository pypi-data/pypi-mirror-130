...
class VirtualComponentSystemDeflection(_2502.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3876.VirtualComponentPowerFlow':
