...
from mastapy.system_model.analyses_and_results.power_flows import _3867, _3866, _3869
...
class SynchroniserPartSystemDeflection(_2450.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3867.SynchroniserPartPowerFlow':
