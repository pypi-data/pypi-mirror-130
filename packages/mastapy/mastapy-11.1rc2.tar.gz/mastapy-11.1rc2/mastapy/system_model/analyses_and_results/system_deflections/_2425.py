...
class BevelDifferentialSunGearSystemDeflection(_2423.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3765.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3765.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
