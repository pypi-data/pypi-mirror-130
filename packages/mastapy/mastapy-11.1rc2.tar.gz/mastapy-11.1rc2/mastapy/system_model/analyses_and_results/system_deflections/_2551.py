...
class TorqueConverterTurbineSystemDeflection(_2450.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3874.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3874.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
