...
class ConceptCouplingConnectionSystemDeflection(_2449.CouplingConnectionSystemDeflection):
    '''ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3776.ConceptCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3776.ConceptCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
