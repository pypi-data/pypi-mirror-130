...
from mastapy.system_model.analyses_and_results.system_deflections import _2497, _2547
from mastapy.system_model.fe import _2133
from mastapy.system_model.analyses_and_results.analysis_cases import _7246
...
class SystemDeflection(_7246.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2497.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2497.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults is not None else None

    @property
    def analysis_options(self) -> '_2547.SystemDeflectionOptions':
        ...
        return constructor.new(_2547.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions is not None else None
