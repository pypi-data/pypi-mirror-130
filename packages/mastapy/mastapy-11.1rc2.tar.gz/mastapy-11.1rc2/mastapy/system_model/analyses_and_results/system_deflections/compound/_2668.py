...
class ShaftDutyCycleSystemDeflection(_0.APIBase):
    ...
    @property
    def shaft_design(self) -> '_2208.Shaft':
        ...
        return constructor.new(_2208.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign is not None else None
    ...
    @property
    def shaft_static_analyses(self) -> 'List[_2524.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2524.ShaftSystemDeflection))
        return value
