...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness(_4442.CoaxialConnectionCompoundModalAnalysisAtAStiffness):
    '''CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4332.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4332.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4332.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4332.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness))
        return value
