...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4467.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    '''PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4373.PlanetaryGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4373.PlanetaryGearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4373.PlanetaryGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4373.PlanetaryGearSetModalAnalysisAtAStiffness))
        return value
