...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2362, _4295
...
class RootAssemblyModalAnalysisAtAStiffness(_4295.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2362.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2362.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs is not None else None
