...
class MassDiscCompoundModalAnalysisAtAStiffness(_4540.VirtualComponentCompoundModalAnalysisAtAStiffness):
    '''MassDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4364.MassDiscModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4364.MassDiscModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4364.MassDiscModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4364.MassDiscModalAnalysisAtAStiffness))
        return value
