...
class MassDiscCompoundMultibodyDynamicsAnalysis(_5361.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    '''MassDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5170.MassDiscMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5170.MassDiscMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5170.MassDiscMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5170.MassDiscMultibodyDynamicsAnalysis))
        return value
