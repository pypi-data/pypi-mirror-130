...
class AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis(_5271.ConicalGearCompoundMultibodyDynamicsAnalysis):
    '''AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5092.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5092.AGMAGleasonConicalGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5092.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5092.AGMAGleasonConicalGearMultibodyDynamicsAnalysis))
        return value
