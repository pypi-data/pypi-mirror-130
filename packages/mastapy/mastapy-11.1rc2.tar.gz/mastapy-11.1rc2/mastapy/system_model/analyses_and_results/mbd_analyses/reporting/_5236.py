...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5233
...
class DynamicTorqueResultAtTime(_5233.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
