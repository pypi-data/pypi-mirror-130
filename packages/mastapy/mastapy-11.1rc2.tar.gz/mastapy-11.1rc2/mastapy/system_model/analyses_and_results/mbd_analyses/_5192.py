...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2364, _5095
...
class RootAssemblyMultibodyDynamicsAnalysis(_5095.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2364.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2364.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs is not None else None
