...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5235
...
class BearingMultibodyDynamicsAnalysis(_5126.ConnectorMultibodyDynamicsAnalysis):
    '''BearingMultibodyDynamicsAnalysis
