...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5327
...
class CVTPulleyCompoundMultibodyDynamicsAnalysis(_5327.PulleyCompoundMultibodyDynamicsAnalysis):
    '''CVTPulleyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5132.CVTPulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5132.CVTPulleyMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5132.CVTPulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5132.CVTPulleyMultibodyDynamicsAnalysis))
        return value
