...
from mastapy.system_model.part_model.couplings import _2329, _2331
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2329.SynchroniserHalf':
        ...
        return constructor.new(_2329.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone is not None else None

    @property
    def sleeve(self) -> '_2331.SynchroniserSleeve':
        ...
        return constructor.new(_2331.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve is not None else None
