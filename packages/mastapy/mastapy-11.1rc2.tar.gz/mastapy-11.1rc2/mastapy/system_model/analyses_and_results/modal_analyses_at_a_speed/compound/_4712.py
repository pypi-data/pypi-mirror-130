...
class ConnectorCompoundModalAnalysisAtASpeed(_4753.MountableComponentCompoundModalAnalysisAtASpeed):
    '''ConnectorCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4583.ConnectorModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4583.ConnectorModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4583.ConnectorModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4583.ConnectorModalAnalysisAtASpeed))
        return value
