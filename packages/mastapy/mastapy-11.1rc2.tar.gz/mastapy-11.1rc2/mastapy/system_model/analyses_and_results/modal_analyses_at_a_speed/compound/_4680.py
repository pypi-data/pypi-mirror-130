...
class AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed(_4708.ConicalGearCompoundModalAnalysisAtASpeed):
    '''AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4552.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4552.AGMAGleasonConicalGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4552.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4552.AGMAGleasonConicalGearModalAnalysisAtASpeed))
        return value
