...
from mastapy.system_model.analyses_and_results.static_loads import _6544, _6590
...
class ConicalGearLoadCase(_6590.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6544.ConicalGearManufactureError':
        ...
        return constructor.new(_6544.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None
