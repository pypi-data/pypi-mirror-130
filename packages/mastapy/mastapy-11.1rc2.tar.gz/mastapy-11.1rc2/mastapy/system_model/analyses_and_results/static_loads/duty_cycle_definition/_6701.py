...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6692
from mastapy.utility_gui import _1607
...
class PointLoadInputOptions(_1607.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6692.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6692.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6692.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
