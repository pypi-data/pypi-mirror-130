...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6708, _6702
...
class TorqueInputOptions(_6702.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6708.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6708.TorqueValuesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6708.TorqueValuesObtainedFrom'):
