...
from mastapy.system_model.analyses_and_results.static_loads import _6516, _6627
...
class RingPinsLoadCase(_6627.MountableComponentLoadCase):
    '''RingPinsLoadCase
    ...
    @property
    def all_ring_pins_manufacturing_error(self) -> '_6516.AllRingPinsManufacturingError':
        ...
        return constructor.new(_6516.AllRingPinsManufacturingError)(self.wrapped.AllRingPinsManufacturingError) if self.wrapped.AllRingPinsManufacturingError is not None else None
