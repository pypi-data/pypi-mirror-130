...
from mastapy.system_model.analyses_and_results.static_loads import _6593, _6598
...
class GearSetHarmonicLoadData(_6598.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6593.GearMeshTEOrderType':
        ...
        return constructor.new(_6593.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6593.GearMeshTEOrderType'):
