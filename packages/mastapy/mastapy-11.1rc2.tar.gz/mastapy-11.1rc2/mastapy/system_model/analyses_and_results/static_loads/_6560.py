...
from mastapy.system_model.analyses_and_results.static_loads import _6561, _6590
...
class CylindricalGearLoadCase(_6590.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6561.CylindricalGearManufactureError':
        ...
        return constructor.new(_6561.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None
