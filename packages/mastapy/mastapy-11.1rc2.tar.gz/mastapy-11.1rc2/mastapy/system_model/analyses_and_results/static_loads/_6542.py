...
from mastapy.system_model.analyses_and_results.static_loads import _6540, _6541, _6595
...
class ConceptGearSetLoadCase(_6595.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6540.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6540.ConceptGearLoadCase))
        return value

    @property
    def concept_gears_load_case(self) -> 'List[_6540.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6540.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6541.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6541.ConceptGearMeshLoadCase))
        return value
