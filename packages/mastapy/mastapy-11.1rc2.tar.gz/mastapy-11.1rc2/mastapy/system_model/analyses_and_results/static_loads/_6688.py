...
from mastapy.system_model.analyses_and_results.static_loads import _6686, _6687, _6595
...
class WormGearSetLoadCase(_6595.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6686.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6686.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6686.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6686.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6687.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6687.WormGearMeshLoadCase))
        return value
