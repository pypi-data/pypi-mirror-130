...
from mastapy.system_model.analyses_and_results.static_loads import _6606, _6602, _6580
...
class HarmonicLoadDataImportFromMotorPackages(_6602.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
