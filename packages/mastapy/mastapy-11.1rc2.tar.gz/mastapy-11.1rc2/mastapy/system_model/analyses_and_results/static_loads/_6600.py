...
from mastapy.system_model.analyses_and_results.static_loads import _6628, _6602, _6578
...
class HarmonicLoadDataExcelImport(_6602.HarmonicLoadDataImportBase['_6578.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6628.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6628.NamedSpeed))
        return value
