...
from mastapy.utility.file_access_helpers import _1580
from mastapy.utility_gui import _1608
...
class MultiTimeSeriesDataInputFileOptions(_1608.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1580.TextFileDelimiterOptions':
        ...
        return constructor.new(_1580.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions is not None else None
