...
from mastapy.bearings.bearing_results.rolling import _1710, _1804, _1805
from mastapy.bearings.bearing_results import _1682
from mastapy.system_model.part_model import _2167
from mastapy.bearings.tolerances import _1655, _1661
...
class BearingLoadCase(_6549.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5097.BearingStiffnessModel':
        ...
        return constructor.new(_5097.BearingStiffnessModel)(value) if value is not None else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5097.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5097.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1655.RaceDetail':
        ...
        return constructor.new(_1655.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail is not None else None

    @property
    def right_ring_detail(self) -> '_1655.RaceDetail':
        ...
        return constructor.new(_1655.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail is not None else None
    ...
    @property
    def inner_ring_detail(self) -> '_1655.RaceDetail':
        ...
        return constructor.new(_1655.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail is not None else None
    ...
    @property
    def outer_ring_detail(self) -> '_1655.RaceDetail':
        ...
        return constructor.new(_1655.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail is not None else None
