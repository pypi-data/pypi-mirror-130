...
from mastapy.system_model.analyses_and_results.static_loads import _6572, _6580
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6572.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
