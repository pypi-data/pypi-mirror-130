...
from mastapy.system_model.analyses_and_results.static_loads import _6607, _6608, _6515
...
class HypoidGearSetLoadCase(_6515.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6607.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6607.HypoidGearLoadCase))
        return value

    @property
    def hypoid_gears_load_case(self) -> 'List[_6607.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_6607.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_6608.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_6608.HypoidGearMeshLoadCase))
        return value
