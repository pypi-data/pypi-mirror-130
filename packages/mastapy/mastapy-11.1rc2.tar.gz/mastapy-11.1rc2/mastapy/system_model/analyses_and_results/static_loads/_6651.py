...
class RootAssemblyLoadCase(_6518.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6564.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6564.CylindricalGearSetLoadCase))
        return value
