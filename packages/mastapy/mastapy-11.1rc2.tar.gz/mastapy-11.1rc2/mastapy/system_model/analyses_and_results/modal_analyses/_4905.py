...
from mastapy.system_model.analyses_and_results.modal_analyses import _2360, _4812
...
class RootAssemblyModalAnalysis(_4812.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2360.ModalAnalysis':
        ...
        if _2360.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
