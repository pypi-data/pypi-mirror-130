...
class BoltCompoundModalAnalysis(_4983.ComponentCompoundModalAnalysis):
    '''BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4825.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4825.BoltModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4825.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4825.BoltModalAnalysis))
        return value
