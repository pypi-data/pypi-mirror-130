...
class ShaftHubConnectionCompoundModalAnalysis(_4994.ConnectorCompoundModalAnalysis):
    '''ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4906.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4906.ShaftHubConnectionModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4906.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4906.ShaftHubConnectionModalAnalysis))
        return value
