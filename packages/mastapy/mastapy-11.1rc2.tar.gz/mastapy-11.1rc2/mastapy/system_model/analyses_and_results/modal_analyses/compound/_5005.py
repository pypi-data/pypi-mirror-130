...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5016
...
class CylindricalGearCompoundModalAnalysis(_5016.GearCompoundModalAnalysis):
    '''CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4854.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4854.CylindricalGearModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4854.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4854.CylindricalGearModalAnalysis))
        return value
