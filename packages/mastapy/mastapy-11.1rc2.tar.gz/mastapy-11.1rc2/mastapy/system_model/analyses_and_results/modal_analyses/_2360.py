...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2351
...
from mastapy.system_model.analyses_and_results.modal_analyses import _2354, _4886, _4884
...
class ModalAnalysis(_7252.StaticLoadAnalysisCase):
    '''ModalAnalysis
    ...
    @property
    def modal_analysis_results(self) -> '_2351.DynamicAnalysis':
        ...
        if _2351.DynamicAnalysis.TYPE not in self.wrapped.ModalAnalysisResults.__class__.__mro__:
    ...
    @property
    def analysis_settings(self) -> '_4886.ModalAnalysisOptions':
        ...
        return constructor.new(_4886.ModalAnalysisOptions)(self.wrapped.AnalysisSettings) if self.wrapped.AnalysisSettings is not None else None

    @property
    def bar_model_export(self) -> '_4884.ModalAnalysisBarModelFEExportOptions':
        ...
        return constructor.new(_4884.ModalAnalysisBarModelFEExportOptions)(self.wrapped.BarModelExport) if self.wrapped.BarModelExport is not None else None
