...
class PartToPartShearCouplingCompoundModalAnalysis(_4995.CouplingCompoundModalAnalysis):
    '''PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4893.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4893.PartToPartShearCouplingModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4893.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4893.PartToPartShearCouplingModalAnalysis))
        return value
