...
class PlanetaryGearSetCompoundModalAnalysis(_5007.CylindricalGearSetCompoundModalAnalysis):
    '''PlanetaryGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4895.PlanetaryGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4895.PlanetaryGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4895.PlanetaryGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4895.PlanetaryGearSetModalAnalysis))
        return value
