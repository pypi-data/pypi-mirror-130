...
class PerModeResultsReport(_1523.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1582.TableAndChartOptions':
    ...
    def display_option(self, value: '_1582.TableAndChartOptions'):
