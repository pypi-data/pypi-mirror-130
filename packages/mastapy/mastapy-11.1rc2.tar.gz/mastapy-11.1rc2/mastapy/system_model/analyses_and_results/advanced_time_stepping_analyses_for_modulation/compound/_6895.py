...
class ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation(_6868.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6765.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6765.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6765.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6765.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation))
        return value
