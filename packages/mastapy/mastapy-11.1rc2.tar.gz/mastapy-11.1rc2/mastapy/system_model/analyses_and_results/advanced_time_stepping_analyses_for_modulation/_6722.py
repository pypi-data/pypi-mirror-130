...
from mastapy.system_model.analyses_and_results.static_loads import _6520, _6553
from mastapy.system_model.analyses_and_results.system_deflections import _2419, _2452
...
class BeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6779.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''BeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6520.BeltConnectionLoadCase':
        ...
        if _6520.BeltConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2419.BeltConnectionSystemDeflection':
