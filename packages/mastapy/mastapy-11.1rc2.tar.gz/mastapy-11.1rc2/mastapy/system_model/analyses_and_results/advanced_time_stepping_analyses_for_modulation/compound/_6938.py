...
class ShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_6844.AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6809.ShaftAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6809.ShaftAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6809.ShaftAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6809.ShaftAdvancedTimeSteppingAnalysisForModulation))
        return value
