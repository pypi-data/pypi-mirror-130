...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6724.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2424.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2424.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
