...
class DatumAdvancedTimeSteppingAnalysisForModulation(_6738.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''DatumAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2471.DatumSystemDeflection':
        ...
        return constructor.new(_2471.DatumSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
