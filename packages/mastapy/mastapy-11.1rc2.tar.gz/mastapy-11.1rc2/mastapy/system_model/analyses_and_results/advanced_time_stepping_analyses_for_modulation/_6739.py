...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_6750.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2439.ConceptCouplingSystemDeflection':
        ...
        return constructor.new(_2439.ConceptCouplingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
