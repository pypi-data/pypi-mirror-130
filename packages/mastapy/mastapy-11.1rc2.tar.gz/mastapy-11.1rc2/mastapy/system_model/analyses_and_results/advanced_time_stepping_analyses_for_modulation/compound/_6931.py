...
from mastapy.system_model.part_model.couplings import _2315, _2312
...
class PulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_6882.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''PulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2315.Pulley':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6802.PulleyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6802.PulleyAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6802.PulleyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6802.PulleyAdvancedTimeSteppingAnalysisForModulation))
        return value
