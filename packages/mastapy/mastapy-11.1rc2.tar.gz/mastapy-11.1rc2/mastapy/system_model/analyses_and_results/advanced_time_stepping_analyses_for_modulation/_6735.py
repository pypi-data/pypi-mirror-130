...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6751.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2431.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2431.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
