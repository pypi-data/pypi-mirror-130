...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6729.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2561.ZerolBevelGearSystemDeflection':
        ...
        return constructor.new(_2561.ZerolBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
