...
class ClutchHalfAdvancedTimeSteppingAnalysisForModulation(_6752.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2432.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2432.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
