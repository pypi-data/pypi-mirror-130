...
class PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6751.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6632.PartToPartShearCouplingConnectionLoadCase':
        ...
        return constructor.new(_6632.PartToPartShearCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None

    @property
    def system_deflection_results(self) -> '_2506.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2506.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
