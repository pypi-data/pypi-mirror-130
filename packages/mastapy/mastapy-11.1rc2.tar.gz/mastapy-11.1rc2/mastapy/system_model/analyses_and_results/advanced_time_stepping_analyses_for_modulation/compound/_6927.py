...
class PlanetaryGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_6892.CylindricalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetaryGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6798.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6798.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6798.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6798.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation))
        return value
