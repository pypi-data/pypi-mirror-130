...
class MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_6965.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6789.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6789.MassDiscAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6789.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6789.MassDiscAdvancedTimeSteppingAnalysisForModulation))
        return value
