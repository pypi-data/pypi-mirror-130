...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6819.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2274.StraightBevelPlanetGear':
        ...
        return constructor.new(_2274.StraightBevelPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2539.StraightBevelPlanetGearSystemDeflection':
        ...
        return constructor.new(_2539.StraightBevelPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
