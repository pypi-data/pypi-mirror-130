...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6772.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2556.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2556.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
