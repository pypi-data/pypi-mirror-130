...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6747.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2415.AGMAGleasonConicalGearSetSystemDeflection':
