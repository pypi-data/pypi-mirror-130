...
class StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation(_6730.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2533.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2533.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
