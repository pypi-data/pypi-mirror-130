...
class PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation(_6762.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_design(self) -> '_2267.PlanetaryGearSet':
        ...
        return constructor.new(_2267.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign is not None else None
