...
class ConceptGearAdvancedTimeSteppingAnalysisForModulation(_6771.GearAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2442.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2442.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
