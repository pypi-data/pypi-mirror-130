...
class GearMeshAdvancedTimeSteppingAnalysisForModulation(_6779.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''GearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2479.GearMeshSystemDeflection':
