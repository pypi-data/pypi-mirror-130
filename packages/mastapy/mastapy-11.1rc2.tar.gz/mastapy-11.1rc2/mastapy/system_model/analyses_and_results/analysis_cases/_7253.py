...
class TimeSeriesLoadAnalysisCase(_7237.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6505.TimeSeriesLoadCase':
        ...
        return constructor.new(_6505.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase is not None else None
