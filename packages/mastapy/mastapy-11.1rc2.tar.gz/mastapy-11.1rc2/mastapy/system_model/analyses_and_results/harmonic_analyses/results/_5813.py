...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    @property
    def selected_result_location_group(self) -> '_5812.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5812.ResultLocationSelectionGroup)(self.wrapped.SelectedResultLocationGroup) if self.wrapped.SelectedResultLocationGroup is not None else None

    @property
    def result_location_groups(self) -> 'List[_5812.ResultLocationSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultLocationGroups, constructor.new(_5812.ResultLocationSelectionGroup))
        return value
