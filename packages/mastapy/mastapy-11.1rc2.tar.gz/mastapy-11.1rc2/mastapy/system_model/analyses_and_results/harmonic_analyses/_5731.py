...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5808
from mastapy.system_model.analyses_and_results.modal_analyses import _4886
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5773, _5719
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5808.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5808.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection is not None else None

    @property
    def modal_analysis_options(self) -> '_4886.ModalAnalysisOptions':
        ...
        return constructor.new(_4886.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions is not None else None
