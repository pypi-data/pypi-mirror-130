...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5733, _5649
...
class ShaftHarmonicAnalysis(_5649.AbstractShaftHarmonicAnalysis):
    '''ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4907.ShaftModalAnalysis':
        ...
        return constructor.new(_4907.ShaftModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis is not None else None

    @property
    def export(self) -> '_5733.HarmonicAnalysisShaftExportOptions':
        ...
        return constructor.new(_5733.HarmonicAnalysisShaftExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2524.ShaftSystemDeflection':
        ...
        return constructor.new(_2524.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
