...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2357
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2357.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
