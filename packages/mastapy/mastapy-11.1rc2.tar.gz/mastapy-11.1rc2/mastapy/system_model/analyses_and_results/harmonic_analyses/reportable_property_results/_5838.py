...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5831, _5815
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5815.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5831.ResultsForOrderIncludingGroups]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5831.ResultsForOrderIncludingGroups))
        return value
