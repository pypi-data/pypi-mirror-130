...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5833, _5839
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5839.SingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5833.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5833.ResultsForOrderIncludingSurfaces))
        return value
