...
class BearingHarmonicAnalysis(_5685.ConnectorHarmonicAnalysis):
    '''BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1806.RollingBearingSpeedResults':
        ...
        return constructor.new(_1806.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2418.BearingSystemDeflection':
        ...
        return constructor.new(_2418.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
