...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5825, _5832
...
class ResultsForOrderIncludingSurfaces(_5832.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5825.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5825.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
