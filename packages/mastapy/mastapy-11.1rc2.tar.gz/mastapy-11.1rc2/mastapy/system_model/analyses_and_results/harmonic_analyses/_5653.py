...
class AGMAGleasonConicalGearMeshHarmonicAnalysis(_5682.ConicalGearMeshHarmonicAnalysis):
    '''AGMAGleasonConicalGearMeshHarmonicAnalysis
    ...
    @property
    def connection_design(self) -> '_2026.AGMAGleasonConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2414.AGMAGleasonConicalGearMeshSystemDeflection':
