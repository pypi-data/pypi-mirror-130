...
from mastapy.system_model.analyses_and_results.system_deflections import _2412, _2458, _2524
...
class AbstractShaftHarmonicAnalysis(_5650.AbstractShaftOrHousingHarmonicAnalysis):
    '''AbstractShaftHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2163.AbstractShaft':
    ...
    @property
    def system_deflection_results(self) -> '_2412.AbstractShaftSystemDeflection':
