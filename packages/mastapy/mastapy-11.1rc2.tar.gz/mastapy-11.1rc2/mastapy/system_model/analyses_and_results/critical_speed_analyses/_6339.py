...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2350, _6250
...
class RootAssemblyCriticalSpeedAnalysis(_6250.AssemblyCriticalSpeedAnalysis):
    '''RootAssemblyCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_inputs(self) -> '_2350.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2350.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysisInputs) if self.wrapped.CriticalSpeedAnalysisInputs is not None else None
