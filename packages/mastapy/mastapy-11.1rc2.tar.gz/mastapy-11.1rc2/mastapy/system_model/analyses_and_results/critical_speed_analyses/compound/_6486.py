...
class StraightBevelSunGearCompoundCriticalSpeedAnalysis(_6479.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    '''StraightBevelSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6357.StraightBevelSunGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6357.StraightBevelSunGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6357.StraightBevelSunGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6357.StraightBevelSunGearCriticalSpeedAnalysis))
        return value
