...
class TorqueConverterTurbineCompoundPowerFlow(_3922.CouplingHalfCompoundPowerFlow):
    '''TorqueConverterTurbineCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3874.TorqueConverterTurbinePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3874.TorqueConverterTurbinePowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3874.TorqueConverterTurbinePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3874.TorqueConverterTurbinePowerFlow))
        return value
