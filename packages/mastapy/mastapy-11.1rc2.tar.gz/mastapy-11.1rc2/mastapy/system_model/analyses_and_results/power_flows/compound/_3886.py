...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_3918.ConnectionCompoundPowerFlow):
    '''AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3753.AbstractShaftToMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3753.AbstractShaftToMountableComponentConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3753.AbstractShaftToMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3753.AbstractShaftToMountableComponentConnectionPowerFlow))
        return value
