...
class AGMAGleasonConicalGearCompoundPowerFlow(_3915.ConicalGearCompoundPowerFlow):
    '''AGMAGleasonConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3755.AGMAGleasonConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3755.AGMAGleasonConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3755.AGMAGleasonConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3755.AGMAGleasonConicalGearPowerFlow))
        return value
