...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_3915.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3818.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3818.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3818.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3818.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value
