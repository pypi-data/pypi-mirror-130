...
from mastapy.system_model.analyses_and_results.power_flows import _3838, _3757
...
class RootAssemblyPowerFlow(_3757.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3838.PowerFlow':
        ...
        return constructor.new(_3838.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs is not None else None
