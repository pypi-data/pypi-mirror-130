...
class PowerFlow(_7252.StaticLoadAnalysisCase):
    '''PowerFlow
    ...
    @property
    def torsional_system_deflection(self) -> '_2552.TorsionalSystemDeflection':
        ...
        return constructor.new(_2552.TorsionalSystemDeflection)(self.wrapped.TorsionalSystemDeflection) if self.wrapped.TorsionalSystemDeflection is not None else None
