...
class DatumCompoundPowerFlow(_3908.ComponentCompoundPowerFlow):
    '''DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3802.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3802.DatumPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3802.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3802.DatumPowerFlow))
        return value
