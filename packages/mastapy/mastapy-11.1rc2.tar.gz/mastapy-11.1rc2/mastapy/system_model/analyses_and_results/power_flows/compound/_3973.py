...
class RingPinsToDiscConnectionCompoundPowerFlow(_3948.InterMountableComponentConnectionCompoundPowerFlow):
    '''RingPinsToDiscConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3843.RingPinsToDiscConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3843.RingPinsToDiscConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3843.RingPinsToDiscConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3843.RingPinsToDiscConnectionPowerFlow))
        return value
