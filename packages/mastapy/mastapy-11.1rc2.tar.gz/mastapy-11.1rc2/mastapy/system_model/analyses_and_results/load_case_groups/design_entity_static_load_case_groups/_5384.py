...
TConnection = TypeVar('TConnection', bound='_1999.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6548.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5385.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
