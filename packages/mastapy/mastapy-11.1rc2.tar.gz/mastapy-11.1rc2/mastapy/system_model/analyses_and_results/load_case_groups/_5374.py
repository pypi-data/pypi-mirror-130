...
from mastapy.system_model.analyses_and_results.load_case_groups import _5377, _5370
...
class DutyCycle(_5370.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5377.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_5377.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6705.TimeSeriesImporter':
        ...
        return constructor.new(_6705.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter is not None else None
    ...
    def add_static_load(self, static_load: '_6504.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_6504.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5377.SubGroupInSingleDesignState'):
