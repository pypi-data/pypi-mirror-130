...
class FlexiblePinAnalysisManufactureLevel(_5970.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4059.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4059.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis is not None else None
