...
from mastapy.system_model.part_model import (
    ...
    _2167, _2169, _2170, _2171,
    _2174, _2175, _2178, _2179,
...
from mastapy.utility.model_validation import _1557, _1558
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1521.CustomReport':
        ...
        return constructor.new(_1521.CustomReport)(self.wrapped.ActiveReportAsText) if self.wrapped.ActiveReportAsText is not None else None
    ...
    @property
    def component_design(self) -> '_1936.DesignEntity':
        ...
        if _1936.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1999.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2194.Part':
    ...
    @property
    def all_status_errors(self) -> 'List[_1558.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1558.StatusItem))
        return value
