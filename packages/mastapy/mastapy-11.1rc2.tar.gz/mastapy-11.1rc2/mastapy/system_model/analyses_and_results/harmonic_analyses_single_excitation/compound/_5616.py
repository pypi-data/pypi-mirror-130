...
class SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_5518.AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    '''SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5487.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5487.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5487.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5487.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation))
        return value
