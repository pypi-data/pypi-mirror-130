...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5435, _5436, _5448
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_5448.GearSetHarmonicAnalysisOfSingleExcitation):
    '''CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5435.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5435.CylindricalGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5436.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5436.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
