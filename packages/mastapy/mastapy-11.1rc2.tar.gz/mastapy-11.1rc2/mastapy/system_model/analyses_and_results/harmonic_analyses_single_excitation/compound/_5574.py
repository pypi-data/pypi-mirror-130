...
class FEPartCompoundHarmonicAnalysisOfSingleExcitation(_5520.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    '''FEPartCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5444.FEPartHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5444.FEPartHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5444.FEPartHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5444.FEPartHarmonicAnalysisOfSingleExcitation))
        return value
