...
class StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_5535.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5498.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5498.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5498.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5498.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
