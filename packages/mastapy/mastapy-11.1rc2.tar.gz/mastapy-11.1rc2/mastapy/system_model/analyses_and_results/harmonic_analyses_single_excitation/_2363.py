...
class ModalAnalysisForHarmonicAnalysis(_2360.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5731.HarmonicAnalysisOptions':
        ...
        if _5731.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
