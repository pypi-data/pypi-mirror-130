...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3745
...
class ShaftModalComplexShape(_3745.ShaftComplexShape['_1463.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
