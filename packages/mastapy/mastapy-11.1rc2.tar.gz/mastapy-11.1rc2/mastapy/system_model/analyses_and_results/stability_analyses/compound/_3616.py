...
class AbstractShaftCompoundStabilityAnalysis(_3617.AbstractShaftOrHousingCompoundStabilityAnalysis):
    '''AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3485.AbstractShaftStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3485.AbstractShaftStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3485.AbstractShaftStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3485.AbstractShaftStabilityAnalysis))
        return value
