...
class GuideDxfModelCompoundStabilityAnalysis(_3640.ComponentCompoundStabilityAnalysis):
    '''GuideDxfModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3545.GuideDxfModelStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3545.GuideDxfModelStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3545.GuideDxfModelStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3545.GuideDxfModelStabilityAnalysis))
        return value
