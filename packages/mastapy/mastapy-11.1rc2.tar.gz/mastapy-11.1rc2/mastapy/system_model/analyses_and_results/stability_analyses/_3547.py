...
from mastapy.system_model.analyses_and_results.stability_analyses import _3548, _3546, _3488
...
class HypoidGearSetStabilityAnalysis(_3488.AGMAGleasonConicalGearSetStabilityAnalysis):
    '''HypoidGearSetStabilityAnalysis
    ...
    @property
    def hypoid_gears_stability_analysis(self) -> 'List[_3548.HypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsStabilityAnalysis, constructor.new(_3548.HypoidGearStabilityAnalysis))
        return value

    @property
    def hypoid_meshes_stability_analysis(self) -> 'List[_3546.HypoidGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesStabilityAnalysis, constructor.new(_3546.HypoidGearMeshStabilityAnalysis))
        return value
