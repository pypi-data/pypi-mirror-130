...
class CoaxialConnectionCompoundStabilityAnalysis(_3712.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3507.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3507.CoaxialConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3507.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3507.CoaxialConnectionStabilityAnalysis))
        return value
