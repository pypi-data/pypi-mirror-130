...
from mastapy.system_model.analyses_and_results.stability_analyses import _3611, _3609, _3543
...
class WormGearSetStabilityAnalysis(_3543.GearSetStabilityAnalysis):
    '''WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3611.WormGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsStabilityAnalysis, constructor.new(_3611.WormGearStabilityAnalysis))
        return value

    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3609.WormGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesStabilityAnalysis, constructor.new(_3609.WormGearMeshStabilityAnalysis))
        return value
