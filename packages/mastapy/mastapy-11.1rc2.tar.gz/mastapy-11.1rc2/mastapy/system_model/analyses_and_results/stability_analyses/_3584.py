...
from mastapy.system_model.analyses_and_results.stability_analyses import _3585, _3583, _3500
...
class SpiralBevelGearSetStabilityAnalysis(_3500.BevelGearSetStabilityAnalysis):
    '''SpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def spiral_bevel_gears_stability_analysis(self) -> 'List[_3585.SpiralBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsStabilityAnalysis, constructor.new(_3585.SpiralBevelGearStabilityAnalysis))
        return value

    @property
    def spiral_bevel_meshes_stability_analysis(self) -> 'List[_3583.SpiralBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesStabilityAnalysis, constructor.new(_3583.SpiralBevelGearMeshStabilityAnalysis))
        return value
