...
from mastapy.system_model.analyses_and_results.stability_analyses import _2367, _3490
...
class RootAssemblyStabilityAnalysis(_3490.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2367.StabilityAnalysis':
        ...
        return constructor.new(_2367.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs is not None else None
