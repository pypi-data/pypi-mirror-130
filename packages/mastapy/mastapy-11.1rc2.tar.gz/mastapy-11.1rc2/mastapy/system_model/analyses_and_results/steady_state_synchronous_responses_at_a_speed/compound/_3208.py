...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3207.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3078.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3078.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3078.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3078.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed))
        return value
