...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed(_3117.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2963.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2963.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2963.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2963.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed))
        return value
