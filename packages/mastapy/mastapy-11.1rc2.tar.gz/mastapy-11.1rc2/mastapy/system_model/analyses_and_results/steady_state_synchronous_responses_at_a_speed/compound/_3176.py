...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3141.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3046.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3046.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3046.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3046.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed))
        return value
