...
class PartSteadyStateSynchronousResponseAtASpeed(_7250.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed(self) -> '_3067.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3067.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeed) if self.wrapped.SteadyStateSynchronousResponseAtASpeed is not None else None
