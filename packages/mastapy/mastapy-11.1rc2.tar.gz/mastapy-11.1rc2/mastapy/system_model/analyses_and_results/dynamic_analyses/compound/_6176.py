...
class KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis(_6142.ConicalGearSetCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6047.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6047.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6047.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6047.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis))
        return value
