...
class TorqueConverterPumpCompoundDynamicAnalysis(_6147.CouplingHalfCompoundDynamicAnalysis):
    '''TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6098.TorqueConverterPumpDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6098.TorqueConverterPumpDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6098.TorqueConverterPumpDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6098.TorqueConverterPumpDynamicAnalysis))
        return value
