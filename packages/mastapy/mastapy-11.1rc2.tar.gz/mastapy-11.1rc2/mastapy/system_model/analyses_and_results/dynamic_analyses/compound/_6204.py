...
class ShaftHubConnectionCompoundDynamicAnalysis(_6144.ConnectorCompoundDynamicAnalysis):
    '''ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6075.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6075.ShaftHubConnectionDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6075.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6075.ShaftHubConnectionDynamicAnalysis))
        return value
