...
class SpecialisedAssemblyCompoundDynamicAnalysis(_6108.AbstractAssemblyCompoundDynamicAnalysis):
    '''SpecialisedAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6077.SpecialisedAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6077.SpecialisedAssemblyDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6077.SpecialisedAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6077.SpecialisedAssemblyDynamicAnalysis))
        return value
