...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4082, _4081, _4018
...
class HypoidGearSetParametricStudyTool(_4018.AGMAGleasonConicalGearSetParametricStudyTool):
    '''HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4081.HypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesParametricStudyTool, constructor.new(_4081.HypoidGearMeshParametricStudyTool))
        return value
