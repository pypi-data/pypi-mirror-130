...
class VirtualComponentCompoundParametricStudyTool(_4236.MountableComponentCompoundParametricStudyTool):
    '''VirtualComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4152.VirtualComponentParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4152.VirtualComponentParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4152.VirtualComponentParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4152.VirtualComponentParametricStudyTool))
        return value
