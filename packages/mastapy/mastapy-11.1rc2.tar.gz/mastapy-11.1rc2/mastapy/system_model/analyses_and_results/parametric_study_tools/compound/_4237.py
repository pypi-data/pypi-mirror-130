...
class OilSealCompoundParametricStudyTool(_4195.ConnectorCompoundParametricStudyTool):
    '''OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4098.OilSealParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4098.OilSealParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4098.OilSealParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4098.OilSealParametricStudyTool))
        return value
