...
class MeasurementComponentCompoundParametricStudyTool(_4281.VirtualComponentCompoundParametricStudyTool):
    '''MeasurementComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4095.MeasurementComponentParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4095.MeasurementComponentParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4095.MeasurementComponentParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4095.MeasurementComponentParametricStudyTool))
        return value
