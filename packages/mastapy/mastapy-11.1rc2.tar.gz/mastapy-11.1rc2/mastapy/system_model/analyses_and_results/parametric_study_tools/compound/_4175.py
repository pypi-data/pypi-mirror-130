...
class BevelGearCompoundParametricStudyTool(_4163.AGMAGleasonConicalGearCompoundParametricStudyTool):
    '''BevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4029.BevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4029.BevelGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4029.BevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4029.BevelGearParametricStudyTool))
        return value
