...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4184.ComponentCompoundParametricStudyTool):
    '''AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4013.AbstractShaftOrHousingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4013.AbstractShaftOrHousingParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4013.AbstractShaftOrHousingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4013.AbstractShaftOrHousingParametricStudyTool))
        return value
