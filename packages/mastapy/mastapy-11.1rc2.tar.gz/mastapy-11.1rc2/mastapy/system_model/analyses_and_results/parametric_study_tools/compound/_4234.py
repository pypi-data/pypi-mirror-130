...
class MassDiscCompoundParametricStudyTool(_4281.VirtualComponentCompoundParametricStudyTool):
    '''MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4094.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4094.MassDiscParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4094.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4094.MassDiscParametricStudyTool))
        return value
