...
class CylindricalGearMeshCompoundParametricStudyTool(_4218.GearMeshCompoundParametricStudyTool):
    '''CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4059.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4059.CylindricalGearMeshParametricStudyTool))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4059.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4059.CylindricalGearMeshParametricStudyTool))
        return value
