...
class ShaftHubConnectionCompoundParametricStudyTool(_4195.ConnectorCompoundParametricStudyTool):
    '''ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4125.ShaftHubConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4125.ShaftHubConnectionParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4125.ShaftHubConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4125.ShaftHubConnectionParametricStudyTool))
        return value
