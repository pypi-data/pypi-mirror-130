...
class AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool(_4194.ConnectionCompoundParametricStudyTool):
    '''AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4015.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4015.AbstractShaftToMountableComponentConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4015.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4015.AbstractShaftToMountableComponentConnectionParametricStudyTool))
        return value
