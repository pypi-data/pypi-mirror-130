...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2524.ShaftSystemDeflection':
        ...
        return constructor.new(_2524.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection is not None else None

    @property
    def node_results(self) -> 'List[_1983.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1983.ShaftDeflectionDrawingNodeItem))
        return value
