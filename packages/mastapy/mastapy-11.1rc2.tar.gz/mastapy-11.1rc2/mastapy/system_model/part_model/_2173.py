...
from mastapy.system_model.connections_and_sockets import (
    ...
    _2020, _2021, _1999, _1992,
    _1995, _1996, _2000, _2008,
    _2014, _2019, _2022
)
...
class ConnectedSockets(_0.APIBase):
    ...
    @property
    def connection(self) -> '_1999.Connection':
        ...
        if _1999.Connection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_abstract_shaft_to_mountable_component_connection(self) -> '_1992.AbstractShaftToMountableComponentConnection':
        ...
        if _1992.AbstractShaftToMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_belt_connection(self) -> '_1995.BeltConnection':
        ...
        if _1995.BeltConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_coaxial_connection(self) -> '_1996.CoaxialConnection':
        ...
        if _1996.CoaxialConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cvt_belt_connection(self) -> '_2000.CVTBeltConnection':
        ...
        if _2000.CVTBeltConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_inter_mountable_component_connection(self) -> '_2008.InterMountableComponentConnection':
        ...
        if _2008.InterMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_planetary_connection(self) -> '_2014.PlanetaryConnection':
        ...
        if _2014.PlanetaryConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_rolling_ring_connection(self) -> '_2019.RollingRingConnection':
        ...
        if _2019.RollingRingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_shaft_to_mountable_component_connection(self) -> '_2022.ShaftToMountableComponentConnection':
        ...
        if _2022.ShaftToMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_agma_gleason_conical_gear_mesh(self) -> '_2026.AGMAGleasonConicalGearMesh':
        ...
        if _2026.AGMAGleasonConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_bevel_differential_gear_mesh(self) -> '_2028.BevelDifferentialGearMesh':
        ...
        if _2028.BevelDifferentialGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_bevel_gear_mesh(self) -> '_2030.BevelGearMesh':
        ...
        if _2030.BevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_concept_gear_mesh(self) -> '_2032.ConceptGearMesh':
        ...
        if _2032.ConceptGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_conical_gear_mesh(self) -> '_2034.ConicalGearMesh':
        ...
        if _2034.ConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cylindrical_gear_mesh(self) -> '_2036.CylindricalGearMesh':
        ...
        if _2036.CylindricalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_face_gear_mesh(self) -> '_2038.FaceGearMesh':
        ...
        if _2038.FaceGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_gear_mesh(self) -> '_2040.GearMesh':
        ...
        if _2040.GearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
            raise CastException('Failed to cast connection to GearMesh. Expected: {}.'.format(self.wrapped.Connection.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Connection.__class__)(self.wrapped.Connection) if self.wrapped.Connection is not None else None

    @property
    def connection_of_type_hypoid_gear_mesh(self) -> '_2042.HypoidGearMesh':
        ...
        if _2042.HypoidGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh(self) -> '_2045.KlingelnbergCycloPalloidConicalGearMesh':
        ...
        if _2045.KlingelnbergCycloPalloidConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_2046.KlingelnbergCycloPalloidHypoidGearMesh':
        ...
        if _2046.KlingelnbergCycloPalloidHypoidGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_2047.KlingelnbergCycloPalloidSpiralBevelGearMesh':
        ...
        if _2047.KlingelnbergCycloPalloidSpiralBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_spiral_bevel_gear_mesh(self) -> '_2050.SpiralBevelGearMesh':
        ...
        if _2050.SpiralBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_straight_bevel_diff_gear_mesh(self) -> '_2052.StraightBevelDiffGearMesh':
        ...
        if _2052.StraightBevelDiffGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_straight_bevel_gear_mesh(self) -> '_2054.StraightBevelGearMesh':
        ...
        if _2054.StraightBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_worm_gear_mesh(self) -> '_2056.WormGearMesh':
        ...
        if _2056.WormGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_zerol_bevel_gear_mesh(self) -> '_2058.ZerolBevelGearMesh':
        ...
        if _2058.ZerolBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cycloidal_disc_central_bearing_connection(self) -> '_2062.CycloidalDiscCentralBearingConnection':
        ...
        if _2062.CycloidalDiscCentralBearingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cycloidal_disc_planetary_bearing_connection(self) -> '_2065.CycloidalDiscPlanetaryBearingConnection':
        ...
        if _2065.CycloidalDiscPlanetaryBearingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_ring_pins_to_disc_connection(self) -> '_2068.RingPinsToDiscConnection':
        ...
        if _2068.RingPinsToDiscConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_clutch_connection(self) -> '_2069.ClutchConnection':
        ...
        if _2069.ClutchConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_concept_coupling_connection(self) -> '_2071.ConceptCouplingConnection':
        ...
        if _2071.ConceptCouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_coupling_connection(self) -> '_2073.CouplingConnection':
        ...
        if _2073.CouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_part_to_part_shear_coupling_connection(self) -> '_2075.PartToPartShearCouplingConnection':
        ...
        if _2075.PartToPartShearCouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_spring_damper_connection(self) -> '_2077.SpringDamperConnection':
        ...
        if _2077.SpringDamperConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_torque_converter_connection(self) -> '_2079.TorqueConverterConnection':
        ...
        if _2079.TorqueConverterConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
