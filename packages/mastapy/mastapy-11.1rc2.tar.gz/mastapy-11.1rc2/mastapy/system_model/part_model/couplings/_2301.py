...
from mastapy.system_model.part_model.couplings import _2302, _2315
...
class BeltDrive(_2202.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2302.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2302.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2302.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2315.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2315.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1995.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1995.BeltConnection))
        return value
