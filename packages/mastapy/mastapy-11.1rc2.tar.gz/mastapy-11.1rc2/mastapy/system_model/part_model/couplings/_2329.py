...
from mastapy.system_model.part_model.couplings import _2328, _2330
...
class SynchroniserHalf(_2330.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2328.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2328.SynchroniserCone))
        return value
