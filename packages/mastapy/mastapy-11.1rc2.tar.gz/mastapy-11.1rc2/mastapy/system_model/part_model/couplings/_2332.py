...
from mastapy.system_model.part_model.couplings import _2333, _2335, _2308
...
class TorqueConverter(_2308.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2333.TorqueConverterPump':
        ...
        return constructor.new(_2333.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump is not None else None

    @property
    def turbine(self) -> '_2335.TorqueConverterTurbine':
        ...
        return constructor.new(_2335.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine is not None else None
