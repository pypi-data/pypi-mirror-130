...
from mastapy.system_model.part_model.part_groups import _2213, _2215, _2212
...
class ParallelPartGroup(_2212.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2213.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2213.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2215.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2215.DesignMeasurements))
        return value
