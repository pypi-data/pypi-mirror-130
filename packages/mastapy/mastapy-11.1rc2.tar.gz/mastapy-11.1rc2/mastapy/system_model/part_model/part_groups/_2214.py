...
from mastapy.system_model.part_model.part_groups import _2212, _2213, _2216
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2212.ConcentricOrParallelPartGroup':
        ...
        if _2212.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2213.ConcentricPartGroup':
        ...
        if _2213.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2216.ParallelPartGroup':
        ...
        if _2216.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
