...
from mastapy.system_model.part_model.part_groups import _2214, _2212
...
class ConcentricPartGroup(_2212.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2214.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2214.ConcentricPartGroupParallelToThis))
        return value
