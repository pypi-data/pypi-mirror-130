...
from mastapy.system_model.part_model.gears import _2250, _2252, _2251
...
class PlanetaryGearSet(_2251.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2250.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2250.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2252.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2252.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2250.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2250.CylindricalGear))
        return value

    def add_sun(self) -> '_2250.CylindricalGear':
    ...
    def add_planet(self) -> '_2250.CylindricalGear':
    ...
    def add_annulus(self) -> '_2250.CylindricalGear':
