...
class SuperchargerRotorSet(_1590.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2290.YVariableForImportedData':
        ...
        return constructor.new(_2290.YVariableForImportedData)(value) if value is not None else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2290.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2283.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2283.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File is not None else None

    @property
    def rotor_speed(self) -> '_2285.RotorSpeedInputOptions':
        ...
        return constructor.new(_2285.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed is not None else None

    @property
    def boost_pressure(self) -> '_2280.BoostPressureInputOptions':
        ...
        return constructor.new(_2280.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure is not None else None

    @property
    def pressure_ratio(self) -> '_2282.PressureRatioInputOptions':
        ...
        return constructor.new(_2282.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio is not None else None

    @property
    def input_power(self) -> '_2281.InputPowerInputOptions':
        ...
        return constructor.new(_2281.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower is not None else None

    @property
    def measured_points(self) -> 'List[_2284.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2284.RotorSetMeasuredPoint))
        return value
