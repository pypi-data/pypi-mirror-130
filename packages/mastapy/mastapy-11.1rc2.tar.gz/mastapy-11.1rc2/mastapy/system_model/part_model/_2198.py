...
from mastapy.system_model.part_model import _2207, _2205
...
class PowerLoad(_2205.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2207.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2207.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails is not None else None

    @property
    def electric_machine_detail(self) -> '_6570.ElectricMachineDetail':
        ...
        return constructor.new(_6570.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail is not None else None
