...
class FESubstructureWithSelection(_2087.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2109.FESubstructure':
        ...
        return constructor.new(_2109.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure is not None else None

    @property
    def element_face_groups(self) -> 'List[_2102.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2102.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2127.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2127.NodeGroupWithSelection))
        return value
