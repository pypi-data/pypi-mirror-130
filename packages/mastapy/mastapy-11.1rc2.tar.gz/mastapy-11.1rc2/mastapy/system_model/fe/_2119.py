...
from mastapy.system_model.fe import _2113, _2116
...
class FESubstructureWithSelectionForModalAnalysis(_2116.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2113.FESubstructureNodeModeShapes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FullFEModeShapesAtCondensationNodes, constructor.new(_2113.FESubstructureNodeModeShapes))
        return value
