...
from mastapy.system_model.fe import _2084, _2091
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2084.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2084.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2084.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2091.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2091.BearingRaceNodeLink))
        return value
