...
from mastapy.system_model.optimization import _1963
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1963.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1963.MicroGeometryOptimisationTarget)(value) if value is not None else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1963.MicroGeometryOptimisationTarget'):
