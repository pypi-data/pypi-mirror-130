...
from mastapy.utility.modal_analysis.gears import _1562, _1566
...
class GearMeshForTE(_1566.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1562.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1562.GearOrderForTE))
        return value
