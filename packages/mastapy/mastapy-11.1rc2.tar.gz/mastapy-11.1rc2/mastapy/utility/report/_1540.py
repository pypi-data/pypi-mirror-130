...
from mastapy.utility.report import _1551, _1550
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_weight(self) -> '_1551.FontWeight':
        '''FontWeight: 'FontWeight' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontWeight)
        return constructor.new(_1551.FontWeight)(value) if value is not None else None

    @font_weight.setter
    def font_weight(self, value: '_1551.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def font_style(self) -> '_1550.FontStyle':
        '''FontStyle: 'FontStyle' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontStyle)
        return constructor.new(_1550.FontStyle)(value) if value is not None else None

    @font_style.setter
    def font_style(self, value: '_1550.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
