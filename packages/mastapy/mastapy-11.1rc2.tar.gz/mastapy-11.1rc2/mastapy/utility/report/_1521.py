...
class CustomReport(_1531.CustomReportItemContainer):
    '''CustomReport
    ...
    @property
    def include_report_check(self) -> '_1548.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1548.DefinitionBooleanCheckOptions)(value) if value is not None else None

    @include_report_check.setter
    def include_report_check(self, value: '_1548.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
