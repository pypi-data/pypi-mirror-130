...
from mastapy.bearings.tolerances import _1662, _1648, _1654
...
class InterferenceFitHalfDesign(_1183.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1662.SupportTolerance':
        ...
        if _1662.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1648.InnerSupportTolerance':
        ...
        if _1648.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1654.OuterSupportTolerance':
        ...
        if _1654.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
