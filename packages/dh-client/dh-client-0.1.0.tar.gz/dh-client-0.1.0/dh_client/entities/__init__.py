...
__all__ = ["datasets", "glossary_terms", "owners", "tags", "users"]
...
class Entity:
    ...
    def _apply_mcp(
        ...
        """
        if not mpc:
            raise ValueError("You have to provide at least one mpc item")
    ...
    def _create_mpc_from_file(self, file_pattern: str) -> List[dict]:
        """Create list of mpc based on the given file pattern."""
        mpc = []
        for filepath in iglob(file_pattern):
