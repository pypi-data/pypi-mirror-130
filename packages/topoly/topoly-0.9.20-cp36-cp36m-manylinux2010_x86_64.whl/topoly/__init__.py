...
def alexander(chain, closure=Closure.TWO_POINTS, tries=200, chain_boundary=None,
              ...
              external_dictionary='', hide_trivial=True, hide_rare=True, chiral=False, matrix_calc_cutoff=0,
    ...
    Args:
        ...
        translate (bool/str, optional):
                ...
                if known topology, print polynomal value if unknown topology.
    ...
    return result.calculate(
                ...
                hide_rare=hide_rare, chiral=chiral, level=matrix_calc_cutoff, matrix=matrix,
...
def yamada(chain, closure=Closure.TWO_POINTS, tries=200, chain_boundary=None,
    ...
    return result.calculate(
                ...
                hide_trivial=hide_trivial, hide_rare=hide_rare, chiral=chiral, level=matrix_calc_cutoff,
