...
class RealTimeIndicatorTab(SmallPowerTab):
    ...
    def _define_callbacks(self):
        ...
        def updateIndicatorGraph(indicator,rsMethod,style,n,updateBtn,timeRange,previousFig,tw,rs,freezeBtn):
            ...
            if freezeBtn=='freeze':
                fig,errCode = self.updateGraph(previousFig,triggerList,style,
                                [indicator,tw*60,rs,rsMethod,True,timeRange],[])
            else:
                fig,errCode = self.updateGraph(previousFig,triggerList,style,
                                        [indicator,tw*60,rs,rsMethod,True],[])
            return fig,errCode
...
class RealTimeTabMultiUnit_SP_RT(tabsD.RealTimeTagMultiUnit):
    def __init__(self,app,cfg):
