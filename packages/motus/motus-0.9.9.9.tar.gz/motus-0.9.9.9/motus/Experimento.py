...
from motus import Series_Tiempo as st
...
class Experimento:
    ...
    def realiza_procesamiento_MOTUS(self, objeto, intervalo, genera_matriz_recurrencia):
        ...
        if self.regiones_preferidas is not None:
            self.genera_matriz_cuadriculada_con_regiones_preferidas()
            self.genera_matriz_cuadriculada_solo_regiones_preferidas()
            self.genera_matriz_cuadriculada_solo_regiones_no_preferidas()
    ...
    def grafica(self, grafica, lim_inf_x=None, lim_sup_x=None, lim_inf_y=None, lim_sup_y=None,
        ...
        #        plt.imshow(np.flipud(self.matriz_cuadriculada)))
            ...
            indices_tiempo, series_tiempo = st.generar_series_tiempo(lista_a_procesar= arreglo_series_tiempo,
                                                                     brinco_temporal=brincos_series_tiempo,
                                                                     longitud_ventana_tiempo=longitud_series_tiempo)

            resultados = st.generar_regresion_lineal_para_series_tiempo(indices_tiempo=indices_tiempo,
