...
def sending_sms(kannel_username:str, kannel_password:str, body:str, phone_number:str ="23273578902"):
    """
    ...
    sending an SMS
    """
    params = {"username":kannel_username, "password": kannel_password, "to": f"232{phone_number[-8:]}", "dlr-mask":0, "text":body}
