...
from canvas_workflow_kit.value_set.specials import LabReportCreatinine
from canvas_workflow_kit.value_set.v2018 import HypertensiveChronicKidneyDisease, KidneyFailure
...
class Hcc002v2(ClinicalQualityMeasure):
    ...
    class Meta:
        ...
        information = 'https://canvas-medical.zendesk.com/hc/en-us/articles/360059083713-CKD-Suspect-HCC002v2'  # noqa: E501
        ...
        references = [
            'Canvas Medical HCC, https://canvas-medical.zendesk.com/hc/en-us/articles/360059083713-CKD-Suspect-HCC002v2'  # noqa: E501
        ]
