...
class SourcePoller:
    ...
    @property
    def source_data(self) -> SourceData:
        return self._sourcedata

    @source_data.setter
    def source_data(self, value: SourceData) -> None:
        ...
        with self.stats.timed("modifiers.apply_ms"):
            if data is None:
                if self.source_data is not None:
                    ...
                    data = self.source_data = self.refresh()
    ...
    def refresh(self) -> SourceData:
        ...
        if hasattr(self, "source_data") and new == self.source_data:
