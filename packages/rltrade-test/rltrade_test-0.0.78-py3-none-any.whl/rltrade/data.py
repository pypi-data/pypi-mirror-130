...
class IBKRDownloader:
    ...
    def download_data(self,app:IBapi,id:int,ticker:str,sectype:str,exchange:str):
        ...
        app.reqHistoricalData(id,cnt,self.end_date+" 15:59:00 est", duration,'1 day','TRADES',1,2,False,[])
        app.nextorderId += 1
        return app
    ...
    def download_min_data(self,app:IBapi,id:int,ticker:str,sectype:str,exchange:str,end:str):
        ...
        app.reqHistoricalData(id,cnt ,end+" 15:59:00 est","2 D",'1 min','TRADES',1,1,False,[])
        app.nextorderId += 1
        return app
