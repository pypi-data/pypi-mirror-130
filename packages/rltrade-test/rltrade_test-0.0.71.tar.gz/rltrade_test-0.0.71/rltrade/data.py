...
class IBKRDownloader:
    ...
    def __init__(self,start_date:str,end_date:str,ticker_list:list,sec_types:list,exchanges:list,demo=True):
    ...
    def download_data(self,app:IBapi,id:int,ticker:str,sectype:str,exchange:str):
        ...
        app.reqHistoricalData(id,cnt,self.end_date+" 15:59:00 est", duration,'1 day','TRADES',0,2,False,[])
        app.nextorderId += 1
        return app
    ...
    def download_min_data(self,app:IBapi,id:int,ticker:str,sectype:str,exchange:str,end:str):
        ...
        app.reqHistoricalData(id,cnt ,end+" 15:59:00 est","2 D",'1 min','TRADES',0,1,False,[])
        app.nextorderId += 1
        return app
    ...
    def download_todays_min_data(self,app:IBapi,id:int,ticker:str,sectype:str,exchange:str,end:str,duration:str):
        ...
        app.reqHistoricalData(id,cnt ,"", duration,'1 min','TRADES',0,1,True,[])
        time.sleep(5)
        app.nextorderId += 1
        return app
...
class FeatureEngineer:
    ...
    def add_half_hour_time(self,df:pd.DataFrame):
        df['half_hour_time'] = pd.cut(df['date'],bins=11,labels=[x for x in range(11)])
        return df
