...
class KnowledgeCardInfo:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCardInfo':
        ...
        return KnowledgeCardInfo(id, non_anchoring_ids_backing_store, anchor_entity_id, archived, aspect_type, created, created_at, detail, entity_id, hashtags, knowledge_card_info_id, last_modified, latest, published, related_entity_ids)
