...
bool ppp_remove_cb_on_create_module_enter(on_create_module_enter_t);
typedef void (*on_create_module_return_t)(CPUState* cpu, target_ulong pc, uint32_t name, uint32_t size);
void ppp_add_cb_on_create_module_return(on_create_module_return_t);
bool ppp_remove_cb_on_create_module_return(on_create_module_return_t);
typedef void (*on_get_kernel_syms_enter_t)(CPUState* cpu, target_ulong pc, uint32_t table);
void ppp_add_cb_on_get_kernel_syms_enter(on_get_kernel_syms_enter_t);
bool ppp_remove_cb_on_get_kernel_syms_enter(on_get_kernel_syms_enter_t);
typedef void (*on_get_kernel_syms_return_t)(CPUState* cpu, target_ulong pc, uint32_t table);
void ppp_add_cb_on_get_kernel_syms_return(on_get_kernel_syms_return_t);
bool ppp_remove_cb_on_get_kernel_syms_return(on_get_kernel_syms_return_t);
...
void ppp_add_cb_on_mmap2_enter(on_mmap2_enter_t);
bool ppp_remove_cb_on_mmap2_enter(on_mmap2_enter_t);
...
void ppp_add_cb_on_mmap2_return(on_mmap2_return_t);
bool ppp_remove_cb_on_mmap2_return(on_mmap2_return_t);
typedef void (*on_modify_ldt_enter_t)(CPUState* cpu, target_ulong pc, int32_t func, uint32_t ptr, uint32_t bytecount);
void ppp_add_cb_on_modify_ldt_enter(on_modify_ldt_enter_t);
bool ppp_remove_cb_on_modify_ldt_enter(on_modify_ldt_enter_t);
typedef void (*on_modify_ldt_return_t)(CPUState* cpu, target_ulong pc, int32_t func, uint32_t ptr, uint32_t bytecount);
void ppp_add_cb_on_modify_ldt_return(on_modify_ldt_return_t);
bool ppp_remove_cb_on_modify_ldt_return(on_modify_ldt_return_t);
typedef void (*on_set_thread_area_enter_t)(CPUState* cpu, target_ulong pc, uint32_t tp);
void ppp_add_cb_on_set_thread_area_enter(on_set_thread_area_enter_t);
bool ppp_remove_cb_on_set_thread_area_enter(on_set_thread_area_enter_t);
typedef void (*on_set_thread_area_return_t)(CPUState* cpu, target_ulong pc, uint32_t tp);
void ppp_add_cb_on_set_thread_area_return(on_set_thread_area_return_t);
bool ppp_remove_cb_on_set_thread_area_return(on_set_thread_area_return_t);
...
void ppp_add_cb_on_sys_cacheflush_enter(on_sys_cacheflush_enter_t);
bool ppp_remove_cb_on_sys_cacheflush_enter(on_sys_cacheflush_enter_t);
typedef void (*on_sys_cacheflush_return_t)(CPUState* cpu, target_ulong pc, uint32_t addr, int32_t nbytes, int32_t cache);
void ppp_add_cb_on_sys_cacheflush_return(on_sys_cacheflush_return_t);
bool ppp_remove_cb_on_sys_cacheflush_return(on_sys_cacheflush_return_t);
...
void ppp_add_cb_on_sys_idle_enter(on_sys_idle_enter_t);
bool ppp_remove_cb_on_sys_idle_enter(on_sys_idle_enter_t);
typedef void (*on_sys_idle_return_t)(CPUState* cpu, target_ulong pc);
void ppp_add_cb_on_sys_idle_return(on_sys_idle_return_t);
bool ppp_remove_cb_on_sys_idle_return(on_sys_idle_return_t);
...
bool ppp_remove_cb_on_sys_ioperm_enter(on_sys_ioperm_enter_t);
...
bool ppp_remove_cb_on_sys_ioperm_return(on_sys_ioperm_return_t);
...
bool ppp_remove_cb_on_sys_iopl_enter(on_sys_iopl_enter_t);
...
bool ppp_remove_cb_on_sys_iopl_return(on_sys_iopl_return_t);
...
bool ppp_remove_cb_on_sys_lstat_enter(on_sys_lstat_enter_t);
...
bool ppp_remove_cb_on_sys_lstat_return(on_sys_lstat_return_t);
...
void ppp_add_cb_on_sys_query_module_enter(on_sys_query_module_enter_t);
bool ppp_remove_cb_on_sys_query_module_enter(on_sys_query_module_enter_t);
...
void ppp_add_cb_on_sys_query_module_return(on_sys_query_module_return_t);
bool ppp_remove_cb_on_sys_query_module_return(on_sys_query_module_return_t);
...
void ppp_add_cb_on_sys_setup_enter(on_sys_setup_enter_t);
bool ppp_remove_cb_on_sys_setup_enter(on_sys_setup_enter_t);
typedef void (*on_sys_setup_return_t)(CPUState* cpu, target_ulong pc);
void ppp_add_cb_on_sys_setup_return(on_sys_setup_return_t);
bool ppp_remove_cb_on_sys_setup_return(on_sys_setup_return_t);
...
bool ppp_remove_cb_on_sys_signal_enter(on_sys_signal_enter_t);
...
bool ppp_remove_cb_on_sys_signal_return(on_sys_signal_return_t);
...
bool ppp_remove_cb_on_sys_stat_enter(on_sys_stat_enter_t);
...
bool ppp_remove_cb_on_sys_stat_return(on_sys_stat_return_t);
