...
typedef void(*taint2_enable_sym_t)(void);
extern taint2_enable_sym_t __taint2_enable_sym;
#ifdef PLUGIN_MAIN
taint2_enable_sym_t __taint2_enable_sym = NULL;
#endif
static inline void taint2_enable_sym(void);
static inline void taint2_enable_sym(void) {
    assert(__taint2_enable_sym);
    return __taint2_enable_sym();
}

typedef void(*taint2_sym_label_addr_t)(Addr a, int offset, uint32_t l);
extern taint2_sym_label_addr_t __taint2_sym_label_addr;
#ifdef PLUGIN_MAIN
taint2_sym_label_addr_t __taint2_sym_label_addr = NULL;
#endif
static inline void taint2_sym_label_addr(Addr a, int offset, uint32_t l);
static inline void taint2_sym_label_addr(Addr a, int offset, uint32_t l) {
    assert(__taint2_sym_label_addr);
    return __taint2_sym_label_addr(a,offset,l);
}

typedef void *(*taint2_sym_query_t)(Addr a);
extern taint2_sym_query_t __taint2_sym_query;
#ifdef PLUGIN_MAIN
taint2_sym_query_t __taint2_sym_query = NULL;
#endif
static inline void * taint2_sym_query(Addr a);
static inline void * taint2_sym_query(Addr a) {
    assert(__taint2_sym_query);
    return __taint2_sym_query(a);
}

typedef void(*taint2_sym_label_ram_t)(uint64_t RamOffset, uint32_t l);
extern taint2_sym_label_ram_t __taint2_sym_label_ram;
#ifdef PLUGIN_MAIN
taint2_sym_label_ram_t __taint2_sym_label_ram = NULL;
#endif
static inline void taint2_sym_label_ram(uint64_t RamOffset, uint32_t l);
static inline void taint2_sym_label_ram(uint64_t RamOffset, uint32_t l) {
    assert(__taint2_sym_label_ram);
    return __taint2_sym_label_ram(RamOffset,l);
}

typedef void(*taint2_sym_label_reg_t)(int reg_num, int offset, uint32_t l);
extern taint2_sym_label_reg_t __taint2_sym_label_reg;
#ifdef PLUGIN_MAIN
taint2_sym_label_reg_t __taint2_sym_label_reg = NULL;
#endif
static inline void taint2_sym_label_reg(int reg_num, int offset, uint32_t l);
static inline void taint2_sym_label_reg(int reg_num, int offset, uint32_t l) {
    assert(__taint2_sym_label_reg);
    return __taint2_sym_label_reg(reg_num,offset,l);
}

typedef void(*taint2_sym_query_ram_t)(uint64_t RamOffset, uint32_t s, uint32_t *n, char** strptr);
extern taint2_sym_query_ram_t __taint2_sym_query_ram;
#ifdef PLUGIN_MAIN
taint2_sym_query_ram_t __taint2_sym_query_ram = NULL;
#endif
static inline void taint2_sym_query_ram(uint64_t RamOffset, uint32_t s, uint32_t *n, char** strptr);
static inline void taint2_sym_query_ram(uint64_t RamOffset, uint32_t s, uint32_t *n, char** strptr) {
    assert(__taint2_sym_query_ram);
    return __taint2_sym_query_ram(RamOffset,s,n,strptr);
}

typedef void(*taint2_sym_query_reg_t)(uint32_t reg_num, uint32_t *n, char** strptr);
extern taint2_sym_query_reg_t __taint2_sym_query_reg;
#ifdef PLUGIN_MAIN
taint2_sym_query_reg_t __taint2_sym_query_reg = NULL;
#endif
static inline void taint2_sym_query_reg(uint32_t reg_num, uint32_t *n, char** strptr);
static inline void taint2_sym_query_reg(uint32_t reg_num, uint32_t *n, char** strptr) {
    assert(__taint2_sym_query_reg);
    return __taint2_sym_query_reg(reg_num,n,strptr);
}

typedef void(*taint2_sym_path_constraints_t)(uint32_t *n, char** strptr);
extern taint2_sym_path_constraints_t __taint2_sym_path_constraints;
#ifdef PLUGIN_MAIN
taint2_sym_path_constraints_t __taint2_sym_path_constraints = NULL;
#endif
static inline void taint2_sym_path_constraints(uint32_t *n, char** strptr);
static inline void taint2_sym_path_constraints(uint32_t *n, char** strptr) {
    assert(__taint2_sym_path_constraints);
    return __taint2_sym_path_constraints(n,strptr);
}

typedef void(*taint2_sym_branch_meta_t)(uint32_t *n, SymbolicBranchMeta** metas);
extern taint2_sym_branch_meta_t __taint2_sym_branch_meta;
#ifdef PLUGIN_MAIN
taint2_sym_branch_meta_t __taint2_sym_branch_meta = NULL;
#endif
static inline void taint2_sym_branch_meta(uint32_t *n, SymbolicBranchMeta** metas);
static inline void taint2_sym_branch_meta(uint32_t *n, SymbolicBranchMeta** metas) {
    assert(__taint2_sym_branch_meta);
    return __taint2_sym_branch_meta(n,metas);
}
...
bool init_taint2_api(void) {
    ...
    IMPORT_PPP(module, taint2_enable_sym)
    IMPORT_PPP(module, taint2_sym_label_addr)
    IMPORT_PPP(module, taint2_sym_query)
    IMPORT_PPP(module, taint2_sym_label_ram)
    IMPORT_PPP(module, taint2_sym_label_reg)
    IMPORT_PPP(module, taint2_sym_query_ram)
    IMPORT_PPP(module, taint2_sym_query_reg)
    IMPORT_PPP(module, taint2_sym_path_constraints)
    IMPORT_PPP(module, taint2_sym_branch_meta)
