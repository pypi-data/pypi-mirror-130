...
from solace.messaging.config.solace_constants.authentication_constants import AUTHENTICATION_SCHEME_KERBEROS, \
    AUTHENTICATION_SCHEME_CLIENT_CERT, AUTHENTICATION_SCHEME_BASIC
...
certificate_mandatory_props = [HOST, VPN_NAME, SCHEME_SSL_CLIENT_CERT_FILE, SCHEME_SSL_CLIENT_PRIVATE_KEY_FILE]
