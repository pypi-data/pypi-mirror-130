...
class ResultsStoreServicer(object):
    ...
    def UploadCTTestRuns(self, request_iterator, context):
        ...
        From now on CT endpoints will be added to the CTServiceML service
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class CTServiceMLStub(object):
    """/////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////
    CT Service

    Notes:
    - Ideally we want to move the whole "CT section" here to another file.  The reason I'm not doing it now is because of protos/Makefile.
    - For python ML code, we git commit the generated code stubs that proto compiler outputs.  The protos/Makefile creates + checks consistency of proto definitions
    and the actual committed code stubs (i.e. they need to be exactly same).  However, since we give the "-I" flag to each file (defines scope of local filesystem for the proto definitions),
    we cannot import other proto files without changing current import structure (protos does relative import paths only and so changing value passed to -I means we have to change many existing import statements)
    /////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////
    ...
    def __init__(self, channel):
        ...
        self.GetActiveCTInstanceID = channel.unary_unary(
                '/rime.CTServiceML/GetActiveCTInstanceID',
                request_serializer=protos_dot_results__upload_dot_results__upload__pb2.GetActiveCTInstanceIDRequest.SerializeToString,
                response_deserializer=protos_dot_results__upload_dot_results__upload__pb2.GetActiveCTInstanceIDResponse.FromString,
                )
        self.GetCTInstance = channel.unary_unary(
                '/rime.CTServiceML/GetCTInstance',
                request_serializer=protos_dot_results__upload_dot_results__upload__pb2.GetCTInstanceRequest.SerializeToString,
                response_deserializer=protos_dot_results__upload_dot_results__upload__pb2.GetCTInstanceResponse.FromString,
                )
        self.CTIncrementalUpload = channel.stream_unary(
                '/rime.CTServiceML/CTIncrementalUpload',
                request_serializer=protos_dot_results__upload_dot_results__upload__pb2.Chunk.SerializeToString,
                response_deserializer=protos_dot_results__upload_dot_results__upload__pb2.CTIncrementalUploadResponse.FromString,
                )


class CTServiceMLServicer(object):
    """/////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////
    CT Service
...
def add_CTServiceMLServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetActiveCTInstanceID': grpc.unary_unary_rpc_method_handler(
                    servicer.GetActiveCTInstanceID,
                    request_deserializer=protos_dot_results__upload_dot_results__upload__pb2.GetActiveCTInstanceIDRequest.FromString,
                    response_serializer=protos_dot_results__upload_dot_results__upload__pb2.GetActiveCTInstanceIDResponse.SerializeToString,
            ),
            'GetCTInstance': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCTInstance,
                    request_deserializer=protos_dot_results__upload_dot_results__upload__pb2.GetCTInstanceRequest.FromString,
                    response_serializer=protos_dot_results__upload_dot_results__upload__pb2.GetCTInstanceResponse.SerializeToString,
            ),
            'CTIncrementalUpload': grpc.stream_unary_rpc_method_handler(
                    servicer.CTIncrementalUpload,
                    request_deserializer=protos_dot_results__upload_dot_results__upload__pb2.Chunk.FromString,
                    response_serializer=protos_dot_results__upload_dot_results__upload__pb2.CTIncrementalUploadResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'rime.CTServiceML', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class CTServiceML(object):
    """/////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////
    CT Service
    ...
    def GetActiveCTInstanceID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rime.CTServiceML/GetActiveCTInstanceID',
            protos_dot_results__upload_dot_results__upload__pb2.GetActiveCTInstanceIDRequest.SerializeToString,
            protos_dot_results__upload_dot_results__upload__pb2.GetActiveCTInstanceIDResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetCTInstance(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rime.CTServiceML/GetCTInstance',
            protos_dot_results__upload_dot_results__upload__pb2.GetCTInstanceRequest.SerializeToString,
            protos_dot_results__upload_dot_results__upload__pb2.GetCTInstanceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CTIncrementalUpload(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/rime.CTServiceML/CTIncrementalUpload',
            protos_dot_results__upload_dot_results__upload__pb2.Chunk.SerializeToString,
            protos_dot_results__upload_dot_results__upload__pb2.CTIncrementalUploadResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
