...
class Response(object):
    ...
    def text(self, content):
        return self.response(content=content, mime_type="text/plain")

    def html(self, content):
        return self.response(content=content, mime_type="text/html")


    def json(self, content):
        if not isinstance(content, string_types):
            content = json_dumps(content)
        return self.response(content=content, mime_type="application/json")
