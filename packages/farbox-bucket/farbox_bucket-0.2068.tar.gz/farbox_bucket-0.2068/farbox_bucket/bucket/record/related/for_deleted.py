...
from farbox_bucket.bucket.record.get.path_related import get_record_id_by_path, get_record_by_path, has_record_by_path
from farbox_bucket.bucket.utils import get_bucket_name_for_url, get_bucket_name_for_path, get_bucket_name_for_slash
from farbox_bucket.bucket.utils import update_bucket_deleted_paths_info
...
def delete_path_related_record_by_path(bucket, path, record_data=None, continue_to_create_record=False):
    ...
    if record_data:
        ...
        update_bucket_deleted_paths_info(bucket, real_path, is_deleted=True)
