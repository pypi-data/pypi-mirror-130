...
from farbox_bucket.server.helpers.bucket import sync_download_file_by_web_request, show_bucket_records_for_web_request, \
    show_bucket_deleted_paths_for_web_request
...
@app.route('/__file_manager_deleted_paths', methods=['POST', 'GET'])
def file_manager_deleted_paths_api():
    return show_bucket_deleted_paths_for_web_request()
