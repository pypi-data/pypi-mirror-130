...
@LastEditTime: 2021-11-25 14:24:13
...
class ErpConsoleModel():
    ...
    def process_order_push(self, mod_value, mod_count):
        ...
        """
        page_size = 100
        push_url = config.get_value("armor_url") + "/api/order"
    ...
    def compose_push_request_params(self, sign_key, erp_relation_dict, prize_order_dict, prize_roster_model):
        ...
        data["activity_time"] = TimeHelper.datetime_to_timestamp(prize_order_dict["create_date"]) * 1000 if str(prize_order_dict["create_date"]) != "1900-01-01 00:00:00" else 0
        data["activity_name"] = ""
                ...
                if len(erp_relation_list) > 0:
                    for erp_relation_dict in erp_relation_list:
                        try:
                            ...
                            key = "order_" + erp_relation_dict["app_id"]
                            ...
                            while True:
                                ...
                                if not order_info_json:
                                    break
                                order_info_dict = json.loads(order_info_json.decode(encoding="utf-8", errors="strict"))
