...
async def present(hub, ctx, name: Text, max_count: int, min_count: int, block_device_mappings: List = None, image_id: Text = None, instance_type: Text = None, ipv6_address_count: int = None, ipv6_addresses: List = None, kernel_id: Text = None, key_name: Text = None, monitoring: Dict = None, placement: Dict = None, ramdisk_id: Text = None, security_group_ids: List = None, security_groups: List = None, subnet_id: Text = None, user_data: Text = None, additional_info: Text = None, disable_api_termination: bool = None, ebs_optimized: bool = None, iam_instance_profile: Dict = None, instance_initiated_shutdown_behavior: Text = None, network_interfaces: List = None, private_ip_address: Text = None, elastic_gpu_specification: List = None, elastic_inference_accelerators: List = None, tag_specifications: List = None, launch_template: Dict = None, instance_market_options: Dict = None, credit_specification: Dict = None, cpu_options: Dict = None, capacity_reservation_specification: Dict = None, hibernation_options: Dict = None, license_specifications: List = None, metadata_options: Dict = None, enclave_options: Dict = None)  -> Dict[str, Any]:
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        block_device_mappings(List, optional): The block device mapping, which defines the EBS volumes and instance store volumes to attach to
...
async def describe(hub, ctx)  -> Dict[str, Dict[str, Any]]:
    ...
    **Autogenerated function**
    ...
    Describes the specified instances or all instances. If you specify instance IDs, the output includes information
    for only the specified instances. If you specify filters, the output includes information for only those
    instances that meet the filter criteria. If you do not specify instance IDs or filters, the output includes
    information for all instances, which can affect performance. We recommend that you use pagination to ensure that
    the operation returns quickly and successfully. If you specify an instance ID that is not valid, an error is
    returned. If you specify an instance that you do not own, it is not included in the output. Recently terminated
    instances might appear in the returned results. This interval is usually less than one hour. If you describe
    instances in the rare case where an Availability Zone is experiencing a service disruption and you specify
    instance IDs that are in the affected zone, or do not specify any instance IDs at all, the call fails. If you
    describe instances and specify only instance IDs that are in an unaffected zone, the call works normally.
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe aws_auto.ec2.instance
    '''
    ...
    if not ret["status"]:
        hub.log.debug(f"Could not describe instance {ret['comment']}")
        return result

    for instance in ret["ret"]["TODO"]:
        new_instance = [
                {"Filters": filters, "InstanceIds": instance_ids, "MaxResults": max_results, "NextToken": next_token}
        ]
        result[instance["instanceId"]] = {"aws_auto.ec2.instance.present": new_instance}

        for i, data in enumerate(instance.get("", ())):
            sub_instance = copy.deepcopy(new_instance)

            # TODO check for subresouruces
            sub_instance.append({})
            sub_instance.append({"name": "TODOs"})
            result[f"TODOs-{i}"] = {"aws_auto.ec2.instance.present": sub_instance}
