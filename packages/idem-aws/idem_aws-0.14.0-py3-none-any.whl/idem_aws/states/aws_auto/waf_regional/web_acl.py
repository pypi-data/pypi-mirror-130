...
hub.exec.boto3.client.waf_regional.associate_web_acl
hub.exec.boto3.client.waf_regional.create_web_acl
hub.exec.boto3.client.waf_regional.delete_web_acl
hub.exec.boto3.client.waf_regional.disassociate_web_acl
hub.exec.boto3.client.waf_regional.get_web_acl
hub.exec.boto3.client.waf_regional.list_web_acls
hub.exec.boto3.client.waf_regional.update_web_acl
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf_regional.web_acl.present:
                - name: value
                - metric_name: value
    ...
    ret = await hub.exec.boto3.client.waf_regional.web_acl.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf_regional.get_web_acl(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf_regional.create_web_acl(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf_regional.get_web_acl(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf_regional.web_acl.absent:
                - name: value
                - web_acl_id: value
                - change_token: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf_regional.delete_web_acl(
                ctx,
