...
hub.exec.boto3.client.waf_regional.delete_logging_configuration
hub.exec.boto3.client.waf_regional.get_logging_configuration
hub.exec.boto3.client.waf_regional.list_logging_configurations
hub.exec.boto3.client.waf_regional.put_logging_configuration
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf_regional.logging_configuration.present:
                - name: value
                - logging_configuration: value
    '''
    
    result = dict(comment="", changes= None, name=name, result=True)
    ret = await hub.exec.boto3.client.waf_regional.logging_configuration.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf_regional.get_logging_configuration(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf_regional.put_logging_configuration(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf_regional.get_logging_configuration(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf_regional.logging_configuration.absent:
                - name: value
                - resource_arn: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf_regional.delete_logging_configuration(
                ctx,
