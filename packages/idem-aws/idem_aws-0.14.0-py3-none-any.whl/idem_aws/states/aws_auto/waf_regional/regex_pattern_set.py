...
hub.exec.boto3.client.waf_regional.create_regex_pattern_set
hub.exec.boto3.client.waf_regional.delete_regex_pattern_set
hub.exec.boto3.client.waf_regional.get_regex_pattern_set
hub.exec.boto3.client.waf_regional.list_regex_pattern_sets
hub.exec.boto3.client.waf_regional.update_regex_pattern_set
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf_regional.regex_pattern_set.present:
                - name: value
                - change_token: value
    '''
    
    result = dict(comment="", changes= None, name=name, result=True)
    ret = await hub.exec.boto3.client.waf_regional.regex_pattern_set.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf_regional.get_regex_pattern_set(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf_regional.create_regex_pattern_set(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf_regional.get_regex_pattern_set(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf_regional.regex_pattern_set.absent:
                - name: value
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf_regional.delete_regex_pattern_set(
                ctx,
