...
hub.exec.boto3.client.waf_regional.delete_permission_policy
hub.exec.boto3.client.waf_regional.get_permission_policy
hub.exec.boto3.client.waf_regional.put_permission_policy
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf_regional.permission_policy.present:
                - name: value
                - resource_arn: value
                - policy: value
    '''
    ...
    ret = await hub.exec.boto3.client.waf_regional.permission_policy.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf_regional.get_permission_policy(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf_regional.put_permission_policy(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf_regional.get_permission_policy(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf_regional.permission_policy.absent:
                - name: value
                - resource_arn: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf_regional.delete_permission_policy(
                ctx,
