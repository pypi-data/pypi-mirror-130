...
hub.exec.boto3.client.waf_regional.create_rule_group
hub.exec.boto3.client.waf_regional.delete_rule_group
hub.exec.boto3.client.waf_regional.get_rule_group
hub.exec.boto3.client.waf_regional.list_rule_groups
hub.exec.boto3.client.waf_regional.update_rule_group
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf_regional.rule_group.present:
                - name: value
                - metric_name: value
                - change_token: value
    '''
    ...
    ret = await hub.exec.boto3.client.waf_regional.rule_group.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf_regional.get_rule_group(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf_regional.create_rule_group(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf_regional.get_rule_group(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf_regional.rule_group.absent:
                - name: value
                - rule_group_id: value
                - change_token: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf_regional.delete_rule_group(
                ctx,
