...
hub.exec.boto3.client.waf_regional.create_size_constraint_set
hub.exec.boto3.client.waf_regional.delete_size_constraint_set
hub.exec.boto3.client.waf_regional.get_size_constraint_set
hub.exec.boto3.client.waf_regional.list_size_constraint_sets
hub.exec.boto3.client.waf_regional.update_size_constraint_set
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf_regional.size_constraint_set.present:
                - name: value
                - change_token: value
    '''
    
    result = dict(comment="", changes= None, name=name, result=True)
    ret = await hub.exec.boto3.client.waf_regional.size_constraint_set.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf_regional.get_size_constraint_set(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf_regional.create_size_constraint_set(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf_regional.get_size_constraint_set(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf_regional.size_constraint_set.absent:
                - name: value
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf_regional.delete_size_constraint_set(
                ctx,
