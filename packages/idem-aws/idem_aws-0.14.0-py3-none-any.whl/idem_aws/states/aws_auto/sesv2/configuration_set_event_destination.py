...
hub.exec.boto3.client.sesv2.create_configuration_set_event_destination
hub.exec.boto3.client.sesv2.delete_configuration_set_event_destination
hub.exec.boto3.client.sesv2.get_configuration_set_event_destinations
hub.exec.boto3.client.sesv2.update_configuration_set_event_destination
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.sesv2.configuration_set_event_destination.present:
                - name: value
    ...
    ret = await hub.exec.boto3.client.sesv2.configuration_set_event_destination.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.sesv2.get_configuration_set_event_destinations(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.sesv2.create_configuration_set_event_destination(
                ctx,
    ...
    after = await hub.exec.boto3.client.sesv2.get_configuration_set_event_destinations(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.sesv2.configuration_set_event_destination.absent:
                - name: value
                - configuration_set_name: value
                - event_destination_name: value
    '''
