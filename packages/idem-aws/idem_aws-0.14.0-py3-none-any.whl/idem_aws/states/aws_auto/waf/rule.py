...
hub.exec.boto3.client.waf.create_rule
hub.exec.boto3.client.waf.delete_rule
hub.exec.boto3.client.waf.get_rule
hub.exec.boto3.client.waf.list_rules
hub.exec.boto3.client.waf.update_rule
"""
...
async def present(hub, ctx, name: Text, metric_name: Text, change_token: Text, tags: List = None)  -> Dict[str, Any]:
    ...
    **Autogenerated function**
    ...
    ret = await hub.exec.boto3.client.waf.rule.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf.get_rule(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf.create_rule(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf.get_rule(name)
...
async def absent(hub, ctx, name: Text, rule_id: Text, change_token: Text)  -> Dict[str, Any]:
    ...
    **Autogenerated function**
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf.delete_rule(
                ctx,
