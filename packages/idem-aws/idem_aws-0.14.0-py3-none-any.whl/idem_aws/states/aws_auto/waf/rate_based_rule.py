...
hub.exec.boto3.client.waf.create_rate_based_rule
hub.exec.boto3.client.waf.delete_rate_based_rule
hub.exec.boto3.client.waf.get_rate_based_rule
hub.exec.boto3.client.waf.list_rate_based_rules
hub.exec.boto3.client.waf.update_rate_based_rule
"""
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.waf.rate_based_rule.present:
                - name: value
                - metric_name: value
                - rate_key: value
                - rate_limit: value
    ...
    ret = await hub.exec.boto3.client.waf.rate_based_rule.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.waf.get_rate_based_rule(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.waf.create_rate_based_rule(
                ctx,
    ...
    after = await hub.exec.boto3.client.waf.get_rate_based_rule(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.waf.rate_based_rule.absent:
                - name: value
                - rule_id: value
                - change_token: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.waf.delete_rate_based_rule(
                ctx,
