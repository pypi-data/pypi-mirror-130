...
hub.exec.boto3.client.neptune.copy_db_cluster_snapshot
hub.exec.boto3.client.neptune.create_db_cluster_snapshot
hub.exec.boto3.client.neptune.delete_db_cluster_snapshot
hub.exec.boto3.client.neptune.describe_db_cluster_snapshots
"""
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        db_cluster_snapshot_identifier(Text): The identifier of the DB cluster snapshot. This parameter is stored as a lowercase string.
            ...
            a letter.   Cannot end with a hyphen or contain two consecutive hyphens.   Example: my-
            cluster1-snapshot1.
        db_cluster_identifier(Text): The identifier of the DB cluster to create a snapshot for. This parameter is not case-sensitive.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.neptune.db_cluster_snapshot.present:
                - name: value
    ...
    ret = await hub.exec.boto3.client.neptune.db_cluster_snapshot.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.neptune.describe_db_cluster_snapshots(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.neptune.create_db_cluster_snapshot(
                ctx,
    ...
    after = await hub.exec.boto3.client.neptune.describe_db_cluster_snapshots(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.neptune.db_cluster_snapshot.absent:
                - name: value
                - db_cluster_snapshot_identifier: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.neptune.delete_db_cluster_snapshot(
                ctx,
