...
hub.exec.boto3.client.pinpoint.create_sms_template
hub.exec.boto3.client.pinpoint.delete_sms_template
hub.exec.boto3.client.pinpoint.get_sms_template
hub.exec.boto3.client.pinpoint.update_sms_template
"""
...
async def present(hub, ctx, name: Text, sms_template_request: Dict, template_name: Text)  -> Dict[str, Any]:
    r'''
    **Autogenerated function**
    ...
    Args:
        ...
        sms_template_request(Dict): Specifies the content and settings for a message template that can be used in text messages that
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              aws_auto.pinpoint.sms_template.present:
                - name: value
                - sms_template_request: value
                - template_name: value
    '''
    
    result = dict(comment="", changes= None, name=name, result=True)
    ret = await hub.exec.boto3.client.pinpoint.sms_template.id(
        ctx,
        jmes_path=name
    )
    if ret["status"]:
    ...
    before = await hub.exec.boto3.client.pinpoint.get_sms_template(name)

    if before:
        result["comment"] = f"'{name}' already exists"
    else:
        try:
            ret = await hub.exec.boto3.client.pinpoint.create_sms_template(
                ctx,
                
                
                **{"SMSTemplateRequest": sms_template_request, "TemplateName": template_name}
            )
    ...
    after = await hub.exec.boto3.client.pinpoint.get_sms_template(name)
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              aws_auto.pinpoint.sms_template.absent:
                - name: value
                - template_name: value
    '''
    ...
    if not before:
        ...
        try:
            ret = await hub.exec.boto3.client.pinpoint.delete_sms_template(
                ctx,
