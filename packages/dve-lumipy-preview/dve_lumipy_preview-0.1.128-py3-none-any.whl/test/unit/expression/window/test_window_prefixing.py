...
class TestWindowPrefixing(unittest.TestCase):
    ...
    def test_auto_prefixing_in_window_fn_frame_only(self):
        ...
        duration = ar2.apply_prefix(ar.duration.cume_sum())
    ...
    def test_complex_join_window_function_prefixing(self):
        ...
        qry = join.select(
            ...
            SelfTimeCumeDist=rt.self_time.cume_dist(),
            ForLackOfABetterExample=rt.self_time.cume_dist()*tv.duration.cume_dist()
        )
