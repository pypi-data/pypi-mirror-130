...
class Shield34Properties:
    ...
    def initialize():
        if not Shield34Properties.isInitialized:
            ...
            Shield34Properties.wait_timeout = int(Shield34Properties.get_section_value('driver', 'wait.timeout', 60))

            Shield34Properties.capture_javascript = Shield34Properties.get_section_value('driver', 'capture.javascript', 'True').lower() == 'true'
