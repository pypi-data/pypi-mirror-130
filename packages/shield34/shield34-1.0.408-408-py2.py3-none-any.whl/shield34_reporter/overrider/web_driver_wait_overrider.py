...
class WaitElementToBeClickable(WaitBase):
    ...
    def finalize_wait(self, web_element):
        try:
            ...
            if web_element is not None:
                ...
                web_element_found(web_element, self.locator[0], self.locator[1])
                RunReportContainer.get_current_block_run_holder().web_element_descriptors_map[web_element.id] = Locator(
    ...
    def timeout_exception(self, e):
        web_element, current_by, current_value = locate_element_by_element_descriptor(DriverUtils.get_current_driver(),
                                                                                      self.locator[0], self.locator[1])
