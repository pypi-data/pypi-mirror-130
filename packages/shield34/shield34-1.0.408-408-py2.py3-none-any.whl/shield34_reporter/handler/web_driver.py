...
class DriverFindElements(SeleniumMethodHandler):
    ...
    def on_successful_action(self):
        ...
        for elem in self.located_web_elements:
            ...
            RunReportContainer.add_report_csv_row(
                WebElementHtml(
                    WebElementUtils.get_element_html(elem),
                    WebElementUtils.get_element_computed_css(elem,
                                                             self.driver),
                    WebElementUtils.get_element_wrapping_html(elem, 3)))
    ...
    def _returned_value(self):
        return self.located_web_elements
