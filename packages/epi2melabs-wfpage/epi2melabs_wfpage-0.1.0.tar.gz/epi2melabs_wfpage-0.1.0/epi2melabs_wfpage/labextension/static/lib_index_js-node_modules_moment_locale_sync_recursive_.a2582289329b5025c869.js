(self["webpackChunkepi2melabs_wfpage"] = self["webpackChunkepi2melabs_wfpage"] || []).push([["lib_index_js-node_modules_moment_locale_sync_recursive_"],{
...
const IndexPanel = ({ className }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `index-panel ${className}` },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "index-panel-intro" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "EPI2ME Labs Workflows"),
...
const WorkflowComponent = ({ className }) => {
    ...
    console.log(setWorkflowParams);
    console.log(workflowParamsErrors);
    console.log(workflowParamsValid);
...
//# sourceMappingURL=lib_index_js-node_modules_moment_locale_sync_recursive_.a2582289329b5025c869.js.map