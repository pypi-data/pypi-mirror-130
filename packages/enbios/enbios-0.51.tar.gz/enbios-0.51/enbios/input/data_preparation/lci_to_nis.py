...
from enbios.common.helper import list_to_dataframe, generate_json, generate_workbook, print_issues, PrintColors
...
class SpoldToNIS:
    ...
    def spold2nis(self, default_output_interface: str, lci_base: str, correspondence, nis_base_url: str, output_file: str):
        ...
        print_issues(issues, f"Please check the issues and the output file '{output_file}'")
