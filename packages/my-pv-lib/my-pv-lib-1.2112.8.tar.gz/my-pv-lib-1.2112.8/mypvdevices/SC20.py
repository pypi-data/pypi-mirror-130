...
SERIALLEN = 16
ACTEMPMINIMUMVALUE = 40
ACTEMPMAXIMUMVALUE = 90

class SC20(SerialDevice):
    ...
    def __init__(self, serialnumber):
        ...
        self._channels["ac_switch_on_time"] = ChannelConfig([25], "NUMBER", 0, registertype="serial")
        ...
        self._setup["ww2target"] = SetupMapping("ac_temp_target")
    ...
    def getdata(self):
        ...
        data={
            ...
            "water_temp": self.getchannelvalue("water_temp", True),
            ...
            # "ac_boost_mode": self.getchannelvalue("ac_boost_mode", True), #todo
            "m1sum": dcPower,
            "m0sum": meter,
    ...
    def getlogdata(self, time = None):
        ...
        logData = {
            ...
            "i_temp1": self.getlogvalue("water_temp", "int"),
...
if __name__ == "__main__":
    ...
    # device = SC20(serialnr)
    # device2 = SC20("1201061912110002")
    ...
    # print(setup)
    # device.setsetupvalue("ww2target", 55)
    # setup = device.getsetup()
    # print(setup)
