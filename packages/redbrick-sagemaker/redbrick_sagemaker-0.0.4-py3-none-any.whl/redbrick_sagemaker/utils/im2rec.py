    ...
    for i in range(args.chunks):
        ...
        if args.train_ratio == 1.0:
            ...
            if args.train_ratio + args.test_ratio < 1.0:
                write_list(
                    args.prefix + str_chunk + "_val.lst",
                    chunk[sep_test + sep :],
                )
            write_list(
                args.prefix + str_chunk + "_train.lst",
...
def construct_args(args):
    """
    Constructs arguments so this file can be imported
    and run as a function call.
    """
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
        description="Create an image list or \
    ...
    parser.add_argument(
        "--root", help="path to folder containing images.", default="root"
    )
