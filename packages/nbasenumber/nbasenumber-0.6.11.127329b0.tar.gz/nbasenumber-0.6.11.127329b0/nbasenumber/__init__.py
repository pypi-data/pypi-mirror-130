...
-1, got "+str(i))
  ...
  self.format_to_str(_0="0", _1="1", _2="2", _3="3", _4="4", _5="5", _6="6",
    ...
    def get_cihper(self, place=None) :
        """Get cihper(s) from self. If place is None, get the complete tuple. Or
return the cihper of that place(from 0)."""
    ...
    def get_amount(self, place) :
        """Get amount of a digit from self. Return the amount of the cihper of
that place(from 0)."""
