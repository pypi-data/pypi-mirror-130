...
ifdo_capture_fields = {
	...
	'image-camera-yaw-degrees':{'comment':'Camera view yaw angle. Rotation of camera coordinates (x,y,z = right, down, line of sight) with respect to NED coordinats (x,y,z = north,east,down) in accordance with the yaw,pitch,roll rotation order convention:\n1. yaw around z,\n2. pitch around rotated y,\n3. roll around rotated x\nRotation directions according to \'right-hand rule\'. I.e. for yaw,pitch,roll = 0,0,0 camera is facing downward with top side towards west','dataType':dataTypes.float},
	'image-camera-pitch-degrees':{'comment':'Camera view pitch angle. Rotation of camera coordinate system (x,y,z = right, down, line of sight) with respect to NED coordinate system (x,y,z = north,east,down) in accordance with the yaw,pitch,roll rotation order convention:\n1. yaw around z,\n2. pitch around rotated y,\n3. roll around rotated x\nRotation directions according to \'right-hand rule\'. I.e. for yaw,pitch,roll = 0,0,0 camera is facing downward with top side towards west','dataType':dataTypes.float},
	'image-camera-roll-degrees':{'comment':'Camera view roll angle. Rotation of camera coordinate system (x,y,z = right, down, line of sight) with respect to NED coordinate system (x,y,z = north,east,down) in accordance with the yaw,pitch,roll rotation order convention:\n1. yaw around z,\n2. pitch around rotated y,\n3. roll around rotated x\nRotation directions according to \'right-hand rule\'. I.e. for yaw,pitch,roll = 0,0,0 camera is facing downward with top side towards west','dataType':dataTypes.float,'req':['image-camera-axis-alignment']}, # TODO use 'req'?
	'image-camera-axis-alignment':{'comment':'Axis of the body-fixed coordinate system along which the camera is facing plus axis indicating up/down in the image with x,y,z pointing in the body\'s forward, right and down direction, respectively. ','valid':['along z, x up', 'along x, z down', 'along y, z down']}, # TODO ?
