...
def readAllPositionsFromFilePath(src_file_path:str,col_names:dict,date_format:str,col_separator="\t",optional=['hgt'],const_values:dict={}):
	...
	return readAllPositionsFromFile(navigation_file,col_indcs,date_format,col_separator=col_separator,const_values=const_values)
...
def readAllAttitudesFromFilePath(src_file_path:str,col_names:dict,date_format:str,col_separator="\t",const_values:dict={}):
	...
	navigation_file = open(src_file_path,"r",errors="ignore")
	max_col_idx,col_indcs = miqtf.tabFileColumnIndicesFromFile(navigation_file,col_names)
	return readAllAttitudesFromFile(navigation_file,col_indcs,date_format,col_separator=col_separator,const_values=const_values)


def readAllAttitudesFromFile(navigation_file,col_indcs:dict,date_format:str,col_separator="\t",const_values:dict={}):
	...
	for line in navigation_file:
		if line.strip() != "":
			try:
				attitude = miqtf.attitudeFromTabFileLine(line,col_indcs,date_format,add_utc=True,col_separator=col_separator,const_values=const_values)
