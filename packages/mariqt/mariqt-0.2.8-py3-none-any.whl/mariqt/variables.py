...
ifdo_capture_fields = {
	...
	'image-camera-yaw-degrees':{'comment':'Camera view yaw angle','dataType':dataTypes.float},
	'image-camera-pitch-degrees':{'comment':'Camera view pith angle','dataType':dataTypes.float},
	'image-camera-roll-degrees':{'comment':'Camera view roll angle','dataType':dataTypes.float,'req':['image-camera-axis-alignment']}, # TODO use 'req'?
