...
This is a basic python starter package to be used as a template for creating your own python packages. Github repo: https://github.com/mystic-repo/PythonStarterPackage
...
pip install PythonStarterPackage
```
4. Finally, run the ```app.py``` to test that the package is working.
```
./app.py
```
