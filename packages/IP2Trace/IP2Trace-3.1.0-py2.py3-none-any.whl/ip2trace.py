...
"  If the database filename is specified but without the path, ip2tracepy will searched in /usr/share/ip2location/ for Linux or C:\Users\(your_Windows_username)\Documents\ for Windows.\n"
"\n"
"  -t, --ttl\n"
