...
from mlflow.protos.service_pb2 import ModelConfigurationInfo as ProtoRunInfo
...
class RunInfo(_MLflowObject):
    ...
    def to_proto(self):
        proto = ProtoRunInfo()
        proto.model_configuration_uuid = self.run_uuid
        proto.model_configuration_id = self.run_id
        proto.model_id = self.experiment_id
    ...
    def from_proto(cls, proto):
        ...
        if end_time == 0:
            end_time = None
        return cls(
            run_uuid=proto.model_configuration_uuid,
            run_id=proto.model_configuration_id,
            experiment_id=proto.model_id,
