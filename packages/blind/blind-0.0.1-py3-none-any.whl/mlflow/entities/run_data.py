...
from mlflow.protos.service_pb2 import (
    ModelConfigurationData as ProtoRunData,
    Param as ProtoParam,
    ModelConfigurationTag as ModelConfigurationTag,
)
...
class RunData(_MLflowObject):
    ...
    def to_proto(self):
        ...
        run_data.tags.extend([ModelConfigurationTag(key=key, value=val) for key, val in self.tags.items()])
        return run_data
