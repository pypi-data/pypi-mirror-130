...
class Experiment(_MLflowObject):
    ...
    def from_proto(cls, proto):
        experiment = cls(
            proto.model_id, proto.name, proto.artifact_location, proto.lifecycle_stage
        )
    ...
    def to_proto(self):
        experiment = ProtoModel()
        experiment.model_id = self.experiment_id
        ...
        experiment.tags.extend(
            [ProtoModelTag(key=key, value=val) for key, val in self._tags.items()]
        )
        return experiment
