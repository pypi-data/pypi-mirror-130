...
class ClientDatabase:
    ...
    '''
    class KnownUsers:
        '''Класс-отображение для таблицы пользователей'''
    ...
    class MessageStat:
        '''Класс-отображение для таблицы статистики по сообщениям'''
    ...
    def contacts_clear(self):
        '''Метод для очистки таблицы контактов'''
        self.session.query(self.Contacts).delete()
    ...
    def add_users(self, users_list):
        '''Метод для заполнения таблицы известных пользователей'''
    ...
    def save_message(self, contact, direction, message):
        '''Метод для сохранения в базе данных сообщения'''
    ...
    def get_contacts(self):
        '''
        Метод извлекающий из базы данных имена всех известных
        пользователю контактов
        '''
        return [contact[0]
                for contact in self.session.query(self.Contacts.name).all()]

    def get_users(self):
        '''Метод возвращающий всех известных пользователей из БД'''
        return [user[0]
                for user in self.session.query(self.KnownUsers.username).all()]

    def check_user(self, user):
        '''
        Метод для проверки существования пользователя в таблице всех
        пользователей
        '''
    ...
    def check_contact(self, contact):
        '''
        Метод для проверки существования пользователя в таблице контактов
        '''
    ...
    def get_history(self, contact):
        '''Метод возвращает все сообщения контакта (историю)'''
