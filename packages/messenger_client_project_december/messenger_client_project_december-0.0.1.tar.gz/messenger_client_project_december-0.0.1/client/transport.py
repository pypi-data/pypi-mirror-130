...
class ClientTransport(threading.Thread, QObject):
    ...
    def process_server_ans(self, message):
        '''Метод разбора сообщения от сервера'''
    ...
    def add_contact(self, contact):
        '''Метод отправляющий на сервер запрос о добавлении контакта'''
    ...
    def remove_contact(self, contact):
        '''Метод отправляющий на сервер запрос об удалении контакта'''
    ...
    def send_message(self, to, message):
        '''Метод который отправляет на сервер сообщение для пользователя.'''
        message_dict = {
            ACTION: MESSAGE,
