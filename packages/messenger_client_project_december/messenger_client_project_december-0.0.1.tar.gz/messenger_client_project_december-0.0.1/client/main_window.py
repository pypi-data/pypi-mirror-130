...
class ClientMainWindow(QMainWindow):
    ...
    клиентского модуля. Конфигурация окна создана в QTDesigner и загружается
    из конвертированого файла main_window_conv.py
    '''
    ...
    def set_disabled_input(self):
        '''Метод, чтобы сделать неактивным поля ввода'''
        # Надпись  - получатель.
    ...
    def select_active_user(self):
        '''Метод, чтобы выбрать активного пользователя по двойному щелчку
         на списке контактов'''
    ...
    def set_active_user(self):
        '''Метод, чтобы активировать чат с собеседником'''
    ...
    def clients_list_update(self):
        '''Метод для обновления списка контактов пользователя'''
    ...
    def add_contact_window(self):
        '''Метод, который создает окно для добавления пользователя
         в список контактов'''
    ...
    def add_contact_action(self, item):
        '''Метод при нажатии на кнопку Добавления контакта'''
        new_contact = item.selector.currentText()
        self.add_contact(new_contact)
        item.close()

    def add_contact(self, new_contact):
        '''Метод дабавляющий контакт в базу данных (на сервере и на клиенте)
         и обновляющий окно контактов'''
        try:
    ...
    def delete_contact_window(self):
        '''Метод, который создает окно для удаления пользователя
         из списка контактов'''
    ...
    def delete_contact(self, item):
        '''
        Метод удаляющий контакт из базы данных (на сервере и на клиенте)
        и обновляющий окно контактов'''
    ...
    def send_message(self):
        '''
        Метод, который реализует отправку сообщения текущему собеседнику.
        Сообщения шифруются.
        '''
    ...
    def connection_lost(self):
        '''Слот обработчик при потере соединения с сервером'''
        self.messages.warning(
            self,
            'Сбой соединения',
