...
doc_requires = get_distribution("dkist_processing_pac").requires(extras=("docs",))
...
# -- Non stdlib imports --------------------------------------------------------
import dkist_processing_pac  # NOQA
from dkist_processing_pac import __version__  # NOQA
...
autoapi_dirs = ["../dkist_processing_pac"]
