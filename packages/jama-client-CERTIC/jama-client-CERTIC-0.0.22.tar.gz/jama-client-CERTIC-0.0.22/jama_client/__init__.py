...
class Client:
    ...
    def restore_collection(self, collection_id: int) -> bool:
        """
        Restore a deleted collection from the recycle bin
        """
        return self.__call("restore_collection", [collection_id])

    def restore_resource(self, resource_id: int) -> bool:
        """
        Restore a deleted resource from the recycle bin
        """
        return self.__call("restore_resource", [resource_id])
