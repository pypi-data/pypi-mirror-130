...
def pydantic_to_straw(
    ...
    fields_to_use = set(gql_cls.__dataclass_fields__.keys()) & set(
        pyd_model.__fields__.keys()
    )
    straw_type_defs_d = {field.name: field for field in gql_cls._type_definition.fields}
    d = {}
