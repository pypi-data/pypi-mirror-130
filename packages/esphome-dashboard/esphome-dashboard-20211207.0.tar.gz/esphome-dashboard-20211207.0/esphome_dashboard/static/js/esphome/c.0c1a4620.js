...
`;let oe=class extends y{constructor(){super(...arguments),this._busy=!1,this._board="ESP32",this._hasWifiSecrets=void 0,this._customBoard="",this._data={ssid:`!secret ${P}`,psk:`!secret ${x}`},this._writeProgress=0,this._state="basic_config",this._cleanNameInput=e=>{this._error=void 0;const o=e.target;o.value=o.value.toLowerCase().replace(/[ \._]/g,"-").replace(/[^a-z0-9-]/g,"")},this._cleanNameBlur=e=>{const o=e.target;o.value=o.value.replace(/^-+/,"").replace(/-+$/,"")},this._cleanSSIDBlur=e=>{const o=e.target;o.value=o.value.trim()}}render(){let e,o,t=!1;return"basic_config"===this._state?[e,o,t]=this._renderBasicConfig():"pick_board"===this._state?(e="Select your ESP device",o=this._renderPickBoard()):"connect_webserial"===this._state?(e="Installation",o=this._renderConnectSerial()):"connecting_webserial"===this._state?(o=this._renderProgress("Connecting"),t=!0):"prepare_flash"===this._state?(o=this._renderProgress("Preparing installation"),t=!0):"flashing"===this._state?(o=this._renderProgress(u`
    ...
    `}_renderMessage(e,o,t){return u`
      ...
      ${t&&u`
        ...
        ></mwc-button>
      `}
    `}_renderBasicConfig(){if(void 0===this._hasWifiSecrets)return[void 0,this._renderProgress("Initializing"),!0];return["Create configuration",u`
      ${R?"":u`
            <div class="notice">
