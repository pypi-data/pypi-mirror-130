...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, ca_cert=None, pulp_href=None, pulp_created=None, client_cert=None, max_retries=None, total_timeout=None, proxy_url=None, pulp_labels=None, pulp_last_updated=None, sock_read_timeout=None, url=None, sock_connect_timeout=None, tls_validation=None, connect_timeout=None, rate_limit=None, name=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
