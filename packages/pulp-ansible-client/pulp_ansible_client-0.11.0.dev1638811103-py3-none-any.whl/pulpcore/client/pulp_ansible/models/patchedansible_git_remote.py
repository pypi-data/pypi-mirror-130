...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, headers=None, ca_cert=None, proxy_password=None, username=None, client_cert=None, max_retries=None, total_timeout=None, proxy_url=None, pulp_labels=None, proxy_username=None, sock_read_timeout=None, url=None, password=None, sock_connect_timeout=None, tls_validation=None, connect_timeout=None, client_key=None, rate_limit=None, name=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
