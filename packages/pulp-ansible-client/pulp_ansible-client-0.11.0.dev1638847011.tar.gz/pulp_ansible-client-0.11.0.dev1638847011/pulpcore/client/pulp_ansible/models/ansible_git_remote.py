...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, headers=None, download_concurrency=None, rate_limit=None, username=None, client_cert=None, total_timeout=None, sock_read_timeout=None, url=None, client_key=None, password=None, proxy_password=None, connect_timeout=None, sock_connect_timeout=None, tls_validation=None, ca_cert=None, proxy_url=None, proxy_username=None, pulp_labels=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
