...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, max_retries=None, headers=None, download_concurrency=None, rate_limit=None, client_cert=None, total_timeout=None, sock_read_timeout=None, url=None, pulp_last_updated=None, connect_timeout=None, sock_connect_timeout=None, tls_validation=None, ca_cert=None, proxy_url=None, pulp_labels=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
