        ...
        if not message.author.bot:
          ...
          for commandinfo in commandloader.commandsToLoad:
            ...
            if str(message.content).startswith(str(prefix + commandname)):
              ...
              while "$addCmdReactions[" in commandcode or prefix:
              ...
              while "$addReactions[" in commandcode or prefix:
              ...
              while "$authorID" in commandcode or prefix:
                commandcode = commandcode.replace("$authorID", str(message.author.id))
                break
                
              while "$createServerInvite[" in commandcode or prefix:
              ...
              while "$updateServerVar[" in commandcode or prefix:
              ...
              while "$createServerVar[" in commandcode or prefix:
              ...
              while "$getServerVar[" in commandcode or prefix:
              ...
              while "$findUserID[" in commandcode or prefix:
                try:
              ...
              while "$jsonRequest[" in commandcode or prefix:
              ...
              while "$round[" in commandcode or prefix:
              ...
              while "$shardID" in commandcode or prefix:
                if self.__sharding is True:
              ...
              while "$shardCount" in commandcode or prefix:
                if self.__sharding is True:
                  if self.__shardsAmount >= 2:
              ...
              while "$shardPing" in commandcode or prefix:
                if self.__sharding is True:
                  if self.__shardsAmount >= 2:
                    shard_id = message.guild.shard_id
              ...
              while "$shardGuilds" in commandcode or prefix:
                if self.__sharding is True:
                  if self.__shardsAmount >= 2:
                    shard_id = message.guild.shard_id
                    shard = self.__clientUse.get_shard(shard_id)
              ...
              while "$randomText[" in commandcode or prefix:
              ...
              while "$remRole[" in commandcode or prefix:
              ...
              while "$addRole[" in commandcode or prefix:
              ...
              while "$packageVersion" in commandcode or prefix:
                commandcode = commandcode.replace("$packageVersion", f"{version}")
                break

              while "$delMessage" in commandcode or prefix:
                try:
              ...
              if "$setFooter[" in commandcode or prefix:
                try:
              ...
              if "$setThumbnail[" in commandcode or prefix:
              ...
              if "$setAuthor[" in commandcode or prefix:
                try:
              ...
              if "$setImage[" in commandcode or prefix:
              ...
              if "$addTimestamp" in commandcode or prefix:
                try:
              ...
              while "$let[" in commandcode or prefix:
              ...
              while "$get[" in commandcode or prefix:
