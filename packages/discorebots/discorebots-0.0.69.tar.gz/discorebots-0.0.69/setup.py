...
bot.onWebsocketResponse("Bot is ready to use!") #log ready if you want set status: bot.onWebsocketResponse("ready", "type (dnd/idle/online)", "status (watch/stream/listen/game)", "status text")
...
setuptools.setup(
    ...
    version=f"0.0.69", # The version of your package!
