...
setup(
 ...
 '* Progress.__init__: make the first optional positional parameter be "name", '    
 'make other parameters keyword only.\n'    
 '* Progress.bar: make "label" the first optional positional parameter, make '    
 'others keyword only.\n'    
 '\n'    
 ...
 '\n'    
 '### Method `Progress.__init__(self, name: Optional[str] = None, *, position: '    
 'Optional[int] = None, start: Optional[int] = None, start_time: '    
 'Optional[float] = None, throughput_window: Optional[int] = None, total: '    
 'Optional[int] = None, units_scale=None)`\n'    
 '\n'    
 ...
 'Initial release of cs.progress.'),
  install_requires = ['cs.deco', 'cs.logutils', 'cs.py.func', 'cs.seq', 'cs.units', 'cs.upd', 'typeguard'],
