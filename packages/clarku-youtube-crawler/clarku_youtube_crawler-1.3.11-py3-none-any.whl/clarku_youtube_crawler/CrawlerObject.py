...
class _CrawlerObject():
    ...
    def __build__(self, objectType):
        ...
        subtitle_dest_list = [self.SUBTITLE_PARENT_PATH, self.subtitle_data_dir]
        if objectType == "raw":
    ...
    def _fetch_vars(self):
        ...
        # subtitle
        self.SUBTITLE_PARENT_PATH = config.get("subtitlefilepath", "subtitle_parent_path")
        self.subtitle_data_dir = \
            self.SUBTITLE_PARENT_PATH + config.get("subtitlefilepath", "subtitle_subtitle_dir")
    # Try update the API
