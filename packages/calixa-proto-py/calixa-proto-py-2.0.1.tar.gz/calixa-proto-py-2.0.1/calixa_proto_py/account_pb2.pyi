...
class Account(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"address",b"address",u"first_seen_at",b"first_seen_at",u"last_seen_at",b"last_seen_at",u"properties",b"properties",u"signed_up_at",b"signed_up_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"address",b"address",u"created_by_user_id",b"created_by_user_id",u"domain_name",b"domain_name",u"first_seen_at",b"first_seen_at",u"last_seen_at",b"last_seen_at",u"name",b"name",u"properties",b"properties",u"signed_up_at",b"signed_up_at",u"status",b"status"]) -> None: ...
...
class AccountUser(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"first_seen_at",b"first_seen_at",u"last_seen_at",b"last_seen_at",u"properties",b"properties",u"signed_up_at",b"signed_up_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"email",b"email",u"first_name",b"first_name",u"first_seen_at",b"first_seen_at",u"last_name",b"last_name",u"last_seen_at",b"last_seen_at",u"properties",b"properties",u"signed_up_at",b"signed_up_at",u"status",b"status"]) -> None: ...
