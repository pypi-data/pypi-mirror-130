...
setup(
    ...
    description='A toolkit for estimating the correlation between variables',  # Optional
    ...
    url='https://github.com/dhchenx/correlation-kit',  # Optional
    ...
    # larger catalog.
    keywords='correlation analysis,relation mining',  # Optional
