...
class TestRelease:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                0,
                "Fedora-Modular",
                fedfind.release.BranchedModularNightly,
                "27",
                "Branched",
                "datestr",
                "0",
            ...
            (
                ...
                0,
                "Fedora-Modular",
                fedfind.release.RawhideModularNightly,
                "Rawhide",
                "",
                "datestr",
                "0",
            ...
            (
                ...
                0,
                "Fedora-Modular",
                fedfind.release.BikeshedModularNightly,
                "Bikeshed",
                "",
                "datestr",
                "0",
    ...
    def test_get_release_url_cid_branched_modular(self):
        ...
        """
        url = (
            "https://kojipkgs.fedoraproject.org/" "compose/Fedora-Modular-27-20170816.n.0/compose/"
        )
        ret = fedfind.release.get_release(url=url)
    ...
    def test_get_stable_current(self):
        ...
        bumping that cutoff.
        """
        ret = fedfind.release.get_release(35)
        assert isinstance(ret, fedfind.release.CurrentRelease)
        assert ret.release == "35"
    ...
    def test_get_stable_archive(self):
        ...
        cutoff.
        """
        ret = fedfind.release.get_release(32)
        assert isinstance(ret, fedfind.release.ArchiveRelease)
        assert ret.release == "32"
    ...
    def test_get_release_respinrelease(self, http):
        ...
        assert got.release == "35"
        assert got.milestone == "Respin"
        assert got.compose == "20211201"
        ...
        got3 = fedfind.release.get_release(cid="FedoraRespin-35-20211201.0")
    ...
    def test_images_respinrelease(self, http):
        ...
        exp = ["Cinnamon", "KDE", "LXDE", "LXQt", "Mate", "Workstation", "Xfce", "i3"]
    ...
    def test_compose_urls(self, http):
        ...
        script.
        """
        urlfn = "compose-urls-20211206.json"
