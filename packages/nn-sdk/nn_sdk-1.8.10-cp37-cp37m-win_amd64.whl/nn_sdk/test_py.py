...
config = {
    ...
    'tf':{
        ...
        "engine_version": 1, # tensorflow version
    ...
    "graph": [
        {
            ...
            "input": [
                {"node":"input_ids:0", "dtype":"int64", "shape":[1, 256]},
                {"node":"input_mask:0", "dtype":"int64", "shape":[1, 256]}
            ],
            "output": [
                {"node":"pred_ids:0", "dtype":"int64", "shape":[1, 256]},
            ],
        }
    ]}
