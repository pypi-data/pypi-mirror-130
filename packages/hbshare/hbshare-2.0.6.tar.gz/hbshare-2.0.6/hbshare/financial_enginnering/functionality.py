...
class Untils:
    ...
    def __init__(self,val_hld,indus_info,fin_info,benchmark_info):
        ...
        with open("hbshare/financial_enginnering/config/Asset_type_code.json", "r") as load_f:
            self.asset_type_code= json.load(load_f)
    ...
    def priviate_holding_valuation(self):
        print("")
