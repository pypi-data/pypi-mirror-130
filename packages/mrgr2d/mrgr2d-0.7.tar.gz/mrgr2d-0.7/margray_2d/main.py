...
class Margray:
    ...
    def health_bar(self,position=(10,10),maxlenght=400,height=25,color=(255,0,0),max_health=1000,current_health=200,outer_rect_color="white",border_width=4):
        from .healthbar import HealthBar
        return HealthBar(self,position,maxlenght,height,color,max_health,current_health,outer_rect_color,border_width)
    def run(self):
        if self.warn == 1:
            print("\n")
