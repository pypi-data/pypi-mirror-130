...
class TransparentSprite:
    ...
    def follow_sprite(self,sprite,velocity=1,stop_when_collided=False,onCollidedCallback=None):
        x = self.x
        y = self.y
    ...
    def follow_to(self,position,velocity=1,stop_when_reached=False,onReachedCallback=None):
        x = self.x
        y = self.y
