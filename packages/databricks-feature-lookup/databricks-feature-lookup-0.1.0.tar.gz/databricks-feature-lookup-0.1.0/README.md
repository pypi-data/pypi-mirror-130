...
This library is for online model serving systems and not intended to work on Databricks ML runtimes. Installing this on Databricks Runtime for ML will conflict with pre-install Feature Store client modules.
