...
class GraphPreferences(google.protobuf.message.Message):
    ...
    class _WeekdayEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Weekday.V], builtins.type):
...
class RevlogEntry(google.protobuf.message.Message):
    ...
    class _ReviewKind:
        V = typing.NewType('V', builtins.int)
    class _ReviewKindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ReviewKind.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        LEARNING = RevlogEntry.ReviewKind.V(0)
        REVIEW = RevlogEntry.ReviewKind.V(1)
        RELEARNING = RevlogEntry.ReviewKind.V(2)
        FILTERED = RevlogEntry.ReviewKind.V(3)
