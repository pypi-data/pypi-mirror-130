...
class FGenerator:
    ...
    def generate_json_locale_file(text_dict: OrderedDict = None,
        ...
        pivot_locale_file_name = f'{nn_pivot_locale}.{FGenerator.DEFAULT_LOCALE_FILE_EXTENSION}'
        file_path = f'{nn_locale_folder_path}/{pivot_locale_file_name}'
        pivot_locale_dict = OrderedDict()
        try:
            ...
            warning_printer(
                f'[{pivot_locale_file_name}] is not existed! We will create a new one',
                emphasis=False)
