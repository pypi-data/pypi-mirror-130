...
class Grid:
    ...
    def __init__(self, grid_config: GridConfig, add_artificial_border: bool = True, num_retries=10):
        ...
        if add_artificial_border:
            ...
            filled_obstacles[r - 1, r - 1:size - r + 1] = grid_config.OBSTACLE
            filled_obstacles[r - 1:size - r + 1, r - 1] = grid_config.OBSTACLE
            filled_obstacles[size - r, r - 1:size - r + 1] = grid_config.OBSTACLE
            filled_obstacles[r - 1:size - r + 1, size - r] = grid_config.OBSTACLE
