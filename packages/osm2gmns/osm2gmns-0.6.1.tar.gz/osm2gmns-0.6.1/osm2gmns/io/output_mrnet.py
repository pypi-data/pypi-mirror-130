...
def _outputMicroNodes(micronet, micronode_filepath, projection, encoding):
    ...
    writer.writerow(['node_id', 'zone_id', 'x_coord', 'y_coord', 'meso_link_id', 'lane_no'])
    for micronode_id, micronode in micronet.node_dict.items():
        ...
        line = [micronode.node_id, micronode.zone_id, x_coord, y_coord, micronode.mesolink.link_id, micronode.lane_no]
        writer.writerow(line)
