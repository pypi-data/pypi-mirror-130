    ...
    def get_complemento_cartaporte(self):
        try:
            ...
            if self.tipo_transporte == 'AutotransporteFederal':
                ...
                cartaporte_seguros.setAttribute('AseguraMedAmbiente', transporte_data.get('NombreAseg'))
                cartaporte_seguros.setAttribute('AseguraCarga', transporte_data.get('NombreAseg'))
                cartaporte_seguros.setAttribute('PolizaCarga', transporte_data.get('NumPolizaSeguro'))
                cartaporte_seguros.setAttribute('PolizaMedAmbiente', transporte_data.get('NumPolizaSeguro'))
                cartaporte_seguros.setAttribute('PolizaRespCivil', transporte_data.get('NumPolizaSeguro'))
                cartaporte_seguros.setAttribute('PrimaSeguro', '1000')
