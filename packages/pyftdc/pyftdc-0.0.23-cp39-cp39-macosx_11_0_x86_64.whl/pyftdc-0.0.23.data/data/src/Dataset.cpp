...
Dataset::getMetric(std::string   metricName, const size_t start, const size_t end, bool ratedMetric)
{
    ...
    Dataset::MetricsPtr metrics =  assembleMetricFromChunks(metricName, start_chunk_pos, end_chunk_pos);
    if (ratedMetric)
...
bool
Dataset::ConvertToRatedMetric(Dataset::MetricsPtr metric) {
...
Dataset::getMetrics(const std::vector<std::string> metricNames,
    ...
    std::vector<Dataset::MetricsPtr> metricList;
