...
diagnostics_file = '/Users/jorge.imperial/CLionProjects/mongo_ftdc/tests/diagnostic.data_40/metrics.2021-07-22T17-16-31Z-00000'
...
def test_dump_json():
    ...
    p.dump_file_as_json(diagnostics_file, '/tmp/test_.log')
