...
def hook(flask):
    ...
    flask.Flask.wsgi_app = wrap_wsgi_app(flask.Flask.wsgi_app, 'flask.Flask.wsgi_app')
    flask.Flask.dispatch_request = wrap_dispatch_requet(flask.Flask.dispatch_request, flask)
