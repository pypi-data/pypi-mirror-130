...
def wrap_wsgi_handler(original_app_func, wsgi_handler_name):
    ...
    def handler(*args, **kwargs):
        ...
        transaction = agent.start_transaction(environ, wmonid, wsgi_handler_name)
        err = None
        try:
...
def wrap_wsgi_app(original_app_func, default_wsgi_handler_name='wsgi_handler'):
    return wrap_wsgi_handler(original_app_func, default_wsgi_handler_name)
