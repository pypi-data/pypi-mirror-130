...
class NotebookHandler {
    ...
    toggleSceneMembershipOfSelectedCells() {
        ...
        notebook.widgets.forEach((cell) => {
            ...
            this.updateCellClassAndTags(cell, tag);
        });
    }
    ...
    updateCellClassesAndTags(notebook, scene_name) {
        ...
        notebook.widgets.map((cell) => {
            this.updateCellClassAndTags(cell, scene_tag);
        });
    }
    jumpToNextSceneCell() {
    ...
    updateCellClassAndTags(cell, scene_tag) {
        let cell_tags = [];
    ...
    constructor(app, nbTracker, mainMenu) {
        ...
        this._nbTracker.widgetAdded.connect((_x, nbpanel) => {
            ...
            nbpanel.content.activeCellChanged.connect((notebook, cell) => {
                this._notebookHandler.updateCellClassAndTags(cell, this._notebookHandler.getActiveScene());
            });
        });
...
//# sourceMappingURL=lib_index_js.b20133d1e9928dd28de2.js.map