...
class Population(object):
    ...
    def __init__(self, config: Config, initial_state=None):
        ...
        if initial_state is None:
            ...
            self.population: Dict[int, DefaultGenome] = self.reproduction.create_new(
    ...
    def run(
        self,
        fitness_function: Callable[[List[Tuple[int, DefaultGenome]], Config], None],
        n: Optional[int] = None,
        ...
        while n is None or k < n:
            ...
            self.reporters.post_evaluate(
                self.config, self.population, self.species_set, best
            )
            ...
            if not self.config.no_fitness_termination:
                ...
                fv: float = self.fitness_criterion(
            ...
            self.population = self.reproduction.reproduce(
                self.config, self.species_set, self.config.pop_size, self.generation
            )
            ...
            self.reporters.end_generation(
                self.config, self.population, self.species_set
            )
