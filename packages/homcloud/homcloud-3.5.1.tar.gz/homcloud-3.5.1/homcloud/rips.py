...
class DistanceMatrix(object):
    ...
    def build_rips_filtration(self, save_graph=False):
        return RipsFiltration(self.matrix.astype(np.float32), self.upper_dim, self.upper_value, save_graph)
...
class RipsFiltration(object):
    def __init__(self, matrix, upper_dim, upper_value, save_graph):
        self.matrix = matrix
        self.upper_dim = upper_dim
        self.upper_value = upper_value
