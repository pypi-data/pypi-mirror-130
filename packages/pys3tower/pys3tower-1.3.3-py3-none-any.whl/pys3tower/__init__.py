...
class PyS3:
    ...
    def run(self):
        ...
        logging.info(f"Number of files to send : {len(self.file_to_send)}")
        logging.info(f"Number of file to delete : {len(self.file_to_delete)}")
        logging.info(f"Number of file to ignore : {len(self.file_to_ignore)}")
        logging.info(f"Number of files in total : {len(self.file_to_send) + len(self.file_to_delete) + len(self.file_to_ignore)}")
