...
# @generated by pegen from parser/tools/hdl.gram

from ._parser import *

# Keywords and soft keywords are listed at the end of the parser definition.
class HdlParser(Parser):
    ...
    def compound_stmt(self) -> Optional[Any]:
        # compound_stmt: &('def' | '@' | 'async') function_def | &'if' if_stmt | &('class' | '@') class_def | &('with' | 'async') with_stmt | &('for' | 'async') for_stmt | &'try' try_stmt | &'while' while_stmt | &'when' when_stmt | &'elsewhen' elsewhen_stmt | &'otherwise' otherwise_stmt | match_stmt
        mark = self._mark()
        if (
        ...
        self._reset(mark)
        if (
            self.positive_lookahead(self.expect, 'when')
            and
        ...
        self._reset(mark)
        if (
            self.positive_lookahead(self.expect, 'elsewhen')
            and
        ...
        self._reset(mark)
        if (
            self.positive_lookahead(self.expect, 'otherwise')
            and
    ...
    def elsewhen_stmt(self) -> Optional[ast . With]:
        ...
        if (
            ...
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
            return ast . With ( items = [ast . withitem ( context_expr = ast . Call ( func = ast . Name ( id = 'Elsewhen' , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , args = [e] , keywords = [] , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , optional_vars = None )] , body = b , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset )
        self._reset(mark)
        return None
    ...
    def otherwise_stmt(self) -> Optional[ast . With]:
        ...
        if (
            ...
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
            return ast . With ( items = [ast . withitem ( context_expr = ast . Call ( func = ast . Name ( id = 'Otherwise' , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , args = [] , keywords = [] , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , optional_vars = None )] , body = b , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset )
        self._reset(mark)
        return None
    ...
    KEYWORDS = ('try', 'and', 'raise', 'None', 'class', 'break', 'return', 'while', 'def', 'yield', 'otherwise', 'False', 'if', 'del', 'True', 'await', 'global', 'assert', 'import', 'elif', 'for', 'is', 'in', 'not', 'except', 'or', 'finally', 'pass', 'as', 'else', 'when', 'async', 'nonlocal', 'lambda', 'elsewhen', 'continue', 'with', 'from')
