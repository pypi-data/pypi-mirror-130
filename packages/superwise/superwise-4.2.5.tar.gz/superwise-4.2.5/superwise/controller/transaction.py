...
class TransactionController(BaseController):
    ...
    def _create_s3_client(self, aws_access_key_id, aws_secret_access_key, role_arn):
        try:
            ...
            self.logger.error("Error create s3 client")
            raise SuperwiseException("Error create s3 client - role arn or access and secret keys not provided")

    def log_from_s3(self, file_path, aws_access_key_id=None, aws_secret_access_key=None, role_arn=None):
