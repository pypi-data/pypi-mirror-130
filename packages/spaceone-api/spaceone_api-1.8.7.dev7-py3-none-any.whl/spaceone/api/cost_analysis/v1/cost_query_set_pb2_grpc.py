...
class CostQuerySetStub(object):
    ...
    def __init__(self, channel):
        ...
        self.change_scope = channel.unary_unary(
                ...
                request_serializer=spaceone_dot_api_dot_cost__analysis_dot_v1_dot_cost__query__set__pb2.ChangeCostQuerySetScopeRequest.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_cost__analysis_dot_v1_dot_cost__query__set__pb2.CostQuerySetInfo.FromString,
                )
...
def add_CostQuerySetServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'change_scope': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=spaceone_dot_api_dot_cost__analysis_dot_v1_dot_cost__query__set__pb2.ChangeCostQuerySetScopeRequest.FromString,
                    response_serializer=spaceone_dot_api_dot_cost__analysis_dot_v1_dot_cost__query__set__pb2.CostQuerySetInfo.SerializeToString,
            ),
...
class CostQuerySet(object):
    ...
    def change_scope(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.cost_analysis.v1.CostQuerySet/change_scope',
            spaceone_dot_api_dot_cost__analysis_dot_v1_dot_cost__query__set__pb2.ChangeCostQuerySetScopeRequest.SerializeToString,
            spaceone_dot_api_dot_cost__analysis_dot_v1_dot_cost__query__set__pb2.CostQuerySetInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
