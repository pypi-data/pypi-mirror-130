...
class JobStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_tasks = channel.unary_unary(
                '/spaceone.api.cost_analysis.job.Job/get_tasks',
...
def add_JobServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.cost_analysis.job.Job', rpc_method_handlers)
...
class Job(object):
    ...
    def get_tasks(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.cost_analysis.job.Job/get_tasks',
