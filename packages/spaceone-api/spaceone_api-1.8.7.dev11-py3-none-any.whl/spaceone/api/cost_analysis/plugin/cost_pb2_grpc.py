...
class CostStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_data = channel.unary_stream(
                '/spaceone.api.cost_analysis.job.Cost/get_data',
...
def add_CostServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.cost_analysis.job.Cost', rpc_method_handlers)
...
class Cost(object):
    ...
    def get_data(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/spaceone.api.cost_analysis.job.Cost/get_data',
