from typing import Optional, Tuple, Union, Dict, Callable, Sequence, Any
...
class ConfigProxy(Listener):
    ...
    def get_config(self) -> Config:
        ...
        cfg: Config = self._parent.config
        return cfg
...
class SettingsTab(QtWidgets.QWidget):
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        def cfg_field(key: str) -> Tuple[QtWidgets.QLabel, ...]:
...
def widget_row_from_field(
    ...
    aux widgets based on field metadata of the Config dataclass.
