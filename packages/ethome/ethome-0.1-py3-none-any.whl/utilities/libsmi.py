...
"""
The libsmi file from the OpenSesame library - working on integration for SMI triggering - need to build wrapper for C++ bindings
"""
...
def errorstring(returncode):
	...
	if type(returncode) != int:
		try:
			...
			return "return code not recognized as a valid integer"
	
	codes = {
		1:"SUCCESS: intended functionality has been fulfilled",
