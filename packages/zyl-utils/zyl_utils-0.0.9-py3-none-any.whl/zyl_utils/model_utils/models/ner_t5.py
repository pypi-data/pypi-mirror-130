...
class NerT5:
    ...
    def _deal_with_df(self, data, sliding_window=False, delimiter='|'):
    ...
    def train(self, train_data: pd.DataFrame, eval_data: pd.DataFrame, sliding_window=False, wandb_log=None):
        # deal with dt
