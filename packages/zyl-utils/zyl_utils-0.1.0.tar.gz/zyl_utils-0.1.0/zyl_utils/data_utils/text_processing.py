...
class MyTokenizer:
    def __init__(self):
        ...
        self.words_tokenizer_en = self.get_word_tokenizer_en()
    ...
    def cut_sentence_to_words(self, sentence: str):
        if langid.classify(sentence)[0] == 'zh':
            return self.cut_sentence_to_words_zh(sentence)
        else:
            return self.words_tokenizer_en.tokenize(sentence)
