...
from zyl_utils import entity_recognition_v2
...
class NerT5:
    ...
    def _eval_entity_recognition(model, eval_data: pd.DataFrame, check_in_input_text: bool, delimiter='|',
        ...
        for prefix in set(prefixes):
            ...
            res_df = entity_recognition_v2(y_true, y_pred, pos_neg_ratio=pos_neg_ratio,
                                           self_metric=self_metric)
            eval_res[prefix] = res_df

        print(f'sum report:')
        res_df = entity_recognition_v2(revised_target_texts, revised_pred_target_texts,
