...
class CohortResults(object):
    ...
    def cohort_definition(self, cohort_definition):
        ...
        if cohort_definition is None:
            raise ValueError("Invalid value for `cohort_definition`, must not be `None`")  # noqa: E501
    ...
    def model_population(self, model_population):
        ...
        """
        if model_population is None:
            raise ValueError("Invalid value for `model_population`, must not be `None`")  # noqa: E501
