...
class JobRunner:
    ...
    # def update_job_run_metadata_with_python_api(
    #     self, client: DataScienceClient, metadata: dict
    # ) -> None:
    #     """Updates the metadata of the job run by calling OCI Python API
    #     This method requires the OCI Python SDK to support Job APIs.
    ...
    #     """
    #     tags = json.loads(repr(client.get_job_run(self.job_run_ocid).data)).get(
    #         "freeform_tags", {}
    #     )
    #     tags.update(metadata)
    #     data = oci.data_science.models.UpdateJobRunDetails(freeform_tags=tags)
    #     response = client.update_job_run(self.job_run_ocid, update_job_run_details=data)
    #     print(response.data)
