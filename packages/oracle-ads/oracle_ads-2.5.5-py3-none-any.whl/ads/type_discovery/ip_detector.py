...
class IPDetector(AbstractTypeDiscoveryDetector):
    def __init__(self):
        self.ipv4_matcher = re.compile(
            "^(?:(?:[0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.){3}(?:[0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$"
        )
        self.ipv6_matcher = re.compile(
    ...
    def _is_ip(self, name, values):
        return all(
            [
                self.ipv4_matcher.match(str(x)) or self.ipv6_matcher.match(str(x))
                for x in values
            ]
        )
...
if __name__ == "__main__":
        ...
        dd.discover(
            ...
            pd.Series(
                [
                    None,
                    "192.168.111.44",
                    "2606:b400:400:1c42:199f:7a12:c9b4:bda4",
                    "10.0.0.1",
                    None,
                ]
            ),
    ...
    print(
        dd.discover(
            "ip6", pd.Series([None, "2606:b400:400:1c42:199f:7a12:c9b4:bda4", None])
        )
    )
