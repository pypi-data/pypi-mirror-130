...
def test_convert_compute_config_aws() -> None:
    config_controller = ConfigController(Mock(), Mock())
...
def test_convert_compute_config_legacy_config() -> None:
    config_controller = ConfigController(Mock(), Mock())
...
def test_convert_compute_config_gcp() -> None:
    config_controller = ConfigController(Mock(), Mock())
...
def test_convert_node_config_aws() -> None:
    config_controller = ConfigController(Mock(), Mock())
...
def test_convert_cluster_env() -> None:
    config_controller = ConfigController(Mock(), Mock())
...
def test_select_base_image(
    python_version: str, ray_version: str, ml: bool, gpu: bool, expected_image: str
) -> None:
...
def test_find_enum_name(
    python_version: str, ray_version: str, ml: bool, gpu: bool, expected_result
) -> None:
    config_controller = ConfigController(Mock(), Mock())
