...
class ClientBuilder:
    ...
    def _init_args(self, **kwargs) -> "ClientBuilder":  # noqa: C901
        ...
        # runtime_environment arugments
        runtime_env = kwargs.pop("runtime_env", None)
        self.env(runtime_env if runtime_env is not None else {})
        ...
        if runtime_env is None or runtime_env.get("working_dir") is None:
            self._log.warning(
                ...
                "See https://docs.ray.io/en/latest/advanced.html?highlight=working_dir#runtime-environments."
            )
