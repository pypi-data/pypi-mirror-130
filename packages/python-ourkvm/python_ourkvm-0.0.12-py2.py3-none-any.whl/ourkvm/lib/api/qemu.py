...
def create_machine_configuration(name :str, info :NewVirtualMachine, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> Dict[str, Any]:
	"""
...
def create_qemu_string_from_struct(name :str, info :NewVirtualMachine, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> str:
	"""
...
def start_qemu_machine(name :str, locations :ResourceLocations, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> None:
	"""
...
def stop_qemu_machine(name :str, locations :ResourceLocations, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> None:
	"""
...
def status_qemu_machine(name :str, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> Dict[str, str]:
	"""
...
def snapshot_qemu_machine(name :str, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> None:
	"""
...
def migrate_qemu_machine(name :str, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> None:
	"""
...
def export_qemu_machine(name :str, current_user: User = Security(get_current_user, scopes=["qemu*"])) -> None:
	"""
