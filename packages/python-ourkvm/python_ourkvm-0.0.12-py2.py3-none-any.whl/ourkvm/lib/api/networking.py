...
def get_network_interface_info(ifname :str, current_user: User = Security(get_current_user, scopes=["networking*"])) -> List[Dict[str, Union[int, None, str]]]:
	"""
...
def create_new_interface(ifname :str, info :NewInterface, current_user: User = Security(get_current_user, scopes=["networking*"])) -> List[Dict[str, Union[int, None, str]]]:
	"""
...
def delete_interface(ifname :str, current_user: User = Security(get_current_user, scopes=["networking*"])) -> List[Dict[str, Union[int, None, str]]]:
	"""
...
def create_new_namespace(name :str, current_user: User = Security(get_current_user, scopes=["networking*"])) -> Dict[str, Any]:
	"""
...
def delete_namespace(name :str, current_user: User = Security(get_current_user, scopes=["networking*"])) -> Dict[str, Any]:
	"""
...
def set_master_on_interface(name :str, master :str, current_user: User = Security(get_current_user, scopes=["networking*"])) -> bool:
	"""
...
def move_interface_to_namespace(name :str, namespace :str, current_user: User = Security(get_current_user, scopes=["networking*"])) -> bool:
	"""
