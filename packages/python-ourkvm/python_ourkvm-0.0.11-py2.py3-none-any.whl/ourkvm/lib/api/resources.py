...
def create_virtual_harddrive(name :str, information :Resource, current_user: User = Depends(get_current_user)) -> Resource:
	"""
...
def delete_virtual_harddrive(uuid :str, information :Resource, current_user: User = Depends(get_current_user)) -> None:
	"""
