...
def generate_empty_data_structures() -> Tuple[PandasDataFrameType, PandasDataFrameType]:
    """
    ...
    columns = [
        'Rule', 'Precision', 'Recall', 'nConditions', 'PercDataFlagged',
        'Metric'
    ]
...
def sort_rule_dfs_by_opt_metric(rule_descriptions: PandasDataFrameType,
...
def combine_rule_dfs(rule_descriptions_1: PandasDataFrameType,
                     X_rules_1: PandasDataFrameType,
                     rule_descriptions_2: PandasDataFrameType,
                     X_rules_2: PandasDataFrameType) -> Tuple[PandasDataFrameType, PandasDataFrameType]:
    """
    Combines the `rule_description` and `X_rules` object of two rule sets.

    Parameters
    ----------
    rule_descriptions_1 : PandasDataFrameType
        The first rule_descriptions.
    X_rules_1 : PandasDataFrameType
        The first X_rules.
    rule_descriptions_2 : PandasDataFrameType
        The second rule_descriptions.
    X_rules_2 : PandasDataFrameType
        The second X_rules.
...
def calc_tps_fps_tns_fns(y_true: Union[PandasSeriesType, np.ndarray, KoalasSeriesType],
    ...
    def _calc_tps_fps_tns_fns_numpy(y_true: Union[PandasSeriesType, np.ndarray],
        ...
        if is_type(y_true, [PandasSeries, PandasDataFrameType]):
