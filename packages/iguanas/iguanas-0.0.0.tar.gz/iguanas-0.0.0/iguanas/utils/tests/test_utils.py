...
def test_generate_empty_data_structures():
    rd, xr = utils.generate_empty_data_structures()
...
def test_sort_rule_dfs_by_opt_metric():
    ...
    rd, xr = utils.sort_rule_dfs_by_opt_metric(rule_descriptions, X_rules)
...
def test_combine_rule_dfs(create_dummy_rules):
    ...
    xr1 = X_rules[['A', 'B']]
    xr2 = X_rules[['C', 'D', 'E']]
    rd_comb, xr_comb = utils.combine_rule_dfs(rd1, xr1, rd2, xr2)
