...
class RuleGeneratorDTSpark(Rules, _BaseGenerator):
    """
    ...
    def __init__(self, metric: Callable,
        ...
        self.tree_ensemble.setMaxDepth(n_total_conditions)
        self.tree_ensemble.setSeed(0)
        self.tree_ensemble.setLabelCol('label_')
        self.metric = metric
    ...
    def __repr__(self):
        if self.rule_strings:
            ...
            return f'RuleGeneratorDTSpark(metric={self.metric}, n_total_conditions={self.tree_ensemble.getMaxDepth}, tree_ensemble={self.tree_ensemble}, precision_threshold={self.precision_threshold}, target_feat_corr_types={self.target_feat_corr_types})'
