...
def _expected_X_rules_mean():
    X_rules_means = {
        'Nelder-Mead': np.array([0.99990001, 0.10428957, 0.10438956, 0., 0.]),
        'Powell': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'CG': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'BFGS': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'L-BFGS-B': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'TNC': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'COBYLA': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'SLSQP': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00]),
        'trust-constr': np.array([9.9990001e-01, 0.0000000e+00, 0.0000000e+00, 9.9990001e-05, 0.0000000e+00])
    }
...
def _expected_X_rules_mean_x0_bounds():
    X_rules_means = {
        'Nelder-Mead': np.array([0.99980002, 0.99980002, 0.50614939, 0.99990001, 0.50624938]),
        'Powell': np.array([0.99880012, 0.99860014, 0.90320968, 0.99990001, 0.90330967]),
        'CG': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'BFGS': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'L-BFGS-B': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'TNC': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'COBYLA': np.array([0.99990001, 0.99990001, 0.99990001, 0.99990001, 1.]),
        'SLSQP': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'trust-constr': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938])
    }
    return X_rules_means
...
def _expected_X_rules_mean_weighted_x0_bounds():
    return {
        'Nelder-Mead': np.array([0.49385061, 0.49375062, 0.50614939, 0.99990001, 0.50624938]),
        'Powell': np.array([0.85281472, 0.77742226, 0.90320968, 0.99990001, 0.90330967]),
        'CG': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'BFGS': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'L-BFGS-B': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
        'TNC': np.array([0.49915008, 0.49915008, 0.50614939, 0.99990001, 0.50624938]),
...
def _expected_X_rules_mean_unlabelled():
    return {
        'Nelder-Mead': np.array([9.99900010e-05, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00,
                                 9.03209679e-01]),
        'Powell': np.array([9.9990001e-05, 0.0000000e+00, 0.0000000e+00, 0.0000000e+00,
                            0.0000000e+00]),
        'CG': np.array([9.99900010e-05, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00,
                        9.03209679e-01]),
        'BFGS': np.array([9.99900010e-05, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00,
                          9.03209679e-01]),
        'L-BFGS-B': np.array([9.99900010e-05, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00,
                              9.03209679e-01]),
        'TNC': np.array([9.99900010e-05, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00,
                         9.03209679e-01]),
        'COBYLA': np.array([9.9990001e-05, 0.0000000e+00, 0.0000000e+00, 0.0000000e+00,
                            0.0000000e+00]),
        'SLSQP': np.array([9.9990001e-05, 0.0000000e+00, 0.0000000e+00, 0.0000000e+00,
                           0.0000000e+00]),
        'trust-constr': np.array([9.99900010e-05, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00,
                                  7.03429657e-01])
    }
...
def _expected_X_rules_mean_unlabelled_x0_bounds():
    return {
        'Nelder-Mead': np.array([9.89901010e-03, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                                 9.99900010e-05]),
        'Powell': np.array([9.99900010e-03, 9.89901010e-03, 0.00000000e+00, 1.04289571e-01,
                            9.99900010e-05]),
        'CG': np.array([0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                        9.99900010e-05]),
        'BFGS': np.array([0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                          9.99900010e-05]),
        'L-BFGS-B': np.array([0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                              9.99900010e-05]),
        'TNC': np.array([0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                         9.99900010e-05]),
        'COBYLA': np.array([9.9990001e-05, 0.0000000e+00, 0.0000000e+00, 0.0000000e+00,
                            0.0000000e+00]),
        'SLSQP': np.array([0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                           9.99900010e-05]),
        'trust-constr': np.array([0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 5.06149385e-01,
                                  9.99900010e-05])
    }
...
def test_apply(_instantiate):
    ...
    exp_rule_descriptions = pd.DataFrame(
        ...
        columns=['Rule', 'Precision', 'Recall', 'PercDataFlagged', 'Metric', 'Logic', 'nConditions'])
    exp_rule_descriptions.set_index('Rule', inplace=True)
    ro.rule_strings = {
        'Rule': "(X['A'] > 1)",
    }
    X_rules = ro.transform(X, y)
...
def _fit(rule_lambdas, lambda_kwargs, X, y, sample_weight, metric, exp_rule_strings,
         exp_X_rules_mean, exp_orig_rule_performances,
         exp_opt_rule_performances, x0, bounds):
    methods = [
        'Nelder-Mead',
        'Powell',
        'CG',
    ...
    for method in methods:
        with pytest.warns(UserWarning,
            ...
            np.testing.assert_array_almost_equal(
                X_rules.mean().values, exp_X_rules_mean[method])
