...
def test_bottom_up(agg_instantiated, clusters, similarity_df, columns_performance):
    agg = agg_instantiated
    agg.columns_performance = columns_performance
    clusters = clusters
...
def test_top_down(agg_instantiated, clusters, similarity_df, columns_performance):
    agg = agg_instantiated
    clusters = clusters
    agg.columns_performance = columns_performance
    similarity_df = similarity_df
...
def test_error(agg_instantiated):
    agg = agg_instantiated
