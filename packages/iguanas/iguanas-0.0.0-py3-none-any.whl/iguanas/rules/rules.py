...
class Rules(RuleApplier):
    ...
    metric : Callable, optional
        ...
        Fbeta score) for each rule when applying the rules to a dataset. 
        Defaults to None.
    ...
    rule_descriptions : PandasDataFrameType
        ...
        metrics on the provided dataset (only populates when the `.transform()`
        method is used).        
    """
    ...
    def __init__(self, rule_dicts=None, rule_strings=None,
        ...
        self.rule_features = {}
        RuleApplier.__init__(self, rule_strings=self.rule_strings,
                             metric=metric)
