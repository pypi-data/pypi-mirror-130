...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=oimvQ
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:oimvk)->oimvk:
  pass
 @oimvG
 def get(cls,requested_file_locator:oimvk):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=oimvQ
 @oimvG
 def get(cls,state_file_locator:oimvk,requested_storage:oimvk,serializers:Dict[oimvk,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[oimvk,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:oimvk)->oimvk:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:oimvk)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:oimvk)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:oimvk)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:oimvk)->oimvk:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[oimvk]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:oimvk,new_key:oimvk,referenced_by_version:oimvk=oimvQ):
  pass
 @abc.abstractmethod
 def version_exists(self,key:oimvk)->oimvH:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:oimvk,key:oimvk):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:oimvk,new_key:oimvk,base_path:oimvk)->oimvH:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[oimvk]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[oimvk,oimvk],remote_location:oimvk=oimvQ)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[oimvk]:
  ...
  for cpvcs_obj in args:
   if oimvC(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif oimvC(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[oimvk,oimvk],remote_location:oimvk=oimvQ)->List[Union[Revision,Version]]:
