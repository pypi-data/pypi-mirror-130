...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=eyLpx
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:eyLpB)->eyLpB:
  pass
 @eyLpc
 def get(cls,requested_file_locator:eyLpB):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=eyLpx
 @eyLpc
 def get(cls,state_file_locator:eyLpB,requested_storage:eyLpB,serializers:Dict[eyLpB,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[eyLpB,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:eyLpB)->eyLpB:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:eyLpB)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:eyLpB)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:eyLpB)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:eyLpB)->eyLpB:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[eyLpB]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:eyLpB,new_key:eyLpB,referenced_by_version:eyLpB=eyLpx):
  pass
 @abc.abstractmethod
 def version_exists(self,key:eyLpB)->eyLpg:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:eyLpB,key:eyLpB):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:eyLpB,new_key:eyLpB,base_path:eyLpB)->eyLpg:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[eyLpB]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[eyLpB,eyLpB],remote_location:eyLpB=eyLpx)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[eyLpB]:
  ...
  for cpvcs_obj in args:
   if eyLpU(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif eyLpU(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[eyLpB,eyLpB],remote_location:eyLpB=eyLpx)->List[Union[Revision,Version]]:
