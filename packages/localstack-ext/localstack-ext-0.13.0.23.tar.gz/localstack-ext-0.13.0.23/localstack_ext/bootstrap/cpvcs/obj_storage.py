...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=WuKYC
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:WuKYS)->WuKYS:
  pass
 @WuKYk
 def get(cls,requested_file_locator:WuKYS):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=WuKYC
 @WuKYk
 def get(cls,state_file_locator:WuKYS,requested_storage:WuKYS,serializers:Dict[WuKYS,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[WuKYS,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:WuKYS)->WuKYS:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:WuKYS)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:WuKYS)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:WuKYS)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:WuKYS)->WuKYS:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[WuKYS]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:WuKYS,new_key:WuKYS,referenced_by_version:WuKYS=WuKYC):
  pass
 @abc.abstractmethod
 def version_exists(self,key:WuKYS)->WuKYd:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:WuKYS,key:WuKYS):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:WuKYS,new_key:WuKYS,base_path:WuKYS)->WuKYd:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[WuKYS]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[WuKYS,WuKYS],remote_location:WuKYS=WuKYC)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[WuKYS]:
  ...
  for cpvcs_obj in args:
   if WuKYN(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif WuKYN(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[WuKYS,WuKYS],remote_location:WuKYS=WuKYC)->List[Union[Revision,Version]]:
