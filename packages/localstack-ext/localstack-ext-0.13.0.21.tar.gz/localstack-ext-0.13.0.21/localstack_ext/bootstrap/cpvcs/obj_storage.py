...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=QYfoL
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:QYfol)->QYfol:
  pass
 @QYfoz
 def get(cls,requested_file_locator:QYfol):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=QYfoL
 @QYfoz
 def get(cls,state_file_locator:QYfol,requested_storage:QYfol,serializers:Dict[QYfol,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[QYfol,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:QYfol)->QYfol:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:QYfol)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:QYfol)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:QYfol)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:QYfol)->QYfol:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[QYfol]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:QYfol,new_key:QYfol,referenced_by_version:QYfol=QYfoL):
  pass
 @abc.abstractmethod
 def version_exists(self,key:QYfol)->QYfoV:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:QYfol,key:QYfol):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:QYfol,new_key:QYfol,base_path:QYfol)->QYfoV:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[QYfol]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[QYfol,QYfol],remote_location:QYfol=QYfoL)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[QYfol]:
  ...
  for cpvcs_obj in args:
   if QYfox(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif QYfox(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[QYfol,QYfol],remote_location:QYfol=QYfoL)->List[Union[Revision,Version]]:
