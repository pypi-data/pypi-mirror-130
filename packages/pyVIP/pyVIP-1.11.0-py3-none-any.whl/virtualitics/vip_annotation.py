...
class VipAnnotation:
    """
    The VipAnnotation class contains the basic data and metadata for creating and managing an Annotation in VIP.
    """
    ...
    def __init__(self, a_type=None, 
        ...
        :param id: :class:`str` specifies a unique identifier provided by VIP.
    ...
    def id(self, val):
        ...
        if isinstance(val, str):
            ...
            utils.raise_invalid_argument_exception(str(type(val)), "id",
                                                    "must be a 'str' specifying the id of the annotation (generated by VIP).")
...
class AnnotationType(Enum):
    """
    Different types of annotations available in VIP.
