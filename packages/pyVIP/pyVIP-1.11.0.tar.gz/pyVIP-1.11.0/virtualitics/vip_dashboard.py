...
class VipDashboard:
    """
    The Dashboard class contains the basic metadata for addressing a VIP dashboard by ID/Name.
    """
    ...
    def __init__(self, name=None, guid=None):
        ...
        :param guid: :class:'str' specifies a unique identifier provided by VIP.
        """
        self.name = name
        self.guid = guid
...
class VipDashboardTile:
    """
    The Dashboard Tile class contains the information used to define and create a dashboard tile in VIP.
    """
