...
class BuiltinFunctions:
    ...
    @meta({'spec': [[Spec.ArityIs, 1]],
           ...
           'type': 'function',
           'forms': ['(not something)'],
           'docstring': 'Invert something truthy'})
    ...
    @meta({'spec': [[Spec.ArityIs, 2],
           ...
           'type': 'function',
           'forms': ['(<= first second)'],
           'docstring': 'Whether first less-tha-equals second or not'})
    ...
    @meta({'spec': [[Spec.ArityIs, 1],
           ...
           'type': 'function',
           'forms': ['(doc callable)'],
           'docstring': 'Allows you to lookup for a Function or a Macro documentation'})
    ...
    def filter_func(args: List[datatypes.Base]) -> datatypes.Vector:
        ...
        return datatypes.Vector(tuple(filter(lambda elem: fun.reference()([elem]).truthy(), coll.elements())))
