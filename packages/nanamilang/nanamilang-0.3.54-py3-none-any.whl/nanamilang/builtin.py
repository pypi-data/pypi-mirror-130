...
class BuiltinMacros:
    ...
    def resolve(mc_name: str) -> dict:
        ...
        if mc_name in BuiltinMacros.cached.keys():
            return BuiltinMacros.cached.get(mc_name)
...
class BuiltinFunctions:
    ...
    def resolve(fn_name: str) -> dict:
        ...
        if fn_name in BuiltinFunctions.cached.keys():
            return BuiltinFunctions.cached.get(fn_name)
