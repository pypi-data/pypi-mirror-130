...
class BuiltinFunctions:
    ...
    @meta({'spec': ((Spec.ArityIs, 1),
           ...
           'docstring': 'Returns true if collection you have passed is empty'})
    ...
    @staticmethod
    @meta({'spec': ((Spec.ArityIs, 2),
                    (Spec.EachArgumentTypeVariants,
                     (datatypes.IntegerNumber, datatypes.FloatNumber))),
           'name': '<',
           'type': 'function',
           'forms': ['(< first second)'],
           'docstring': 'Whether first less than second or not'})
    def less_than_func(args: (List[datatypes.IntegerNumber]
                              or List[datatypes.FloatNumber])
                       ) -> datatypes.Boolean:
        """
        Builtin '<' function implementation
    ...
    @meta({'spec': ((Spec.ArityIs, 2),
           ...
           'type': 'function',
           'forms': ['(<= first second)'],
           'docstring': 'Whether first <= second or not'})
    ...
    @meta({'spec': ((Spec.ArityIs, 2),
           ...
           'docstring': 'A Vector of something repeated as many times as you want'})
    def repeat_func(args: List[datatypes.Base]) -> datatypes.Base:
        ...
        # TODO: should we use copy.deepcopy there or not?
    ...
    @meta({'spec': ((Spec.ArityIs, 2),
                    (Spec.ArgumentsTypeChainVariants,
                     ((datatypes.Function, datatypes.Collection), (datatypes.Keyword, datatypes.Collection)))),
           'name': 'map',
           'type': 'function',
           'forms': ['(map function collection)'],
           'docstring': 'Allows you to map your collection with the passed function which returns a Base Type'})
    ...
    @meta({'spec': ((Spec.ArityIs, 2),
           ...
           'docstring': 'Allows you to filter your collection with the passed function which returns Boolean'})
