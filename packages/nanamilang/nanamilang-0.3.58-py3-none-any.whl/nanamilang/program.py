...
from nanamilang.datatypes import Base, NException
...
class Program:
    ...
    def evaluate(self) -> Base:
        ...
        except Exception as python3_exception_instance:
            return NException(python3_exception_instance)

        # We could place handling Python 3 exception somewhere else, but for now... why not
