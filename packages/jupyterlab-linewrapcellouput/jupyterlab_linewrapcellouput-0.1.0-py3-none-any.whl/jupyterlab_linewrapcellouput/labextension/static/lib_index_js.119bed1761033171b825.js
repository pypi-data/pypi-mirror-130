    ...
    createNew(panel, context) {
        const triggerLineWrapCellOutput = () => {
            if (SET) {
                ...
                t = setInterval(JupyterLabLineWrapCellOuputOn, 1000);
            }
        };
        ...
        var SET = true;
        var t = setInterval(JupyterLabLineWrapCellOuputOn, 1000);
        button.addClass('selected');
...
//# sourceMappingURL=lib_index_js.119bed1761033171b825.js.map