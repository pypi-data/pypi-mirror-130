...
function JupyterLabLineWrapCellOuputOn() {
    ...
    console.log(0, divs.length);
    for (let i = 0; i < divs.length; i++) {
        var div = divs[i];
        console.log(1, div.style["whiteSpace"]);
    ...
    createNew(panel, context) {
        const triggerLineWrapCellOutput = () => {
            if (SET) {
                ...
                t = setInterval(JupyterLabLineWrapCellOuputOn, 500);
            }
        };
        ...
        var SET = true;
        var t = setInterval(JupyterLabLineWrapCellOuputOn, 500);
        button.addClass('selected');
...
//# sourceMappingURL=lib_index_js.6caca11f807c71fa0c56.js.map