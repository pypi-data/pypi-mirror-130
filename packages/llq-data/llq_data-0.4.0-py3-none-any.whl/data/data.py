...
def create_name(size):
    xing='赵钱孙李周吴郑王冯陈褚卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻柏水窦章云苏潘葛奚范彭郎鲁韦昌马苗凤花方俞任袁柳'
    xingl = [i for i in xing]
    ming= "风华正茂仁义礼智黄天霸和平世界中华正义伟岸茂盛繁荣群智慧睿风清扬自成世民太极网红文艺学与中小学语文教学研究丛书"
    mingl=[i for i in ming]
...
def create_data(size=40,colums=['英语','政治','高数','专业课','面试']):
    ...
    return pd.concat([create_name(size),create_subjects(size,colums)],axis=1)
