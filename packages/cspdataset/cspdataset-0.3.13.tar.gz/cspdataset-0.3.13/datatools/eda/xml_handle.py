...
def analysis_data(xml_file_path):
    ...
    plt.xlabel('Width', fontsize=50)
    plt.ylabel('Height', fontsize=50)
    plt.title('Images', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.scatter(images_size_w, images_size_h, c='r')
    plt.savefig(results + '/images.png', dpi=300)
    ...
    plt.title('Distribution of Width about Images', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.hist(images_size_w, num_bins, facecolor='red', alpha=0.5)
    plt.savefig(results + '/images_width.png', dpi=300)

    # 图像高度分布
    plt.figure(figsize=(40, 40))
    plt.xlabel('Height', fontsize=50)
    plt.ylabel('Number', fontsize=50)
    plt.title('Distribution of Height about Images', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.hist(images_size_h, num_bins, facecolor='red', alpha=0.5)
    plt.savefig(results + '/images_height.png', dpi=300)

    # 图像高/宽比分布
    plt.figure(figsize=(40, 40))
    plt.xlabel('Height', fontsize=50)
    plt.ylabel('Number', fontsize=50)
    plt.title('Distribution of Ratio(Height/Width) about Images', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.hist(images_size_ratio, num_bins, facecolor='red', alpha=0.5)
    plt.savefig(results + '/images_ratio.png', dpi=300)

    # 散点图(目标框) ##########################################
    plt.figure(figsize=(40, 40))
    plt.xlabel('Width', fontsize=50)
    plt.ylabel('Height', fontsize=50)
    plt.title('Boxes', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.scatter(boxes_size_w, boxes_size_h, c='b')
    plt.savefig(results + '/boxes.png', dpi=300)
    ...
    plt.xlabel('Width', fontsize=50)
    plt.ylabel('Number', fontsize=50)
    plt.title('Distribution of Width about Boxes', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.hist(boxes_size_w, num_bins, facecolor='blue', alpha=0.5)
    plt.savefig(results + '/boxes_width.png', dpi=300)

    # 目标框高度分布
    plt.figure(figsize=(40, 40))
    plt.xlabel('Height', fontsize=50)
    plt.ylabel('Number', fontsize=50)
    plt.title('Distribution of Height about Boxes', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.hist(boxes_size_h, num_bins, facecolor='blue', alpha=0.5)
    plt.savefig(results + '/boxes_height.png', dpi=300)

    # 目标框高/宽比分布
    plt.figure(figsize=(40, 40))
    plt.xlabel('Height', fontsize=50)
    plt.ylabel('Number', fontsize=50)
    plt.title('Distribution of Ratio(Height/Width) about Boxes', fontsize=60)
    plt.tick_params(labelsize=50)
    plt.hist(boxes_size_ratio, num_bins, facecolor='blue', alpha=0.5)
    plt.savefig(results + '/boxes_ratio.png', dpi=300)
