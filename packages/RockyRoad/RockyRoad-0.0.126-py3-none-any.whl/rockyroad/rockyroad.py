...
def build(serviceName, version, base_url, **kw):
    ...
    Usage Examples - Data Services:
        ...
        api_response = dataservice.companies().list(company_code="D123")
        api_response = dataservice.companies().list(ccompany_name="D123")
        api_response = dataservice.companies().list(company_account="D123")
        api_response = dataservice.companies().list(uid="123e4567-e89b-12d3-a456-426614174000")
        ...
        api_response = dataservice.companies().update(company=company)
        api_response = dataservice.companies().delete(uid=uid)
        api_response = dataservice.companies().subscribers().list(company_uid=uid)
        api_response = dataservice.companies().subscribers().insert(company_subscriber=company_subscriber)
        api_response = dataservice.companies().subscribers().delete(company_uid=uid, subscriber_uid=uid)
        ...
        api_response = dataservice.companies().branches().list(company_code="D123")
        api_response = dataservice.companies().branches().list(branch_name="D123")
        api_response = dataservice.companies().branches().list(branch_code="D123")
        api_response = dataservice.companies().branches().list(company_account="D123")
        api_response = dataservice.companies().branches().list(uid="123e4567-e89b-12d3-a456-426614174000")
        api_response = dataservice.companies().branches().list(company_account_uid="123e4567-e89b-12d3-a456-426614174000")
        api_response = dataservice.companies().branches().list(company_uid="123e4567-e89b-12d3-a456-426614174000")
        api_response = dataservice.companies().branches().list(include_machines=True)
        api_response = dataservice.companies().branches().insert(companyBranch=companyBranch)
        api_response = dataservice.companies().branches().update(companyBranch=companyBranch)
        api_response = dataservice.companies().branches().delete(uid=uid)
        api_response = dataservice.companies().branches().subscribers().list(company_branch_uid=uid)
        api_response = dataservice.companies().branches().subscribers().list(company_code='d123')
