...
################################################################################
## Form generated from reading UI file 'pyblackbox.ui'
##
...
"")
        ...
        self.messages_scroll.setGeometry(QRect(0, 0, 240, 711))
...
"}")
        ...
        self.verticalLayout_2 = QVBoxLayout(self.page_scope)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.PBB_MplWidget_ACMPlot = MplWidget(self.page_scope)
        self.PBB_MplWidget_ACMPlot.setObjectName(u"PBB_MplWidget_ACMPlot")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.PBB_MplWidget_ACMPlot.sizePolicy().hasHeightForWidth())
        self.PBB_MplWidget_ACMPlot.setSizePolicy(sizePolicy)
        self.PBB_MplWidget_ACMPlot.setMinimumSize(QSize(800, 800))
        self.PBB_MplWidget_ACMPlot.setStyleSheet(u"background-color: rgb(170, 0, 127)")

        self.verticalLayout_2.addWidget(self.PBB_MplWidget_ACMPlot)

        self.app_pages.addWidget(self.page_scope)
        self.page_console = QWidget()
        self.page_console.setObjectName(u"page_console")
        self.verticalLayout_3 = QVBoxLayout(self.page_console)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.PBB_ConsoleWidget = ConsoleWidget(self.page_console)
        self.PBB_ConsoleWidget.setObjectName(u"PBB_ConsoleWidget")
        self.PBB_ConsoleWidget.setEnabled(True)
        self.PBB_ConsoleWidget.setMinimumSize(QSize(500, 300))
        self.PBB_ConsoleWidget.setStyleSheet(u"background-color: rgb(85, 0, 127);")

        self.verticalLayout_3.addWidget(self.PBB_ConsoleWidget)

        self.app_pages.addWidget(self.page_console)
