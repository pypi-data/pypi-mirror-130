...
class CRUD:
    ...
    def _make_resource(self, response):
        data = response[self.resource_info] if self.resource_info else response
    ...
    def create(self, **kwargs):
        ...
        return self._make_resource(res)
    ...
    def get(self, resource_id, **query_params):
        res = self.client.get(self.url(self.client.get_id(resource_id)), query_params=query_params)
        return self._make_resource(res)
