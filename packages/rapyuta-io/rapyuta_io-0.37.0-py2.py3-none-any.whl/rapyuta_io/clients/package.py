...
class ProvisionConfiguration(ObjDict):
    ...
    def mount_volume(self, component_name, volume_instance, mount_path=None, executable_mounts=None):
        """
        ...
        :param executable_mounts: list of executable mounts
        ...
        component_id = self.plan.get_component_id(component_name)
        self._add_dependency(volume_instance.deploymentId, component_id, mount_path, executable_mounts=executable_mounts)
        return self
