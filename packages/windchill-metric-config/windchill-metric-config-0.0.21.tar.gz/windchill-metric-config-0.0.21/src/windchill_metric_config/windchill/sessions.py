...
class Sessions:
    def __init__(self):
        self.average = Description(
            metric_id='windchill_server_status_active_sessions_average',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.end = Description(
            metric_id='windchill_server_status_active_sessions_end',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.max = Description(
            metric_id='windchill_server_status_active_sessions_max',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.start = Description(
            metric_id='windchill_server_status_active_sessions_start',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.elapsed_seconds = Description(
            metric_id='windchill_server_status_sessions_elapsed_seconds',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.activated = Description(
            metric_id='windchill_server_status_sessions_activated',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.created = Description(
            metric_id='windchill_server_status_sessions_created',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.destroyed = Description(
            metric_id='windchill_server_status_sessions_destroyed',
            desc='',
            labels=['']
        )
        self.passivated = Description(
            metric_id='windchill_server_status_sessions_passivated',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
