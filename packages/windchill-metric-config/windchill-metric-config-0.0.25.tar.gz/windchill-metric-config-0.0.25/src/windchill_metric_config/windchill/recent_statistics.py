...
class RecentStatistics:
    def __init__(self):
        self.average = Description(
            metric_id='windchill_server_status_active_requests_average',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.end = Description(
            metric_id='windchill_server_status_active_requests_end',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.max = Description(
            metric_id='windchill_server_status_active_requests_max',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.start = Description(
            metric_id='windchill_server_status_active_requests_start',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.blocked = Description(
            metric_id='windchill_server_status_blocked_count_per_request',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.ie_requests = Description(
            metric_id='windchill_server_status_ie_calls_per_request',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.jndi_requests = Description(
            metric_id='windchill_server_status_jndi_calls_per_request',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.rmi_requests = Description(
            metric_id='windchill_server_status_rmi_calls_per_request',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.soap_requests = Description(
            metric_id='windchill_server_status_soap_call_per_request',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.WaitedCount = Description(
            metric_id='windchill_server_status_waited_count_per_request',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
        self.completedRequests = Description(
            metric_id='windchill_server_status_completed_requests',
            desc='',
            labels=['server_type', 'sub_server_types']
        )
